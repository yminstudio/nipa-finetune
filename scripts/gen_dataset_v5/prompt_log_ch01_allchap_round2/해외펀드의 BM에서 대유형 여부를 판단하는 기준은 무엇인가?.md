...
## Question
해외펀드의 BM에서 대유형 여부를 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "해외펀드의 BM에서 대유형 여부를 판단하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "BM_대유형_판단기준"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "3) 해외펀드의 유형별 BM",
  "question": "해외펀드의 BM에서 대유형 여부를 판단하는 기준은 무엇인가?",
...
## Assistant Response
```text
- 해외펀드의 BM에서 대유형 여부는 “볼드체 BM”에 해당하는지로 판단합니다.   
- 볼드체 BM은 해당 소유형이 속한 대유형의 BM과 동일한 것으로 봅니다.
```
...
## Assistant Response
```text
해외펀드는 성과평가 시 BM을 “대유형” 관점에서 보되, 먼저 적용되는 BM(펀드 BM 또는 유형 BM)이 무엇인지가 전제됩니다. 

해외펀드 BM에서 대유형 여부를 판단하는 기준은, 적용된 BM이 제로인에서 정한 “대유형-소유형”의 유형별 BM에 해당하는지를 보는 것입니다. 

- 해외주식형: 소유형 BM이 MSCI ACWI, MSCI EUROPE, MSCI CHINA 등(해외주식형 내 소유형 BM)에 해당하면 해외주식형으로 판단   
- 해외채권형: 소유형 BM이 Bloomberg Barclays Global Aggregate (KRW Hedged) 90%, JP Morgan GBI-EM Global Diversified 90% 등(해외채권형 내 소유형 BM)에 해당하면 해외채권형으로 판단   
- 해외부동산형: 소유형 BM이 재간접DWGRTT 90%(해외부동산형 내 소유형 BM)에 해당하면 해외부동산형으로 판단   

(참고) 해외펀드의 경우, 투자설명서/규약에 명시된 비교지수를 펀드 BM으로 적용하고, 없으면 유사 BM을 적용하며, 유사 BM을 적용하기 어렵다면 유형 BM을 적용합니다.
```
...
## Assistant Response
```text
해외펀드의 BM은 대유형-소유형 체계에 따라 설정되며, 이때 “해당 BM이 대유형에 해당하는가”는 대유형 BM과의 동일성 여부로 본다. 

- 대유형 여부 판단의 직접 기준은 “해당 소유형의 BM이지만, 대유형의 BM과 동일한가”이다. 특히 볼드체로 표시된 BM은 소유형이 속한 대유형의 BM과 동일하다고 본다.   
- 대유형은 해외주식형/해외채권형/해외부동산형으로 구분되고, 각 대유형별로 대표적인 유형별 BM이 제시되어 있다(예: 해외주식형–MSCI ACWI, 해외채권형–Bloomberg Barclays Global Aggregate(KRW Hedged) 90%, 해외부동산형–재간접DWGRTT 90%).   
- 해외펀드는 비교지수(펀드 BM) 또는 유사/부재 시 유형 BM을 사용하므로, 최종적으로 적용되는 BM이 위 대유형 대표 BM과 “동일”로 처리되는지(볼드체 해당 여부)가 대유형 판단의 핵심이 된다.
```

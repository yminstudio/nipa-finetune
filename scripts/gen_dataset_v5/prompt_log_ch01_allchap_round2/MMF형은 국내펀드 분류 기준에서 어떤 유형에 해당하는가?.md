...
## Question
MMF형은 국내펀드 분류 기준에서 어떤 유형에 해당하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "MMF형은 국내펀드 분류 기준에서 어떤 유형에 해당하는가?",
  "qa_type": "application",
  "question_template": "MMF형 적용 템플릿"
}
```
...
```json
{
  ...
  "subsection": "국내펀드",
  "seed_title": "국내펀드",
  "question": "MMF형은 국내펀드 분류 기준에서 어떤 유형에 해당하는가?",
...
## Assistant Response
```text
- 국내펀드 분류에서 MMF형은 대유형 ‘MMF형’에 해당하며, 소유형은 ‘MMF’로 구분됩니다.   
- 유형 판단은 가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드로 봅니다.   
- 세부적으로는 CP, CD, Call 등 1년 미만의 단기금융상품에만 투자하는 것으로 정리됩니다.
```
...
## Assistant Response
```text
국내펀드 분류 기준에서 “MMF형”은 국내 유형 체계 내에서 특정 대유형/소유형으로 매핑됩니다. 

- 국내펀드 분류의 **대유형: MMF형**, **소유형: MMF**에 해당합니다.   
- 해당 **MMF형(MMF)**은 가중평균 잔존만기가 **90일 이내인 채권형 자산(CP, CD, Call 등 1년 미만 단기금융상품)**에 투자하는 펀드로 설명됩니다.
```
...
## Assistant Response
```text
국내펀드의 유형분류 기준에서 ‘MMF형’은 MMF(머니마켓펀드) 계열로 분류됩니다. 

- 국내펀드 대유형: MMF형   
- 국내펀드 소유형: MMF   
- 분류 설명: CP, CD, Call 등 ‘1년 미만’의 단기금융상품에만 투자하는 펀드
```
...
## Assistant Response
```text
국내펀드는 투자목적·투자전략을 바탕으로 유형을 분류하며, MMF형은 국내펀드 분류의 대유형으로 구분됩니다. 

- 국내펀드 분류에서 MMF형은 대유형이 “MMF형”에 해당
- MMF형의 소유형은 “MMF”
- 분류 기준(정의): 가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드 
- 투자대상 범위: CP, CD, Call 등 1년 미만의 단기금융상품에만 투자
```
...
## Assistant Response
```text
국내펀드 유형분류 기준에서 MMF형은 단기금융상품에 투자하는 펀드를 별도 유형으로 잡습니다. 

- 국내펀드 분류상 해당 유형: 대유형 MMF형 
- 소유형: MMF 
- 분류 기준(정의): 가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드로, CP·CD·Call 등 1년 미만의 단기금융상품에만 투자하는 것으로 설명됩니다.
```

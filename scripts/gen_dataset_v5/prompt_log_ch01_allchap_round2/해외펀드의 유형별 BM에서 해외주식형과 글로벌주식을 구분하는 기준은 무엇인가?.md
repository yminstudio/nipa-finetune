...
## Question
해외펀드의 유형별 BM에서 해외주식형과 글로벌주식을 구분하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "해외펀드의 유형별 BM에서 해외주식형과 글로벌주식을 구분하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "해외주식형_vs_글로벌주식_구분_기준_템플릿"
}
```
...
```json
{
  ...
  "subsection": "해외펀드의 유형별 BM",
  "seed_title": "해외펀드의 유형별 BM",
  "question": "해외펀드의 유형별 BM에서 해외주식형과 글로벌주식을 구분하는 기준은 무엇인가?",
...
## Assistant Response
```text
- 해외펀드에서 해외주식형은 대유형이고, 글로벌주식은 그 하위 소유형으로 구분됩니다.   
- 구분의 축은 국외투자 펀드의 유형분류 기준인 “투자지역”이며, 글로벌주식은 복수의 국가 주식에 투자하는 소유형(아태/아태(ex J) 내 일본비중 조건 포함)입니다.   
- 이에 유형별 BM에서는 글로벌주식의 소유형 BM을 MSCI ACWI로 두어, 다른 소유형(예: 유럽주식 MSCI EUROPE, 중국주식 MSCI CHINA)과 BM으로 구분합니다.
```
...
## Assistant Response
```text
해외펀드는 대유형(해외주식형)과 그 안의 소유형(예: 글로벌주식)으로 나누고, 각각에 유형별 BM을 매칭합니다. 

- 해외주식형(대유형) 구분 기준: 약관상 주식 또는 주식펀드 투자한도가 최고 2/3를 초과하면서, 투자가능 주식의 2/3 이상을 해외주식(또는 해외 특정지역)에 투자하는 펀드입니다.   
- 글로벌주식(소유형) 구분 기준: 복수의 국가 주식에 투자하는 펀드입니다.   
- 참고로 유형별 BM 매핑: 글로벌주식의 소유형 BM은 MSCI ACWI입니다.
```
...
## Assistant Response
```text
해외펀드에서는 대유형(해외주식형)과 소유형(글로벌주식)을 유형별로 나누고, 그 구분에 따라 BM(벤치마크)이 연결됩니다. 

- 해외주식형(대유형) 구분 기준: 약관상 주식 또는 주식펀드 투자한도가 최고 2/3를 초과하면서, 투자가능 주식의 2/3 이상을 해외주식(또는 해외 특정지역)에 투자하는 펀드입니다. 
- 글로벌주식(소유형) 구분 기준: 복수의 국가 주식에 투자하는 펀드입니다(다만 아태/아태(ex J)는 일본비중 30% 기준으로 나뉩니다). 
- (유형별 BM 연결) 위 구분 중 글로벌주식의 유형 BM은 MSCI ACWI로 설정됩니다.
```
...
## Assistant Response
```text
해외펀드는 “유형”을 먼저 나눈 뒤, 그 유형에 맞는 벤치마크(BM)를 붙이는데, 이때 “해외주식형(대유형)”과 그 안의 “글로벌주식(소유형)”은 정의(분류 기준)로 구분됩니다. 

- 해외주식형(대유형) 기준: 약관상 주식 또는 주식펀드 투자한도가 최고 2/3를 초과하면서, 투자가능 주식의 2/3 이상을 해외주식(또는 해외 특정지역)에 투자하는 펀드 
- 글로벌주식(소유형) 기준: 복수의 국가 주식에 투자하는 펀드(단, 아태/아태(ex J) 구분은 일본 비중 30% 기준으로 나뉨) 
- BM 관점의 차이: 해외주식형 중 소유형이 “글로벌주식”으로 분류되면 그 소유형 BM으로 MSCI ACWI를 사용합니다.
```
...
## Assistant Response
```text
해외펀드의 유형별 BM에서는 펀드를 먼저 대유형(해외주식형)과 소유형(글로벌주식)으로 나눠, 소유형에 해당하는 지수를 기준으로 삼습니다. 

- 해외주식형(대유형) 구분 기준: 약관상 주식 또는 주식펀드 투자한도가 최고 2/3를 초과하고, 투자가능 주식의 2/3 이상을 해외주식(또는 해외 특정지역)에 투자하는 펀드   
- 글로벌주식(소유형) 구분 기준: 복수의 국가 주식에 투자하는 펀드(단, 아태는 일본 비중 30% 이상, 아태(ex J)는 일본 비중 30% 미만)   
- 참고(유형별 BM 연결): 글로벌주식으로 분류되면 유형 BM은 MSCI ACWI로 정해집니다.
```

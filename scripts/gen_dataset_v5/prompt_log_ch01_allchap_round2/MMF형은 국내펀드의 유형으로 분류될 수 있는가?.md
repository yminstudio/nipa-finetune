...
```json
{
  ...
  "target_total": 100,
  "generated_question": "MMF형은 국내펀드의 유형으로 분류될 수 있는가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "국내펀드",
  "seed_title": "국내펀드",
  "question": "MMF형은 국내펀드의 유형으로 분류될 수 있는가?",
...
## Assistant Response
```text
- 예. 제로인의 국내펀드 유형 분류에서 대유형에 MMF형이 포함됩니다.   
- 국내투자 펀드는 자산유형을 기준으로 운용전략·스타일에 따라 유형을 나누며, MMF형은 “가중평균 잔존만기 90일 이내”의 채권형 자산에 투자하는 펀드로 설명됩니다.
```
...
## Assistant Response
```text
제로인에서는 펀드 유형을 투자설명서의 투자목적·투자전략을 바탕으로 분류하며, 국내투자펀드는 자산유형 중심으로 판단합니다. 

따라서 MMF형은 국내펀드의 유형으로 분류될 수 있습니다.   
- 국내펀드 유형 체계 안에 대유형으로 “MMF형”이 포함됩니다.   
- MMF형은 가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드로 정의됩니다.   
- 또한 CP, CD, Call 등 1년 미만의 단기금융상품에만 투자하는 것으로 설명됩니다.
```
...
## Assistant Response
```text
펀드 유형분류에서 제로인은 먼저 국내/해외를 구분한 뒤, 국내투자펀드는 그 운용전략·스타일 등 자산유형 기준으로 국내 유형을 정리합니다. 

- 국내펀드의 유형 분류 체계에 대유형으로 “MMF형”이 포함되어 있어, MMF형은 국내펀드의 유형으로 분류될 수 있습니다.   
- MMF형은 “가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드”로, CP·CD·Call 등 1년 미만 단기금융상품에만 투자하는 것으로 설명됩니다.
```
...
## Assistant Response
```text
국내투자 펀드의 “유형”을 제로인 기준으로 나눌 때, MMF형이 국내 유형으로 포함되는지 묻는 질문이다. 

- 제로인은 유형분류를 투자설명서의 투자목적·투자전략에 따라 하며, 국내투자 펀드는 “자산유형 → 운용전략, 스타일”을 기준으로 국내/국외를 판단한다.   
- 국내펀드의 유형(대유형/소유형) 구성에 MMF형이 포함되어 있다.   
- MMF형은 “가중평균 잔존만기 90일 이내인 채권형 자산”에 투자하고, CP·CD·Call 등 1년 미만의 단기금융상품에만 투자하는 것으로 설명된다.   

따라서 MMF형은 국내펀드의 유형으로 분류될 수 있다.
```
...
## Assistant Response
```text
국내펀드는 투자설명서상 투자목적/전략을 바탕으로 유형을 나누며, 그중 자산유형·운용전략(국내 기준)으로 분류합니다. 

따라서 MMF형은 국내펀드의 유형으로 분류될 수 있습니다.   
- 제로인 국내펀드의 유형 목록에 “MMF형(MMF)”이 포함됩니다.   
- MMF형은 “가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드”로 정의됩니다.   
- 세부적으로는 CP, CD, Call 등 “1년 미만의 단기금융상품에만 투자”하는 것으로 설명됩니다.
```

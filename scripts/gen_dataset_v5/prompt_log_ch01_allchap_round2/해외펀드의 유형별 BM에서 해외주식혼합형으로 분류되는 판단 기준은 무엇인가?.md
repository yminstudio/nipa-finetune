...
## Question
해외펀드의 유형별 BM에서 해외주식혼합형으로 분류되는 판단 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "해외펀드의 유형별 BM에서 해외주식혼합형으로 분류되는 판단 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "BM_해외주식혼합형_판단기준"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "3) 해외펀드의 유형별 BM",
  "question": "해외펀드의 유형별 BM에서 해외주식혼합형으로 분류되는 판단 기준은 무엇인가?",
...
## Assistant Response
```text
- 약관상 최고 주식투자한도가 40~70%(주식혼합)인 경우   
- 투자가능 주식의 2/3 이상을 해외주식에 투자하는 펀드
```
...
## Assistant Response
```text
해외펀드 유형별 BM을 정할 때, 해외주식혼합형은 “혼합(주식+기타자산)” 성격을 가지면서 주식의 해외편입 비중이 일정 조건을 충족하는지로 판단합니다. 

- 약관상 최고 주식투자한도가 40~70%(주식혼합 범위)일 것   
- 투자가능 주식의 2/3 이상을 해외주식에 투자할 것   
- (해외주식혼합형의 세부 소유형을 나누는 방식) 지역구분은 추정 상관성을 감안해 결정하며, 복합지역 혼합형은 글로벌·신흥국·아시아태평양 3개만 인정합니다.
```
...
## Assistant Response
```text
해외펀드에서 ‘해외주식혼합형’으로 분류되려면, 약관상 주식 편입 한도와 실제 해외주식 투자비중 요건을 동시에 충족해야 합니다. 

- 약관상 최고 주식투자한도가 40~70%(주식혼합 구간)인 경우 
- 투자가능 주식의 2/3 이상을 해외주식(또는 해외 특정지역)으로 투자하는 경우 
- 위 요건을 만족하는 펀드는 해외혼합형 중 ‘해외주식혼합형(예: 글로벌주식혼합 등)’으로 분류됩니다.
```
...
## Assistant Response
```text
해외펀드의 유형별 BM을 적용할 때, 펀드를 ‘해외주식혼합형’으로 판단하는 핵심 기준은 혼합의 성격(주식 편입한도)과 해외주식 투자비중이다. 

- 약관상 최고 주식투자한도가 40~70%에 해당(‘주식혼합’ 구간)   
- 투자가능 주식 중 2/3 이상을 해외주식에 투자
```
...
## Assistant Response
```text
해외펀드의 유형별 BM을 적용할 때, 펀드가 ‘해외주식혼합형’으로 분류되는지 먼저 판단합니다. 

- 약관상 최고 주식투자한도가 40~70%인 경우(해외혼합형 중 주식혼합)   
- 투자가능 주식의 2/3 이상을 해외주식에 투자하는 펀드
```

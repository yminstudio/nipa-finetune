...
## Question
국내펀드의 유형별 BM에서 절대수익추구형의 구분 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "국내펀드의 유형별 BM에서 절대수익추구형의 구분 기준은 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "2) 국내펀드의 유형별 BM",
  "question": "국내펀드의 유형별 BM에서 절대수익추구형의 구분 기준은 무엇인가?",
...
## Assistant Response
```text
절대수익추구형(국내 유형별 BM의 구분)은 다음 3가지 하위유형의 전략 특성으로 나뉩니다.   
- 채권알파: 투자설명서상 절대수익을 추구하면서 마켓타이밍 전략을 주로 쓰되, 평균 주식편입비가 약 10% 수준일 것으로 추정되는 펀드   
- 시장중립: 저평가주식 매수-고평가선물 매도 등으로 시장포지션을 중립화하는 전략을 주로 쓰면서 절대수익을 추구하는 펀드   
- 공모주하이일드: 투기등급 채권에 투자 가능하면서도 공모주식에도 투자하는 펀드(공모주 우선배정권이 있었던 펀드)
```
...
## Assistant Response
```text
국내펀드의 유형별 BM에서 절대수익추구형은 “투자설명서상 절대수익을 추구”한다는 큰 틀 아래, 하위 전략/구성특성에 따라 3개로 나뉩니다. 

- 채권알파: 투자설명서상 절대수익을 추구하며, 마켓타이밍 전략을 주로 취하고 평균 주식편입비가 약 10% 수준일 것으로 추정되는 펀드   
- 시장중립: 저평가주식 매수-고평가 선물매도 등으로 시장 포지션을 중립화하는 전략을 주로 취하면서 절대수익을 추구하는 펀드   
- 공모주하이일드: 투기등급 채권에 투자 가능하면서도 공모주(공모주 우선배정권이 있었던 펀드)에도 투자하는 펀드   

이 구분에 따라 절대수익추구형의 유형별 BM도 채권/주식 비중이 달리 설정되는데, 예컨대 채권알파는 주식 10% + 채권(1년) 90%, 시장중립/공모주하이일드는 주식 5% + 채권(1년) 95%로 제시됩니다.
```
...
## Assistant Response
```text
국내펀드의 유형별 BM에서 절대수익추구형은 투자설명서상 ‘절대수익 추구’ 방식에 따라 소유형(3가지)로 나뉘며, 그 소유형별로 서로 다른 유형 BM이 적용됩니다. 

- 채권알파: 절대수익을 추구하고 마켓타이밍 전략을 주로 사용하되, 평균 주식편입비가 10% 수준일 것으로 추정되는 펀드   
  → BM: KOSPI200 10% + 매경 BP 종합채권 1년 90% 
- 시장중립: 저평가 주식 매수–고평가 선물 매도 등으로 시장 포지션을 중립화하면서 절대수익을 추구하는 펀드   
  → BM: KOSPI200 5% + 매경 BP 종합채권 1년 95% 
- 공모주하이일드: 투기등급채권에 투자 가능하면서도 공모주(공모주 우선배정권이 있었던 펀드)에도 투자하는 펀드   
  → BM: KOSPI200 5% + 매경 BP 회사채 I-BBB 종합 2년 95%
```
...
## Assistant Response
```text
국내펀드의 유형별 BM에서는 ‘절대수익형’ 중에서도 절대수익을 추구하는 소유형(절대수익추구형)을 세부 전략에 따라 나누고, 그에 맞는 소유형 BM을 설정합니다. 

- 채권알파: 투자설명서상 절대수익을 추구하면서 마켓타이밍 전략을 주로 쓰고, 평균 주식편입비가 약 10% 수준일 것으로 추정되는 펀드 → 소유형 BM: KOSPI200 10% + 매경 BP 종합채권 1년 90%    
- 시장중립: 저평가주식 매수-고평가 선물 매도 등으로 시장 포지션을 중립화하는 전략을 주로 쓰면서 절대수익을 추구하는 펀드 → 소유형 BM: KOSPI200 5% + 매경 BP 종합채권 1년 95%    
- 공모주하이일드: 투기등급 채권에 투자 가능하면서도 공모주(공모주 우선배정권이 있었던 펀드)에도 투자하는 펀드 → 소유형 BM: KOSPI200 5% + 매경 BP 회사채 I-BBB 종합 2년 95%
```
...
## Assistant Response
```text
국내펀드에서 유형별 BM을 설정할 때, 절대수익형(절대수익을 추구하는 펀드) 내 “절대수익추구형”은 투자설명서상 전략 성격과 편입 수준/구성에 따라 채권알파·시장중립·공모주하이일드로 구분합니다. 

- 채권알파: 투자설명서상 절대수익을 추구하며 마켓타이밍 전략을 주로 취하고, 평균 주식편입비가 10% 수준일 것으로 추정되는 펀드   
- 시장중립: 저평가 주식 매수–고평가 선물 매도 등을 통해 시장 포지션을 중립화하는 전략을 주로 취하면서 절대수익을 추구하는 펀드   
- 공모주하이일드: 투기등급 채권에 투자 가능하면서도 공모주식에도 투자하는 펀드(공모주 우선배정권이 있었던 펀드)
```

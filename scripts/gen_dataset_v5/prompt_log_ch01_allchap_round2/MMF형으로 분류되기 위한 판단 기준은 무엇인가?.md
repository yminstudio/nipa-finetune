...
```json
{
  ...
  "target_total": 100,
  "generated_question": "MMF형으로 분류되기 위한 판단 기준은 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1.3. 유형분류 기준",
  "question": "MMF형으로 분류되기 위한 판단 기준은 무엇인가?",
...
## Assistant Response
```text
- MMF형은 가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드로 분류합니다.   
- MMF형(설명 기준)은 CP, CD, Call 등 1년 미만의 단기금융상품에만 투자하는 경우입니다.
```
...
## Assistant Response
```text
제로인은 투자설명서상의 투자목적과 투자전략에 따라 펀드 유형을 분류하며, MMF형은 운용자산의 ‘단기 성격’ 요건으로 판단합니다. 

- 가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드   
- CP, CD, Call 등 1년 미만의 단기금융상품에만 투자
```
...
## Assistant Response
```text
MMF형은 펀드를 유형분류할 때, 투자대상이 “단기 금융자산 중심”인지에 따라 판단합니다. 

- 펀드가 가중평균 잔존만기 90일 이내인 채권형 자산에 투자해야 합니다.   
- 투자대상은 CP, CD, Call 등 1년 미만의 단기금융상품에만 투자하는 펀드로 설명됩니다.
```
...
## Assistant Response
```text
제로인은 펀드 유형을 투자설명서상의 투자목적과 투자전략에 따라 분류합니다. 

- MMF형으로 분류되려면, 가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드여야 합니다.   
- 또한 CP, CD, Call 등 1년 미만의 단기금융상품에만 투자해야 합니다.
```
...
## Assistant Response
```text
제로인에서는 투자설명서의 투자목적과 투자전략을 기준으로 펀드 유형을 분류하며, 그에 따라 MMF형을 가릅니다. 

- MMF형: 가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드   
- MMF형 세부 조건: CP, CD, Call 등 1년 미만의 단기금융상품에만 투자
```

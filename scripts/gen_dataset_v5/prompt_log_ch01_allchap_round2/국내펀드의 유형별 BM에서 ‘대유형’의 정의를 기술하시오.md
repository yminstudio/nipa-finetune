...
## Question
국내펀드의 유형별 BM에서 ‘대유형’의 정의를 기술하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "국내펀드의 유형별 BM에서 ‘대유형’의 정의를 기술하시오.",
  "qa_type": "definition",
  "question_template": "definition_대유형"
}
```
...
```json
{
  ...
  "subsection": "국내펀드의 유형별 BM",
  "seed_title": "국내펀드의 유형별 BM",
  "question": "국내펀드의 유형별 BM에서 ‘대유형’의 정의를 기술하시오.",
...
## Assistant Response
```text
국내펀드의 유형별 BM에서 ‘대유형’은 ‘소유형’을 묶어 구분하는 상위 유형이다.   
대유형은 주식형, 주식혼합형, 채권혼합형, 채권형, MMF, 부동산형으로 설정되며, 각 대유형에 속한 소유형별 소유형 BM이 제시된다.   
또한 표시된 소유형 BM 중 일부는 해당 소유형이 속한 대유형의 BM과 동일하게 취급된다.
```
...
## Assistant Response
```text
국내펀드 유형별 BM은 펀드를 ‘대유형-소유형’ 체계로 구분한 뒤, 대유형에 속한 소유형에 해당하는 BM을 적용해 비교합니다. 

대유형의 정의는 다음과 같습니다.   
- 대유형은 국내펀드 유형분류에서 자산유형을 바탕으로 운용전략·스타일 관점을 반영해 나눈 상위 분류입니다.  
- 유형별 BM 표에서 대유형은 주식형, 주식혼합형, 채권혼합형, 채권형, MMF, 부동산형처럼 상위 범주로 제시됩니다.   
- 각 대유형은 그 하위의 소유형을 구분하며, 해당 소유형에 대응하는 소유형 BM이 연결됩니다.
```
...
## Assistant Response
```text
국내펀드의 유형별 BM은 대유형-소유형 구조로 정해지며, 이때 대유형은 국내펀드 유형분류의 상위 구분으로 적용된다. 

- 정의: 대유형은 국내투자펀드를 “자산유형” 기준으로 먼저 묶어 분류한 상위 범주(대유형)이며, 그 아래에서 운용전략·스타일에 따라 소유형으로 세분된다.   
- 국내 유형별 BM에서의 구성: 대유형에는 주식형, 주식혼합형, 채권혼합형, 채권형, MMF, 부동산형이 포함되며, 각 대유형 아래 소유형이 존재한다.   
- 대유형의 역할(비교 기준): 국내펀드에서 테마 및 기타인덱스를 제외하면 펀드 BM을 유형 BM으로 두므로, 대유형에 연결된 소유형 BM이 곧 비교를 위한 BM 기준이 된다.
```
...
## Assistant Response
```text
국내펀드의 유형별 BM은 먼저 자산유형을 기준으로 큰 틀을 잡고, 이후 운용전략/스타일을 반영해 세부(소유형)로 나누는 체계로 구성됩니다. 

- ‘대유형’ 정의: 국내펀드 유형분류에서 자산유형을 기준으로 먼저 구분한 최상위 유형입니다.   
- 대유형 구성(유형별 BM 표 기준): 주식형, 주식혼합형, 채권혼합형, 채권형, MMF, 부동산형으로 제시됩니다.   
- 대유형-소유형 관계: 각 대유형은 그 아래 소유형을 두고, 소유형마다 해당 소유형 BM이 배정됩니다.
```
...
## Assistant Response
```text
국내펀드의 유형별 BM을 만들 때는 소유형 BM을 먼저 정하고, 그 소유형을 묶는 상위 구분으로 ‘대유형’을 사용합니다. 

- 정의: 국내펀드 유형별 BM에서 ‘대유형’은 소유형(하위 유형)과 그에 대응하는 소유형 BM을 포함하는 최상위 유형 구분입니다.   
- 기준: 국내투자 펀드는 자산유형을 바탕으로 운용전략·스타일에 따라 유형을 분류하며, 이 분류 체계의 최상위 축이 ‘대유형’입니다.   
- 구성: 국내 유형별 BM의 대유형에는 주식형, 주식혼합형, 채권혼합형, 채권형, MMF, 부동산형, 절대수익추구형, 특별자산, 헤지, 기타가 제시됩니다.
```

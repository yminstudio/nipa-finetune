...
## Question
해외펀드의 유형별 BM에서 해외주식형으로 분류되는 판단 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "해외펀드의 유형별 BM에서 해외주식형으로 분류되는 판단 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "BM_해외주식형_판단기준"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "3) 해외펀드의 유형별 BM",
  "question": "해외펀드의 유형별 BM에서 해외주식형으로 분류되는 판단 기준은 무엇인가?",
...
## Assistant Response
```text
- 해외주식형으로 분류되려면, 약관상 주식 또는 주식펀드 투자한도가 최고 2/3를 초과해야 합니다.   
- 또한 투자가능 주식의 2/3 이상을 해외주식(또는 해외 특정지역)에 투자해야 합니다.   
- 해외펀드의 유형분류는 자산유형을 바탕으로 투자지역/투자섹터로 판단합니다.
```
...
## Assistant Response
```text
해외펀드는 “유형(자산유형/투자지역 등)”에 따라 유형별 BM이 정해지며, 그중 해외주식형에 해당할 때 BM도 주식지수로 매칭됩니다. 

- 해외펀드의 유형분류 판단기준은 자산유형을 바탕으로 투자지역과 투자섹터를 반영하는 것입니다. 
- 해외펀드의 BM은 투자설명서 또는 규약에 명시된 비교지수를 기준으로 설정합니다. 
- 비교지수가 없거나 명확히 정하기 어렵다면, 유형 BM을 사용하며 이때 해외주식형의 소유형별 BM은 예를 들어 글로벌주식=MSCI ACWI, 유럽주식=MSCI EUROPE, 중국주식=MSCI CHINA로 제시됩니다. 
- 해외주식형에 적용되는 지수는 환헷지 여부에 따라 달라져, 환헷지 시 로컬지수, 환헷지 미실시 시 원화환산 지수가 적용됩니다(적극적으로 밝힌 경우만 인정).
```
...
## Assistant Response
```text
해외펀드는 투자설명서의 내용에 따라 유형을 먼저 정한 뒤, 그 유형의 BM을 기준으로 운용성과를 비교합니다. 

- 유형 분류의 출발점은 투자설명서에 있는 투자목적과 투자전략입니다.   
- 국내/국외 분류 중 ‘국외(해외)투자 펀드’는 자산유형을 바탕으로 투자지역과 투자섹터를 기준으로 유형을 정합니다.   
- 이렇게 ‘해외주식형’으로 분류되면, 유형별 BM은 해외주식형의 소유형(예: 글로벌주식, 유럽주식, 중국주식 등)에 해당하는 지수(예: MSCI ACWI, MSCI EUROPE, MSCI CHINA 등)로 연결됩니다.   
- 다만 해외펀드는 펀드가 명시한 비교지수(펀드 BM)가 있으면 그 BM을 우선 적용하고, 비교지수가 없거나 적합성이 떨어질 때 유형 BM으로 대체합니다.
```
...
## Assistant Response
```text
해외펀드의 유형별 벤치마크(BM)를 적용할 때, 펀드를 ‘해외주식형’으로 분류하는 판단 기준은 투자약관과 실제 투자대상(해외주식 비중) 요건을 기준으로 합니다. 

- 약관상 주식 또는 주식펀드 투자한도가 최고 2/3를 초과해야 합니다.   
- 투자가능 주식의 2/3 이상을 해외주식(또는 해외 특정지역)에 투자해야 합니다.
```
...
## Assistant Response
```text
질문은 해외펀드를 ‘유형별 BM’에 매칭하기 위해, 어떤 조건에서 ‘해외주식형’으로 분류되는지(판단 기준)를 묻고 있습니다.  

- 해외주식형은 약관상 주식 또는 주식펀드 투자한도가 최고 2/3를 초과하는 펀드입니다.   
- 또한 투자 가능한 주식의 2/3 이상을 해외주식(또는 해외 특정 지역)에 투자하는 펀드입니다.   
- 이처럼 ‘해외주식형’으로 분류되면, 유형별 BM은 글로벌주식/유럽주식/북미주식 등 소유형에 따라 MSCI 계열 지수(예: MSCI ACWI, MSCI EUROPE)로 설정됩니다.
```

...
## Question
Delta Normal Method의 특징에서 Delta를 이용해 포트폴리오의 수익률 민감도를 반영하는 것이 판단 기준인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Delta Normal Method의 특징에서 Delta를 이용해 포트폴리오의 수익률 민감도를 반영하는 것이 판단 기준인가?",
  "qa_type": "criteria",

...
## Question
주어진 데이터에서 t-1을 포함한 값을 이용해 추정 주식매수회전율(TR)을 계산하는 적용 절차를 한 문장으로 제시하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "주어진 데이터에서 t-1을 포함한 값을 이용해 추정 주식매수회전율(TR)을 계산하는 적용 절차를 한 문장으로 제시하시오.",
  "qa_type": "application",
  "question_template": "Application-TR-EV-estimation"
}
```

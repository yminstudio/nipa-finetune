...
## Question
Delta-Normal 방법에서 포트폴리오의 VaR 산출에 필요한 Delta 값의 산출 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Delta-Normal 방법에서 포트폴리오의 VaR 산출에 필요한 Delta 값의 산출 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "DeltaNormal_VaR_Delta값_산출_기준"
}
```

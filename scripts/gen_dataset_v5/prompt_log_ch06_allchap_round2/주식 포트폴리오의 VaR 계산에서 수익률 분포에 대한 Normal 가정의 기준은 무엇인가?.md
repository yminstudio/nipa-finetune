...
## Question
주식 포트폴리오의 VaR 계산에서 수익률 분포에 대한 Normal 가정의 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "주식 포트폴리오의 VaR 계산에서 수익률 분포에 대한 Normal 가정의 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "DeltaNormal_VaR_Normal가정_기준"
}
```

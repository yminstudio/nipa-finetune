...
## Question
Delta Normal Method의 특징에서 기초자산의 수익률과 포트폴리오 수익률 간의 선형 관계가 성립하는가를 판단 기준으로 삼는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Delta Normal Method의 특징에서 기초자산의 수익률과 포트폴리오 수익률 간의 선형 관계가 성립하는가를 판단 기준으로 삼는가?",
  "qa_type": "criteria",
  "question_template": "Delta_Normal_Method_Feature_Criteria_Template"
}
```

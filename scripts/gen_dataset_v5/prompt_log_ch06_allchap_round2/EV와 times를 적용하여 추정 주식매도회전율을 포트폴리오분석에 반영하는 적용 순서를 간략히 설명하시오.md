...
## Question
EV와 times를 적용하여 추정 주식매도회전율을 포트폴리오분석에 반영하는 적용 순서를 간략히 설명하시오.
...
{
  "chapter": "6. 포트폴리오분석",
  "section": "1) 추정 주식매도회전율",
  "subsection": "",
  "seed_title": "1) 추정 주식매도회전율",
  "record_target": 7,
  ...
  "target_total": 100,
  "generated_question": "EV와 times를 적용하여 추정 주식매도회전율을 포트폴리오분석에 반영하는 적용 순서를 간략히 설명하시오.",
  "qa_type": "application",
...
[핵심 명사]
) 추정 주식매도회전율, 추정 주식매도회전율, 추정, 주식매도회전율, TR, frac, sum, t-1, left, right, EV, times

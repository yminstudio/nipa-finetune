...
## Question
주식 포트폴리오의 VaR를 Delta-Normal 방식으로 산출할 때 필요한 입력값은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "주식 포트폴리오의 VaR를 Delta-Normal 방식으로 산출할 때 필요한 입력값은 무엇인가?",
  "qa_type": "application",
  "question_template": "application_inputs_delta_normal"
}
```

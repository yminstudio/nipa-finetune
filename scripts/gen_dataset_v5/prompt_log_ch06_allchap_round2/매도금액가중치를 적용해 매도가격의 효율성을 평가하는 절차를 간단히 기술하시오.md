...
## Question
매도금액가중치를 적용해 매도가격의 효율성을 평가하는 절차를 간단히 기술하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "매도금액가중치를 적용해 매도가격의 효율성을 평가하는 절차를 간단히 기술하시오.",
  "qa_type": "application",
  "question_template": "application_weighted_evaluation"
}
```

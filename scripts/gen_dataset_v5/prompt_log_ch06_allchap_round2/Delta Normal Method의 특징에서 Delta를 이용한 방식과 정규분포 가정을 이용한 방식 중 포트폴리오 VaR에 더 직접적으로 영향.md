...
## Question
Delta Normal Method의 특징에서 Delta를 이용한 방식과 정규분포 가정을 이용한 방식 중 포트폴리오 VaR에 더 직접적으로 영향을 주는 요소는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Delta Normal Method의 특징에서 Delta를 이용한 방식과 정규분포 가정을 이용한 방식 중 포트폴리오 VaR에 더 직접적으로 영향을 주는 요소는 무엇인가?",
  "qa_type": "comparison",

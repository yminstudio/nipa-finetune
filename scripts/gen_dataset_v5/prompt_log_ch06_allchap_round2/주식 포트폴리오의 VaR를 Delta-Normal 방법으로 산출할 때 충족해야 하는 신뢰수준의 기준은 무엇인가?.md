...
## Question
주식 포트폴리오의 VaR를 Delta-Normal 방법으로 산출할 때 충족해야 하는 신뢰수준의 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "주식 포트폴리오의 VaR를 Delta-Normal 방법으로 산출할 때 충족해야 하는 신뢰수준의 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "DeltaNormal_VaR_신뢰수준_기준"
}
```

...
## Question
월초에 구성된 주식포트폴리오를 월말까지 보유한다고 가정할 때, 평가손익은 어떤 시점의 가치로 반영되는가?
...
{
  "chapter": "6. 포트폴리오분석",
  "section": "6.3. 동결 주식포트폴리오 분석",
  "subsection": "",
  "seed_title": "6.3. 동결 주식포트폴리오 분석",
  "record_target": 7,
  ...
  "target_total": 100,
  "generated_question": "월초에 구성된 주식포트폴리오를 월말까지 보유한다고 가정할 때, 평가손익은 어떤 시점의 가치로 반영되는가?",
  "qa_type": "application",
  "question_template": "application_process"
}
```
...
[핵심 명사]
. 동결 주식포트폴리오 분석, 동결, 주식포트폴리오, 분석, 월초, 주식을, 월말까지, 보유한다고, 가정한, 평가손익, 월말, 동결평가액

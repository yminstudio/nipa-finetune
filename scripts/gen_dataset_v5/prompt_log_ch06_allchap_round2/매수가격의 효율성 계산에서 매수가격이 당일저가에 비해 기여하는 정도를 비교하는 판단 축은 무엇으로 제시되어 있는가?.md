...
## Question
매수가격의 효율성 계산에서 매수가격이 당일저가에 비해 기여하는 정도를 비교하는 판단 축은 무엇으로 제시되어 있는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "매수가격의 효율성 계산에서 매수가격이 당일저가에 비해 기여하는 정도를 비교하는 판단 축은 무엇으로 제시되어 있는가?",
  "qa_type": "comparison",
...
[핵심 명사]
매수가격의 효율성, 매수가격의, 효율성, sum, left, frac, 매수가격, 당일저가, 당일고가, times, 매수금액가중치, right

...
## Question
매도가격의 효율성 평가에서 당일고가를 포함하는 방식과 포함하지 않는 방식을 비교하는 판단축은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "매도가격의 효율성 평가에서 당일고가를 포함하는 방식과 포함하지 않는 방식을 비교하는 판단축은 무엇인가?",
  "qa_type": "comparison",
  "question_template": "comparison_include_vs_exclude"
}
```

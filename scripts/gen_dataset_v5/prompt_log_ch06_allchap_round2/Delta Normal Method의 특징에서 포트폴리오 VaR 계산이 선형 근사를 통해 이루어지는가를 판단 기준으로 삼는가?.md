...
## Question
Delta Normal Method의 특징에서 포트폴리오 VaR 계산이 선형 근사를 통해 이루어지는가를 판단 기준으로 삼는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Delta Normal Method의 특징에서 포트폴리오 VaR 계산이 선형 근사를 통해 이루어지는가를 판단 기준으로 삼는가?",
  "qa_type": "criteria",

...
## Question
Top10 종목 집중도 산정의 판단 기준으로 '기준점 계산 대상'은 무엇으로 정의되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Top10 종목 집중도 산정의 판단 기준으로 '기준점 계산 대상'은 무엇으로 정의되는가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "4) Top10 종목 집중도",
  "question": "Top10 종목 집중도 산정의 판단 기준으로 '기준점 계산 대상'은 무엇으로 정의되는가?",
...
## Assistant Response
```text
- 기준점 계산 대상은 순자산액 100억 이상 평가 공모펀드 중 FoFs, 자펀드를 제외한 펀드로 정의됩니다.   
- 또한 사모펀드는 제외됩니다.
```
...
## Assistant Response
```text
Top10 종목 집중도를 등급화(평균이상/수준/이하)할 때 기준값을 산정하기 위한 대상입니다.   
- 기준점 계산 대상: 순자산액 100억 이상 평가 공모펀드(FoFs, 자펀드 제외)
```
...
## Assistant Response
```text
Top10 종목 집중도에서 ‘기준점’을 정하기 위해 어떤 펀드를 볼지를 정하는 집합이 기준점 계산 대상입니다. 

- 기준점 계산 대상: 순자산액 100억 이상 평가 공모펀드 중 FoFs 및 자펀드를 제외한 펀드(사모펀드는 제외).
```
...
## Assistant Response
```text
Top10 종목 집중도의 “기준점”을 정하기 위한 펀드 모집단은 해당 집중도 분포를 비교할 대상들로 한정됩니다. 

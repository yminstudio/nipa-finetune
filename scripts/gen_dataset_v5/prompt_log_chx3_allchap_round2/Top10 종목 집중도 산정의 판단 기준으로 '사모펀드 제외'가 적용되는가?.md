...
## Question
Top10 종목 집중도 산정의 판단 기준으로 '사모펀드 제외'가 적용되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Top10 종목 집중도 산정의 판단 기준으로 '사모펀드 제외'가 적용되는가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "4) Top10 종목 집중도",
  "question": "Top10 종목 집중도 산정의 판단 기준으로 '사모펀드 제외'가 적용되는가?",
...
## Assistant Response
```text
- Top10 종목 집중도 산정 시 “사모펀드 제외”가 판단 기준으로 적용됩니다.   
- 기준점 계산 대상은 “순자산액 100억 이상 평가 공모펀드(FoFs, 자펀드 제외)”로 정해져 있습니다.
```
...
## Assistant Response
```text
- Top10 종목 집중도가 “어느 펀드들을 대상으로” 비교·기준점 산정하는지를 판단하기 위한 기준입니다.  
- Top10 종목 집중도 산정에는 ‘사모펀드 제외’가 적용되며, 집중도 기준점 계산 대상은 순자산액 100억 이상 평가 공모펀드( FoFs, 자펀드 제외 )입니다.
```
...
## Assistant Response
```text
Top10 종목 집중도는 펀드의 “상위 10개 종목 집중도”를 기준점으로 삼기 위한 산정 대상/구성을 정하는 판단 기준입니다. 

- 네, Top10 종목 집중도 산정에는 “사모펀드 제외”가 적용됩니다. 
- 기준점 계산 대상은 순자산액 100억 이상 평가 공모펀드(FoFs, 자펀드 제외)로 한정되며, 이 과정에서 사모펀드는 제외됩니다.
```
...
## Assistant Response
```text
Top10 종목 집중도 산정을 위해 적용하는 판단 기준에는 “사모펀드 제외”가 포함됩니다.   
따라서 Top10 종목 집중도 산정 시에는 사모펀드를 대상에서 제외합니다.
```

...
## Question
포트폴리오의 사이즈와 운용규모 수준 간의 관계를 판단할 때 어떤 데이터가 우선적으로 활용되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "포트폴리오의 사이즈와 운용규모 수준 간의 관계를 판단할 때 어떤 데이터가 우선적으로 활용되는가?",
  "qa_type": "comparison",
  "question_template": "비교_데이터우선순위"
}
```

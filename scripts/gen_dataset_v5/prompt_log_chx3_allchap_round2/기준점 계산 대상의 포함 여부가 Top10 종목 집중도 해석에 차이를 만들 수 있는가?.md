...
## Question
기준점 계산 대상의 포함 여부가 Top10 종목 집중도 해석에 차이를 만들 수 있는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "기준점 계산 대상의 포함 여부가 Top10 종목 집중도 해석에 차이를 만들 수 있는가?",
  "qa_type": "comparison",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "4) Top10 종목 집중도",
  "question": "기준점 계산 대상의 포함 여부가 Top10 종목 집중도 해석에 차이를 만들 수 있는가?",
...
## Assistant Response
```text
- 제로인의 Top10 종목 집중도 기준점은 ‘기준점 계산 대상’으로 정한 펀드(순자산액 100억 이상 평가 공모펀드: FoFs·자펀드 제외, 사모펀드 제외)의 집중도를 내림차순 정렬해 상한/하한(33.1%/67.0%)에 해당하는 집중도로 정해집니다.   
- 따라서 기준점 계산 대상의 포함/제외가 달라지면, 그 기준점(상한/하한 기준 집중도)이 달라질 수 있고, 그에 따라 해당 집중도를 ‘평균이상/평균수준/평균이하’로 해석(판정)하는 결과도 달라질 수 있습니다.   
- 한편, 이렇게 산출된 기준값은 펀드규모 관계없이 전 펀드에 동일 기준으로 적용됩니다.
```
...
## Assistant Response
```text
- 제로인에서 Top10 종목 집중도는 “기준점 계산 대상”인 순자산액 100억 이상 평가 공모펀드(FoFs, 자펀드 제외)에서 집중도를 내림차순 정렬한 뒤 33.1%(상한)·67.0%(하한)에 해당하는 펀드의 집중도를 기준점으로 정해 해석합니다.   
- 따라서 기준점 계산 대상의 포함/제외가 바뀌면, 해당 내림차순 분포를 구성하는 펀드가 달라져 33.1%·67.0%에 해당하는 집중도(기준점)도 달라질 수 있고, 그 결과 “평균이상/평균수준/평균이하”로 보는 해석이 달라질 수 있습니다.   
- 또한 기준점 자체는 펀드 규모와 무관하게 전펀드에 적용하지만, “기준점이 정해지는 모집단(포함 대상)”이 달라지면 해석의 기준은 변합니다.
```
...
## Assistant Response
```text
- 제로인 방법론에서 Top10 종목 집중도의 기준점은 “순자산액 100억 이상 평가 공모펀드(FoFs, 자펀드 제외)”를 기준으로 내림차순 정렬 후 33.1%(상한), 67.0%(하한)에 해당하는 집중도를 산출합니다.   
- 이렇게 정해진 기준값은 펀드 규모와 무관하게 전 펀드에 적용되어, 상한보다 많은 집중수는 ‘평균이상’, 상한~하한은 ‘평균수준’, 하한보다 적은 집중수는 ‘평균이하’로 해석합니다.   
- 따라서 기준점 계산 대상의 포함 여부가 달라지면(=기준점 산출에 쓰인 펀드 집합이 달라지면) 기준값이 달라질 수 있고, 그에 따라 같은 Top10 집중도라도 ‘평균이상/수준/이하’ 해석이 달라질 수 있습니다.
```
...
## Assistant Response
```text
- Top10 종목 집중도는 “기준점”을 먼저 정한 뒤, 해당 펀드의 집중도와 기준점의 상·하한을 비교해 ‘평균이상/평균수준/평균이하’로 해석합니다.   
- 이 기준점은 “기준점 계산 대상”의 집중도 분포로부터 정해지며, 기준점 계산 대상은 순자산액 100억이상 평가 공모펀드(FoFs, 자펀드 제외)로 한정됩니다.   
- 따라서 기준점 계산 대상의 포함 여부가 달라지면 기준점(상한·하한 집중도)이 달라질 수 있고, 그 결과 같은 Top10 집중도라도 평균이상/평균수준/평균이하 해석이 달라질 수 있습니다.
```

...
## Question
BM대비 성과요인 분석에서 세 가지 효과의 합이 나타내는 지표는 무엇인가요?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "BM대비 성과요인 분석에서 세 가지 효과의 합이 나타내는 지표는 무엇인가요?",
  "qa_type": "application",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "5.1. BM대비 성과요인 분석",
  "question": "BM대비 성과요인 분석에서 세 가지 효과의 합이 나타내는 지표는 무엇인가요?",
...
## Assistant Response
```text
- BM대비 성과요인 분석에서 세 가지 효과(자산배분효과 + 자산배분타이밍효과 + 종목선정효과)를 합산합니다.   
- 그 합이 나타내는 지표는 “BM대비 초과수익률”입니다.   
- 즉, BM대비 초과수익률 = 자산배분효과 + 자산배분타이밍효과 + 종목선정효과로 전환해 해석합니다.
```
...
## Assistant Response
```text
- 특정 기간 동안 BM대비 성과요인 분석을 수행할 때, 자산배분효과 + 자산배분타이밍효과 + 종목선정효과를 각각 산출합니다.   
- 그 세 효과 값을 더하는 방식으로 통합합니다.  
- 세 가지 효과의 합이 곧 “BM대비 초과수익률”을 나타내는 지표입니다.
```
...
## Assistant Response
```text
- 적용대상/맥락: 특정 기간의 BM 대비 초과수익(또는 초과손실)을 세 가지 성과요인으로 분해하는 경우   
- 적용 순서: 자산배분효과 + 자산배분타이밍효과 + 종목선정효과를 각각 구한 뒤   
- 전환 규칙(합의 지표): 세 가지 효과의 합은 “BM대비 초과수익률”로 귀결됩니다   
- 수식 형태: BM대비 초과수익률 = 자산배분효과 + 자산배분타이밍효과 + 종목선정효과
```
...
## Assistant Response
```text
- (적용 대상/맥락) BM 대비 성과요인 분석에서 특정 기간 동안의 BM대비 초과수익(또는 초과손실) 원인을 분해할 때   
- (적용 순서) 자산배분효과, 자산배분타이밍효과, 종목선정효과를 각각 계산한 뒤   
- (전환 규칙/결론) 세 가지 효과의 합 = “BM대비 초과수익률(또는 초과손실)”   
- (적용 조건) 위 합산은 BM대비 성과요인 분석의 3분해(자산배분+자산배분타이밍+종목선정) 체계에서 동일하게 적용
```

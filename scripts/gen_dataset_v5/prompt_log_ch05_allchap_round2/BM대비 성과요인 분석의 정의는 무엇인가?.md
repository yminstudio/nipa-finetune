...
```json
{
  ...
  "target_total": 100,
  "generated_question": "BM대비 성과요인 분석의 정의는 무엇인가?",
  "qa_type": "definition",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "5.1. BM대비 성과요인 분석",
  "question": "BM대비 성과요인 분석의 정의는 무엇인가?",
...
## Assistant Response
```text
- BM대비 성과요인 분석은 특정 기간 동안 BM대비 초과수익(또는 초과손실)의 원인을 분석하는 것으로, 크게 자산배분효과·자산배분타이밍효과·종목선정효과의 3가지로 나누어 설명합니다.   
- BM대비 초과수익률 = 자산배분효과 + 자산배분타이밍효과 + 종목선정효과 입니다.   
- 자산배분효과 = 평균편입비수익률 – BM수익률, 자산배분타이밍효과 = 실제편입비수익률 – 평균편입비수익률, 종목선정효과 = 펀드수익률 – 실제편입비수익률입니다.
```
...
## Assistant Response
```text
BM대비 성과요인 분석은 “특정 기간 동안 BM대비 초과수익(또는 초과손실)의 원인”을 파악하기 위해, 성과를 자산배분효과·자산배분타이밍효과·종목선정효과로 나누어 설명하는 분석을 말합니다. 

- BM대비 초과수익률 = 자산배분효과 + 자산배분타이밍효과 + 종목선정효과   
- 자산배분효과 = 평균편입비수익률 – BM수익률   
- 자산배분타이밍효과 = 실제편입비수익률 – 평균편입비수익률, 종목선정효과 = 펀드수익률 – 실제편입비수익률
```
...
## Assistant Response
```text
BM대비 성과요인 분석은 특정 기간 동안 BM 대비 초과수익(또는 초과손실)의 원인을 설명하는 분석을 말하며, 이를 크게 자산배분효과, 자산배분타이밍효과, 종목선정효과의 3가지로 나누어 정리합니다.   
- BM대비 초과수익률 = 자산배분효과 + 자산배분타이밍효과 + 종목선정효과   
- 자산배분효과 = 평균편입비수익률 − BM수익률   
- 자산배분타이밍효과 = 실제편입비수익률 − 평균편입비수익률, 종목선정효과 = 펀드수익률 − 실제편입비수익률
```
...
## Assistant Response
```text
BM대비 성과요인 분석은 특정 기간 동안 BM 대비 초과수익(또는 초과손실)이 발생한 원인을 분해해 설명하는 분석이다.   
초과성과는 크게 자산배분효과, 자산배분타이밍효과, 종목선정효과의 3가지로 나누어 설명한다.   
즉, BM대비 초과수익률은 자산배분효과 + 자산배분타이밍효과 + 종목선정효과로 구성된다.
```

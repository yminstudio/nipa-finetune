...
```json
{
  ...
  "target_total": 100,
  "generated_question": "펀드수익률과 BM수익률의 차이로 설명되는 효과는?",
  "qa_type": "comparison",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "5.1. BM대비 성과요인 분석",
  "question": "펀드수익률과 BM수익률의 차이로 설명되는 효과는?",
...
## Assistant Response
```text
- 펀드수익률과 BM수익률의 차이는 BM대비 초과수익률(또는 초과손실)로 설명됩니다.   
- 이 BM대비 초과수익률은 자산배분효과, 자산배분타이밍효과, 종목선정효과로 나누어 설명합니다.   
- 즉, “펀드수익률 – BM수익률”에 해당하는 초과성과를 위 3개 효과의 합으로 파악합니다.
```
...
## Assistant Response
```text
펀드수익률과 BM수익률의 차이(= BM대비 초과수익/초과손실)는 자산배분효과, 자산배분타이밍효과, 종목선정효과의 합으로 설명합니다. 
...
## Assistant Response
```text
펀드수익률과 BM수익률의 차이는 BM대비 초과수익률로 보고, 이를 3가지 성과요인으로 분해해 설명합니다. 
...
## Assistant Response
```text
펀드수익률과 BM수익률의 차이(= BM대비 초과수익률)는, 특정 기간 동안 성과가 BM을 얼마나 넘었는지를 설명하는 성과요인으로 보고   
- 자산배분효과: 평균편입비수익률 – BM수익률   
- 자산배분타이밍효과: 실제편입비수익률 – 평균편입비수익률   
- 종목선정효과: 펀드수익률 – 실제편입비수익률
```

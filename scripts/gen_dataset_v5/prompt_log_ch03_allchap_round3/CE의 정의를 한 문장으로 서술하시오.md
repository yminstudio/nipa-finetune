...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0026

## Question
CE의 정의를 한 문장으로 서술하시오.
...
```json
{
  ...
  "section": "6) 확실성등가 ; Certainty Equivalence(CE)",
  "subsection": "",
  "seed_title": "6) 확실성등가 ; Certainty Equivalence(CE)",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "CE의 정의를 한 문장으로 서술하시오.",
  "qa_type": "definition",
...
[핵심 명사]
) 확실성등가 ; Certainty Equivalence(CE), 확실성등가 ; Certainty Equivalence, CE, 확실성등가, Certainty, Equivalence, 샤프지수, 트레이너, 지수, 등은, 각각의, 장점에도
...
## Assistant Response
```text
- CE(Certainty Equivalence)는 제로인이 펀드등급(태극마크)을 산출하기 위한 기초값으로, 효용함수와 같은 의미이며 위험조정 성과를 나타냅니다.   
- 즉 CE는 위험을 반영해 수익을 효용 관점에서 정리한 값입니다.
```

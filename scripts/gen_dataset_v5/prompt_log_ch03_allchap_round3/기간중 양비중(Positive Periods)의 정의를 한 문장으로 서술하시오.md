...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0017

## Question
기간중 양비중(Positive Periods)의 정의를 한 문장으로 서술하시오.
...
```json
{
  ...
  "section": "15) 기간중 양비중 ; Positive Periods",
  "subsection": "",
  "seed_title": "15) 기간중 양비중 ; Positive Periods",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "기간중 양비중(Positive Periods)의 정의를 한 문장으로 서술하시오.",
  "qa_type": "definition",
...
[핵심 명사]
) 기간중 양비중 ; Positive Periods, 기간중 양비중 ; Positive Periods, 기간중, 양비중, Positive, Periods, 전체, 기간, 환산, 플러스, 수익이, 발생했던

...
## Assistant Response
```text
- Sterling Ratio는 펀드의 연복리(연환산) 수익률을 “평균 최대낙폭에서 10%를 뺀 값”으로 나눈 비율로, 위험 대비 수익을 나타내는 지표입니다.   
- 산식은 Sterling Ratio = Annualized Rate of Return / |Average Maximum Drawdown − 10%| 입니다.   

...
## Question
Sterling Ratio와 Calmar Ratio의 공통된 계산 기반은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Sterling Ratio와 Calmar Ratio의 공통된 계산 기반은 무엇인가?",
  "qa_type": "comparison",
  "question_template": "Sterling_Calmar_Comparison_Template"
}
```

...
## Question
Average Gain의 판단 기준에서 이익의 산정 방식으로 단순평균이 사용되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Average Gain의 판단 기준에서 이익의 산정 방식으로 단순평균이 사용되는가?",
  "qa_type": "criteria",
  "question_template": "criteria_calculation_method"
}
```

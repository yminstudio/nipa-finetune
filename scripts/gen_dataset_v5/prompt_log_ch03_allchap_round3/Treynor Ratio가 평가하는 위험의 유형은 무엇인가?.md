...
## Question
Treynor Ratio가 평가하는 위험의 유형은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Treynor Ratio가 평가하는 위험의 유형은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_risk_type"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "3) 트레이너지수 ; Treynor Ratio",
  "question": "Treynor Ratio가 평가하는 위험의 유형은 무엇인가?",
...
## Assistant Response
```text
Treynor Ratio는 펀드의 위험을 감안해 성과(무위험 초과수익)를 평가할 때, 위험의 어떤 유형을 측정하는지에 해당합니다. 

- 평가하는 위험 유형은 체계적 위험입니다.   
- 체계적 위험은 베타(펀드와 시장 또는 BM과의 베타)로 반영합니다.   
- 비체계적 위험은(분산투자로 상쇄 가능한 관점에서) 초과수익에 기여할 수 없다고 보고, 체계적 위험만을 위험으로 사용합니다.
```

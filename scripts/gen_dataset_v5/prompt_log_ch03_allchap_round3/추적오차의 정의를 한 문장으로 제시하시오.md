...
```json
{
  ...
  "section": "8) 추적오차 ; Tracking Error",
  "subsection": "",
  "seed_title": "8) 추적오차 ; Tracking Error",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "추적오차의 정의를 한 문장으로 제시하시오.",
  "qa_type": "definition",
...
[핵심 명사]
) 추적오차 ; Tracking Error, 추적오차 ; Tracking Error, 추적오차, Tracking, Error, 트래킹에러는, 일반적으로, 일정기간, 투자한, 펀드의, 수익률이, 이에

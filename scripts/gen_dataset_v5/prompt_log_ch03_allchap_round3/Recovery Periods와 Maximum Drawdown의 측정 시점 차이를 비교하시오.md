...
## Question
Recovery Periods와 Maximum Drawdown의 측정 시점 차이를 비교하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Recovery Periods와 Maximum Drawdown의 측정 시점 차이를 비교하시오.",
  "qa_type": "comparison",
  "question_template": "Comparison_RecoveryPeriods_vs_MaxDrawdown_Timing"
}
```

...
## Question
Upside Deviation와 일반 표준편차의 차이는 무엇인가?
...
```json
{
  ...
  "section": "3) 상승편차 ; Upside Deviation",
  "subsection": "",
  "seed_title": "3) 상승편차 ; Upside Deviation",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "Upside Deviation와 일반 표준편차의 차이는 무엇인가?",
  "qa_type": "comparison",
...
[핵심 명사]
) 상승편차 ; Upside Deviation, 상승편차 ; Upside Deviation, 상승편차, Upside, Deviation, 수익률이, 벤치마크, BM, 대비, 상승한, 시기의, 표준편차
...
```json
{
  ...
  "subsection": "",
  "seed_title": "3) 상승편차 ; Upside Deviation",
  "question": "Upside Deviation와 일반 표준편차의 차이는 무엇인가?",
...
## Assistant Response
```text
- 공통 맥락: 두 지표 모두 수익률의 “변동성(표준편차)”을 수치화하지만, 기준을 어디에 두고 어떤 구간의 변동만 보느냐가 다릅니다.    
- 일반 표준편차는 펀드 수익률이 평균수익률 대비 변동한 범위를 전체 기간에 대해 측정하며( (Rᶠᵢ−평균)² ), 값이 클수록 변동성이 큽니다.   
- Upside Deviation은 펀드 수익률이 벤치마크(BM) 대비 “상승한 시기”의 변동성만 보며( max(Rᶠᵢ−Rᴮᴹᵢ, 0 )² ), 플러스 수익률 구간에 대한 위험지표로 해석됩니다.
```

...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0031

## Question
Bull/Bear Beta Ratio의 판단 기준은 Bear Beta로 나눈 값인가?
...
```json
{
  ...
  "section": "11) Bull/Bear Beta Ratio",
  "subsection": "",
  "seed_title": "11) Bull/Bear Beta Ratio",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "Bull/Bear Beta Ratio의 판단 기준은 Bear Beta로 나눈 값인가?",
  "qa_type": "criteria",
...
[핵심 명사]
) Bull/Bear Beta Ratio, Bull, Bear Beta Ratio, Bull/Bear, Beta, Ratio, 앞에서, 언급했던, Ratio를, Bear, Beta로, 나눈
...
```json
{
  ...
  "subsection": "",
  "seed_title": "11) Bull/Bear Beta Ratio",
  "question": "Bull/Bear Beta Ratio의 판단 기준은 Bear Beta로 나눈 값인가?",
...
## Assistant Response
```text
이 지표는 상승장(Bull)과 하락장(Bear)에서의 펀드 변동 민감도를 함께 비교하기 위한 것입니다.   
판단 기준(계산)은 “Bull Beta를 Bear Beta로 나눈 값”입니다. 즉 Bull/Bear Beta Ratio = Bull Beta / Bear Beta 입니다.   
값이 클수록 상승장에서 상대적으로 변동폭이 큰 펀드, 값이 작을수록 하락장에서 변동폭이 큰 펀드로 해석합니다.
```

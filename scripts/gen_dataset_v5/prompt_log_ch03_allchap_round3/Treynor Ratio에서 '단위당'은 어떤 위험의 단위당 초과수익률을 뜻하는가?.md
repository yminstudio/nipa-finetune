...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0023

## Question
Treynor Ratio에서 '단위당'은 어떤 위험의 단위당 초과수익률을 뜻하는가?
...
```json
{
  ...
  "section": "3) 트레이너지수 ; Treynor Ratio",
  "subsection": "",
  "seed_title": "3) 트레이너지수 ; Treynor Ratio",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "Treynor Ratio에서 '단위당'은 어떤 위험의 단위당 초과수익률을 뜻하는가?",
  "qa_type": "criteria",
  "question_template": "criteria_unit_definition"
}
```
...
[핵심 명사]
) 트레이너지수 ; Treynor Ratio, 트레이너지수 ; Treynor Ratio, 트레이너지수, Treynor, Ratio, 펀드의, 체계적, 위험, 단위당, 무위험, 초과수익률을, 나타내는

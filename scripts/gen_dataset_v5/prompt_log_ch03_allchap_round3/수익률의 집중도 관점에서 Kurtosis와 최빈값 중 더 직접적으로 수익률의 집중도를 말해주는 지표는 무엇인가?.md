...
## Question
수익률의 집중도 관점에서 Kurtosis와 최빈값 중 더 직접적으로 수익률의 집중도를 말해주는 지표는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "수익률의 집중도 관점에서 Kurtosis와 최빈값 중 더 직접적으로 수익률의 집중도를 말해주는 지표는 무엇인가?",
  "qa_type": "comparison",
...
[핵심 명사]
. 기타 지표, 기타, 지표, 첨도, Kurtosis, 수익률이, 최빈값, 주변에, 얼마나, 밀집되어, 있는지를, 말해주는

...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0032

## Question
Calmar Ratio의 정의는 무엇인가?
...
```json
{
  ...
  "section": "12) Calmar Ratio",
  "subsection": "",
  "seed_title": "12) Calmar Ratio",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "Calmar Ratio의 정의는 무엇인가?",
  "qa_type": "definition",
  "question_template": "Calmar_Ratio_Definition"
}
```
...
[핵심 명사]
) Calmar Ratio, Calmar Ratio, Calmar, Ratio, 펀드의, 연복리수익률을, Maximum, Drawdown으로, 나눈, 비율, 일반적으로, Ratio가
...
```json
{
  ...
  "subsection": "",
  "seed_title": "12) Calmar Ratio",
  "question": "Calmar Ratio의 정의는 무엇인가?",
...
## Assistant Response
```text
- Calmar Ratio는 펀드의 연복리(연환산) 수익률을 Maximum Drawdown(최대 누적손실) 대비로 나타내는 비율이다.   
- 정의(산식): Calmar Ratio = Annualized Rate of Return / |Maximum Drawdown|   
- 여기서 Annualized Rate of Return은 단순수익률의 연환산을 의미한다.
```

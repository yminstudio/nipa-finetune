...
## Question
Modified Sharpe Ratio와 일반 샤프지수의 차이는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Modified Sharpe Ratio와 일반 샤프지수의 차이는 무엇인가?",
  "qa_type": "comparison",
  "question_template": "comparison_template_Modified_vs_Standard_Sharpe"
}
```

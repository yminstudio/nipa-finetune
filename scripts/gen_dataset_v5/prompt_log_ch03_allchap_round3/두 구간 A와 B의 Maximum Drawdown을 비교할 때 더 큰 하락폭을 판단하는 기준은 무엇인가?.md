...
## Question
두 구간 A와 B의 Maximum Drawdown을 비교할 때 더 큰 하락폭을 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "subsection": "",
  "seed_title": "11) Maximum Drawdown",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "두 구간 A와 B의 Maximum Drawdown을 비교할 때 더 큰 하락폭을 판단하는 기준은 무엇인가?",
  "qa_type": "comparison",
  "question_template": "comparison_between_periods"
}
```
...
[핵심 명사]
) Maximum Drawdown, Maximum Drawdown, Maximum, Drawdown, 수익률의, 고점에서, 다음, 저점까지의, 하락폭이, 가장, 구간의, 하락비율을
...
```json
{
  ...
  "subsection": "",
  "seed_title": "11) Maximum Drawdown",
  "question": "두 구간 A와 B의 Maximum Drawdown을 비교할 때 더 큰 하락폭을 판단하는 기준은 무엇인가?",
...
## Assistant Response
```text
- 두 구간 A와 B 각각에 대해 Maximum Drawdown은 “고점에서 다음 저점까지의 하락폭이 가장 큰 구간의 하락비율”로 계산된 값입니다.   
- 따라서 A와 B를 비교할 때는 Maximum Drawdown 값(하락비율)이 더 큰 구간을 “더 큰 하락폭”으로 판단합니다.   
- 실무적으로 Maximum Drawdown은 부호가 포함될 수 있으므로(예: 음수), 하락폭의 크기는 보통 |Maximum Drawdown| 기준으로 비교합니다.
```

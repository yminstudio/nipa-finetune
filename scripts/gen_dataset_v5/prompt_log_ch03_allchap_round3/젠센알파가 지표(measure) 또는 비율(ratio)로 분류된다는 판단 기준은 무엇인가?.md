...
## Question
젠센알파가 지표(measure) 또는 비율(ratio)로 분류된다는 판단 기준은 무엇인가?
...
```json
{
  ...
  "section": "4) 젠센알파 ; Jensen’s Alpha",
  "subsection": "",
  "seed_title": "4) 젠센알파 ; Jensen’s Alpha",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "젠센알파가 지표(measure) 또는 비율(ratio)로 분류된다는 판단 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_measure_vs_ratio"
}
```
...
[핵심 명사]
) 젠센알파 ; Jensen’s Alpha, 젠센알파 ; Jensen’s Alpha, 젠센알파, Jensen, Alpha, 젠센척도, measure, 또는, 젠센알파지수, ratio, 라고도, 합니다

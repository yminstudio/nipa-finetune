...
## Question
Maximum Drawdown에서 '하락비율'은 어떤 구간의 하락을 의미하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Maximum Drawdown에서 '하락비율'은 어떤 구간의 하락을 의미하는가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "11) Maximum Drawdown",
  "question": "Maximum Drawdown에서 '하락비율'은 어떤 구간의 하락을 의미하는가?",
...
## Assistant Response
```text
Maximum Drawdown에서 ‘하락비율’은 하락위험(최대 누적손실)을 판단하기 위한 지표입니다. 

- 펀드 수익률의 고점에서 다음 저점까지의 하락비율입니다.   
- 그중에서도 하락폭이 가장 큰(최악의) 하락 구간을 대상으로 합니다.
```

...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Beta가 표현하는 민감도는 어떤 대상에 대한 것인가?",
  "qa_type": "criteria",
  "question_template": "criteria_target_of_sensitivity"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "4) 베타 ; Beta",
  "question": "Beta가 표현하는 민감도는 어떤 대상에 대한 것인가?",
...
## Assistant Response
```text
베타는 시장변화에 대한 펀드수익률의 민감도를 판단하기 위한 지표입니다.   
제로인에서는 이때 ‘시장’으로 KOSPI200 지수를 사용하며, KOSPI200이 1% 변할 때 펀드수익률이 몇 % 변하는지의 상호변동관계를 베타가 나타냅니다.
```

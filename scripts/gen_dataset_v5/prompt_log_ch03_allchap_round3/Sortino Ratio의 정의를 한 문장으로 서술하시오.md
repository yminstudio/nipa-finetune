...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0030

## Question
Sortino Ratio의 정의를 한 문장으로 서술하시오.
...
```json
{
  ...
  "section": "10) Sortino Ratio",
  "subsection": "",
  "seed_title": "10) Sortino Ratio",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "Sortino Ratio의 정의를 한 문장으로 서술하시오.",
  "qa_type": "definition",
...
[핵심 명사]
) Sortino Ratio, Sortino Ratio, Sortino, Ratio, 무위험수익률을, 초과하는, 수익률을, 하방편차로, 나눈, 값입니다, 샤프지수, Sharpe
...
```json
{
  ...
  "subsection": "",
  "seed_title": "10) Sortino Ratio",
  "question": "Sortino Ratio의 정의를 한 문장으로 서술하시오.",
...
## Assistant Response
```text
- Sortino Ratio는 무위험수익률을 초과하는 펀드 수익률을 하방편차(하락편차)로 나눈 값으로, 수익률이 마이너스일 경우의 하락편차만을 사용해(샤프지수와 달리 양측 변동성 대신) 그 위험을 반영합니다.
```

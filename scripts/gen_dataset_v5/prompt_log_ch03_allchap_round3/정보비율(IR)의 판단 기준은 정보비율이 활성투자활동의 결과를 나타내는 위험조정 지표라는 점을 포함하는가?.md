...
## Question
정보비율(IR)의 판단 기준은 정보비율이 활성투자활동의 결과를 나타내는 위험조정 지표라는 점을 포함하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "정보비율(IR)의 판단 기준은 정보비율이 활성투자활동의 결과를 나타내는 위험조정 지표라는 점을 포함하는가?",
  "qa_type": "criteria",
  "question_template": "criteria_template_3"
}
```

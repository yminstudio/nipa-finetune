...
## Question
Kurtosis에서 판단하는 핵심 기준은 수익률 분포가 최빈값 주변에 얼마나 모여 있는지인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Kurtosis에서 판단하는 핵심 기준은 수익률 분포가 최빈값 주변에 얼마나 모여 있는지인가?",
  "qa_type": "criteria",
  "question_template": "criteria_kurtosis_dense_near_mode_2"
}
```

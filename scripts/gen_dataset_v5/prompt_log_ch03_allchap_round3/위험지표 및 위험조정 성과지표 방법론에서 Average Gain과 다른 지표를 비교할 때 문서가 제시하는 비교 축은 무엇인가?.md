...
## Question
위험지표 및 위험조정 성과지표 방법론에서 Average Gain과 다른 지표를 비교할 때 문서가 제시하는 비교 축은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "위험지표 및 위험조정 성과지표 방법론에서 Average Gain과 다른 지표를 비교할 때 문서가 제시하는 비교 축은 무엇인가?",
  "qa_type": "comparison",
  "question_template": "Comparison_Average_Gain_vs_Other"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "10) 평균이익 ; Average Gain",
  "question": "위험지표 및 위험조정 성과지표 방법론에서 Average Gain과 다른 지표를 비교할 때 문서가 제시하는 비교 축은 무엇인가?",
...
## Assistant Response
```text
Average Gain(평균이익)을 포함한 “위험지표 및 위험조정 성과지표”들을 문서의 요약표에서 비교할 때, 공통 비교 축은 다음과 같습니다. 

- 구분(해당 지표가 위험지표/위험조정 지표 등으로 묶이는지) 
- 연환산 여부(연환산 “O” 또는 “-”) 
- 단위(예: % 또는 무표기/기타 단위) 
- (참고) Average Gain 자체는 “이익을 볼 경우 평균적으로 한 주에 어느 정도 이익을 기록하는지”로 제시됩니다.
```

...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0018

## Question
Maximum Drawdown Periods의 판단 기준은 '최대 낙폭이 발생한 기간의 길이'를 기준으로 삼는가?
...
```json
{
  ...
  "section": "16) Maximum Drawdown Periods",
  "subsection": "",
  "seed_title": "16) Maximum Drawdown Periods",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "Maximum Drawdown Periods의 판단 기준은 '최대 낙폭이 발생한 기간의 길이'를 기준으로 삼는가?",
  "qa_type": "criteria",
  "question_template": "criteria_question_template_03"
}
```
...
[핵심 명사]
) Maximum Drawdown Periods, Maximum Drawdown Periods, Maximum, Drawdown, Periods, 기간, 동안, Drawdown이, 발생한, MDP, text, End
...
```json
{
  ...
  "subsection": "",
  "seed_title": "16) Maximum Drawdown Periods",
  "question": "Maximum Drawdown Periods의 판단 기준은 '최대 낙폭이 발생한 기간의 길이'를 기준으로 삼는가?",
...
## Assistant Response
```text
Maximum Drawdown Periods는 최대 낙폭(Maximum Drawdown)이 나타난 구간이 “얼마나 오래 지속됐는지”를 판단하기 위한 기간 지표입니다. 

- 판단 기준: 최대 낙폭이 발생한 기간의 길이(주 또는 월)입니다.   
- 산정: Maximum Drawdown End Date − Maximum Drawdown Start Date로 계산합니다.   
- 예시: 최대 낙폭이 발생한 누적수익률 지점이 3주차까지라면, MDP는 6주 − 3주 = 3주로 제시됩니다.
```

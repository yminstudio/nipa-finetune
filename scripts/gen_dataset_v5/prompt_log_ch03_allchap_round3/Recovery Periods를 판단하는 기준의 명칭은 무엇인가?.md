...
## Question
Recovery Periods를 판단하는 기준의 명칭은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Recovery Periods를 판단하는 기준의 명칭은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "RecoveryPeriods_criteria_name"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "17) Recovery Periods",
  "question": "Recovery Periods를 판단하는 기준의 명칭은 무엇인가?",
...
## Assistant Response
```text
Recovery Periods를 판단하기 위한 기준(측정지표)은 Maximum Drawdown이 발생한 이후의 잔여기간을 측정하는 항목입니다. 

- 기준 명칭: Recovery Periods 
- (동일 항목으로 표기되는 명칭) Recovery Period
```

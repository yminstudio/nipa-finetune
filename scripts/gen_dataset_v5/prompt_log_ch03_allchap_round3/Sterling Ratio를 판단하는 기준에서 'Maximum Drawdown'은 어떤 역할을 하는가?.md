...
## Question
Sterling Ratio를 판단하는 기준에서 'Maximum Drawdown'은 어떤 역할을 하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Sterling Ratio를 판단하는 기준에서 'Maximum Drawdown'은 어떤 역할을 하는가?",
  "qa_type": "criteria",
  "question_template": "SterlingRatio_요소역할_MaxDrawdown"
}
```

...
## Question
Average Gain의 판단 기준에서 적용 기간의 단위는 무엇으로 규정되어 있는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Average Gain의 판단 기준에서 적용 기간의 단위는 무엇으로 규정되어 있는가?",
  "qa_type": "criteria",
  "question_template": "criteria_period_unit"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "10) 평균이익 ; Average Gain",
  "question": "Average Gain의 판단 기준에서 적용 기간의 단위는 무엇으로 규정되어 있는가?",
...
## Assistant Response
```text
Average Gain은 펀드가 이익을 볼 때, 평균적으로 한 기간(단위 기간) 동안 어느 정도 이익을 기록하는지 판단하기 위한 지표입니다.  
Average Gain에서 적용 기간의 단위는 “주간(주)”으로 규정되어 있으며, 계산에 사용되는 수익률은 “i번째 주의 주간 실현수익률”을 기준으로 합니다.
```

...
## Question
선정지표의 판단 기준으로 TECO를 사용할 때의 적용 대상은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "선정지표의 판단 기준으로 TECO를 사용할 때의 적용 대상은 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "5) 선정지표",
  "question": "선정지표의 판단 기준으로 TECO를 사용할 때의 적용 대상은 무엇인가?",
...
## Assistant Response
```text
- TECO를 선정지표로 사용할 때의 적용 대상은 “유사펀드 선정 대상”이며, 공모 및 사모, 클래스 및 모펀드가 모두 포함됩니다.   
- 통합채권형(국내채권형 전체, 해외채권형 전체, MMF, 단기매칭, 장기매칭)   
- 통합주식형(국내주식형 전체, 해외주식형 전체, 커머디티형)   
- 통합혼합형 및 부동산 등(통합혼합형: 국내주식혼합형/국내채권혼합형/해외주식혼합형/해외채권혼합형/절대수익추구형/라이프스타일/PI/글로벌헤지전략/글로벌PI, 부동산 등: 국내부동산형 전체/해외부동산형 전체/특별자산/글로벌특별자산)   
- ELF 등 및 제외펀드(ELF, 베어마켓 인덱스 / 제외펀드: 글로벌장기미분류, 글로벌신규설정펀드, 장기미분류, 영구미분류, 신규설정펀드)
```
...
## Assistant Response
```text
- TECO는 유사펀드 선정을 위한 선정지표로서, 타겟펀드와 대상펀드의 “수익률 변동 추이” 유사성과 “변동의 방향성”을 함께 판단하는 데 적용된다   
- 적용 대상은 TECO 산출에 사용되는 쌍(관계)이며, 수식에서의 “펀드 i(대상펀드)”와 “타겟펀드(타겟펀드 수익률)”가 해당된다   
- 즉 TECO 지표는 펀드 i의 수익률과 타겟펀드의 수익률을 비교 대상으로 하여 계산된다
```
...
## Assistant Response
```text
- TECO를 선정지표의 판단 기준으로 사용할 때의 적용 대상은 “타겟펀드”와 그에 대응해 비교되는 “대상펀드(펀드 i)”이며, 두 펀드의 수익률(타겟펀드: R_t^{j′}, 대상펀드: R_t^i) 변동 추이를 T기간 동안 비교해 유사성을 판단합니다 

- TECO 비교에 사용되는 대상펀드(즉, TECO를 산출/적용하는 펀드 범위)는 유사펀드 선정의 대상 유형에 해당하는 펀드들로, 공모·사모 및 클래스·모펀드를 모두 포함합니다 

- 다만 유사펀드 선정 대상 유형에서 “제외펀드”로 지정된 펀드(글로벌장기미분류, 글로벌신규설정펀드, 장기미분류, 영구미분류, 신규설정펀드)는 TECO 적용 대상에서 제외됩니다
```
...
## Assistant Response
```text
- TECO는 유사펀드 선정에서 타겟펀드와 대상펀드 사이의 수익률 변동 추이(변동의 방향성 포함) 유사성을 판단하는 선정지표로 사용됩니다 .  
- TECO 산출에서는 대상펀드 i의 수익률과 타겟펀드의 수익률이 함께 들어가며, 두 펀드 간 수익률 차이/상관을 반영해 값을 계산합니다 .  
- 유사펀드 선정 결과를 웹에 제시할 때는 “대상펀드” 중 공모 펀드만을 제시 대상으로 합니다 .
```
...
## Assistant Response
```text
- TECO를 선정지표의 판단 기준으로 사용할 때는 “타겟펀드”와 “대상펀드(펀드 i)”의 수익률 변동 추이 유사성을 비교하는 데 적용됩니다.   
- TECO 비교는 유사펀드 선정의 대상 유형에 포함된 펀드들을 대상으로 이뤄집니다(공모 및 사모, 클래스 및 모펀드 모두 포함).   
- 해당 비교 대상 유형은 통합채권형(국내/해외채권형 전체, MMF, 단기매칭, 장기매칭), 통합주식형(국내/해외주식형 전체, 커머디티형), 통합혼합형(국내주식혼합형/국내채권혼합형/해외주식혼합형/해외채권혼합형, 절대수익추구형, 라이프스타일, PI, 글로벌헤지전략, 글로벌PI), 부동산 등(국내/해외부동산형 전체, 특별자산, 글로벌특별자산), ELF 등(ELF, 베어마켓 인덱스)입니다.   
- 한편, 제외펀드로 분류된(글로벌장기미분류, 글로벌신규설정펀드, 장기미분류, 영구미분류, 신규설정펀드) 경우는 유사펀드 선정 대상 유형에서 제외됩니다.
```

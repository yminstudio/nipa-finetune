...
```json
{
  ...
  "target_total": 100,
  "generated_question": "일반주식과 순수주식의 BM 구분 기준은 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "국내펀드의 유형별 BM",
  "seed_title": "국내펀드의 유형별 BM",
  "question": "일반주식과 순수주식의 BM 구분 기준은 무엇인가?",
...
## Assistant Response
```text
국내 주식형에서 ‘일반주식’은 하위 소유형으로 ‘순수주식’을 포함하며, 유형별 BM은 이 소유형 묶음 기준으로 설정됩니다. 

- 일반주식: 약관상 최고 주식투자한도가 2/3를 넘고, 운용 중 평균 주식 편입비가 2/3~100%인 펀드(프리스타일(액티브) 펀드)   
- 순수주식: 일반주식 유형에 속하면서 주식 편입비의 변화가 적을 것으로 예상되는 펀드   
- BM 구분(매핑) 기준: 국내펀드의 유형별 BM에서 ‘일반주식(순수, 자산배분)’ 소유형 BM은 KOSPI200으로 설정됩니다.
```

...
## Question
해외펀드의 유형별 BM에서 대유형과 소유형을 구분하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "해외펀드의 유형별 BM에서 대유형과 소유형을 구분하는 기준은 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "해외펀드의 유형별 BM",
  "seed_title": "해외펀드의 유형별 BM",
  "question": "해외펀드의 유형별 BM에서 대유형과 소유형을 구분하는 기준은 무엇인가?",
...
## Assistant Response
```text
해외펀드의 유형별 BM은 대유형과 소유형을 먼저 나눈 뒤, 소유형에 해당하는 지수를 BM(소유형 BM)으로 연결해 비교합니다. 

- 대유형 구분 기준: 해외에서의 자산유형(예: 해외주식형, 해외채권형, 해외부동산형)으로 크게 묶습니다.   
- 소유형 구분 기준: 해외 자산유형 아래에서 투자지역 및 투자섹터 관점으로 세분합니다.   
- 결과적으로 대유형은 “자산 성격의 큰 틀”, 소유형은 “지역/섹터의 세부”를 반영하고, 소유형별로 MSCI ACWI, MSCI EUROPE, MSCI CHINA, 글로벌채권 지수 등 소유형 BM이 매칭됩니다.
```

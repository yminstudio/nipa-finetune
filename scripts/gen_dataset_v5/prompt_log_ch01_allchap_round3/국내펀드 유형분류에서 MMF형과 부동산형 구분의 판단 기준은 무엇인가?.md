...
## Question
국내펀드 유형분류에서 MMF형과 부동산형 구분의 판단 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "국내펀드 유형분류에서 MMF형과 부동산형 구분의 판단 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_fund_type_mmf_realestate"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1) 국내펀드",
  "question": "국내펀드 유형분류에서 MMF형과 부동산형 구분의 판단 기준은 무엇인가?",
...
## Assistant Response
```text
국내펀드 유형분류에서는 투자설명서의 투자목적과 투자전략을 바탕으로 자산유형(운용전략/스타일)을 기준으로 대유형을 나눕니다. 

- MMF형: 가중평균 잔존만기 90일 이내의 “채권형 자산”에 투자하는 펀드이며, CP/CD/Call 등 1년 미만의 단기금융상품에만 투자합니다. 
- 부동산형: 공개시장을 통하지 않고 협상을 통해 부동산 및 관련증권에 투자하는 펀드입니다. 
- 따라서 구분의 핵심은 “단기금융상품 중심의 90일 이내 단기자금(=MMF형)”인지, “협상 기반의 부동산 및 관련증권 투자(=부동산형)”인지에 있습니다.
```

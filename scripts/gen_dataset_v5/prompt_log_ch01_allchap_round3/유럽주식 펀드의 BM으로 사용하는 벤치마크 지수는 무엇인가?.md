...
## Question
유럽주식 펀드의 BM으로 사용하는 벤치마크 지수는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "유럽주식 펀드의 BM으로 사용하는 벤치마크 지수는 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "해외펀드의 유형별 BM",
  "seed_title": "해외펀드의 유형별 BM",
  "question": "유럽주식 펀드의 BM으로 사용하는 벤치마크 지수는 무엇인가?",
...
## Assistant Response
```text
유럽 주식에 투자하는 해외 주식형 펀드는 제로인의 유형별 벤치마크(BM) 기준에 따라 성과를 비교합니다.   

- 유럽주식 펀드의 BM으로 사용하는 벤치마크 지수: MSCI EUROPE
```

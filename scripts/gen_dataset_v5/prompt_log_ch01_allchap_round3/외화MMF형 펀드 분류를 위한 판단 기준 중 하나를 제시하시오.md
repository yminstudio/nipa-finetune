...
## Question
외화MMF형 펀드 분류를 위한 판단 기준 중 하나를 제시하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "외화MMF형 펀드 분류를 위한 판단 기준 중 하나를 제시하시오.",
  "qa_type": "criteria",
  "question_template": "criteria_template_05"
}
```
...
[핵심 명사]
) 해외펀드, 대유형, 소유형, 해외주식형, 해외주식혼합형, 해외채권혼합형, 커머더티형, 해외채권형, 외화MMF형, 해외부동산형, 해외특별자산형, 해외헤지형

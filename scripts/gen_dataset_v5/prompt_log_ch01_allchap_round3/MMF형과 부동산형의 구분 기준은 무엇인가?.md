...
```json
{
  ...
  "target_total": 100,
  "generated_question": "MMF형과 부동산형의 구분 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "유형분류 기준"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1.3. 유형분류 기준",
  "question": "MMF형과 부동산형의 구분 기준은 무엇인가?",
...
## Assistant Response
```text
제로인은 펀드 유형을 투자설명서의 투자목적과 투자전략에 따라 분류합니다. 

- MMF형: 가중평균 잔존만기 90일 이내인 채권형 자산에 투자하는 펀드이며, 소유형 MMF는 CP, CD, Call 등 1년 미만의 단기금융상품에만 투자합니다.   
- 부동산형: 공개시장을 통하지 않고 협상을 통해 부동산 및 관련증권에 투자하는 펀드입니다.   

즉, 단기금융(채권형·90일 이내/1년 미만 단기금융상품) 중심이면 MMF형, 부동산·관련증권(협상 기반) 중심이면 부동산형으로 구분합니다.
```

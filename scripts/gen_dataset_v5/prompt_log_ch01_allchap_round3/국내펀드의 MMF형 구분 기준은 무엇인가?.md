...
```json
{
  ...
  "target_total": 100,
  "generated_question": "국내펀드의 MMF형 구분 기준은 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "국내펀드",
  "seed_title": "국내펀드",
  "question": "국내펀드의 MMF형 구분 기준은 무엇인가?",
...
## Assistant Response
```text
국내투자펀드는 자산유형과 운용전략/스타일에 따라 유형을 나누며, 그중 MMF형은 만기·투자대상 특성으로 구분합니다. 

- MMF형 구분 기준: 가중평균 잔존만기가 90일 이내인 채권형 자산에 투자하는 펀드   
- MMF형(소유형 MMF)의 설명: CP, CD, Call 등 1년 미만의 단기금융상품에만 투자
```

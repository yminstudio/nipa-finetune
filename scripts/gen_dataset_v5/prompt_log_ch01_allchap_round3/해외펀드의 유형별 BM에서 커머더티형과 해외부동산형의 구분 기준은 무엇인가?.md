...
## Question
해외펀드의 유형별 BM에서 커머더티형과 해외부동산형의 구분 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "해외펀드의 유형별 BM에서 커머더티형과 해외부동산형의 구분 기준은 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "3) 해외펀드의 유형별 BM",
  "question": "해외펀드의 유형별 BM에서 커머더티형과 해외부동산형의 구분 기준은 무엇인가?",
...
## Assistant Response
```text
해외펀드에서 유형별 BM을 정할 때, 커머더티형과 해외부동산형은 “펀드의 주수익원이 무엇과 직접 연결되는지/어느 자산에 얼마나 투자하는지”로 유형을 나눈 뒤 그 유형에 해당하는 BM을 매칭한다.  

- 커머더티형: 커머더티(실물자산)를 기초로 장내·장외 파생상품 인덱스를 추적하거나 커머더티에 직접 투자해, 펀드의 주수익원이 커머더티와 연결된 펀드.   
  - 이에 대응하는 유형 BM: Rogers International Commodity TR. 
- 해외부동산형: 해외소재 부동산 또는 이와 연계된 인덱스·주식·펀드에 자산의 2/3 이상을 투자하는 펀드.   
  - 이에 대응하는 유형 BM: 글로벌리츠(재간접)로, 재간접DWGRTT 90%.
```

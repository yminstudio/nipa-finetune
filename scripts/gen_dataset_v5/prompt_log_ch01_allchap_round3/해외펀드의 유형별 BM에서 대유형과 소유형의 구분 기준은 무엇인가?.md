...
## Question
해외펀드의 유형별 BM에서 대유형과 소유형의 구분 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "해외펀드의 유형별 BM에서 대유형과 소유형의 구분 기준은 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "3) 해외펀드의 유형별 BM",
  "question": "해외펀드의 유형별 BM에서 대유형과 소유형의 구분 기준은 무엇인가?",
...
## Assistant Response
```text
해외펀드의 유형별 BM을 매길 때, 대유형과 소유형은 “대(자산유형) → 소(투자지역·투자섹터)”로 펀드 유형을 쪼개는 구조를 기준으로 구분합니다. 

- 대유형 구분 기준: 자산유형을 기준으로 먼저 나눕니다(예: 해외주식형, 해외채권형, 해외부동산형). 
- 소유형 구분 기준: 대유형 안에서 투자지역(또는 투자섹터) 단위로 더 세분합니다(예: 글로벌주식/유럽주식/중국주식, 글로벌채권/신흥국채권, 글로벌리츠). 
- 이 구분에 따라 각 소유형에 대응하는 “소유형 BM”이 정해집니다.
```

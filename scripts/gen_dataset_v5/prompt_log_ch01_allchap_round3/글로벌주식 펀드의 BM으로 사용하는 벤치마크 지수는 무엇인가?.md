...
## Question
글로벌주식 펀드의 BM으로 사용하는 벤치마크 지수는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "글로벌주식 펀드의 BM으로 사용하는 벤치마크 지수는 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "해외펀드의 유형별 BM",
  "seed_title": "해외펀드의 유형별 BM",
  "question": "글로벌주식 펀드의 BM으로 사용하는 벤치마크 지수는 무엇인가?",
...
## Assistant Response
```text
글로벌주식(해외주식형) 펀드는 유형별 벤치마크를 BM으로 둡니다. 

- 글로벌주식의 소유형 BM: MSCI ACWI
```

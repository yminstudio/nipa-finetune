...
```json
{
  ...
  "target_total": 100,
  "generated_question": "소유형 BM의 대표 벤치마크 지수는 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "해외펀드의 유형별 BM",
  "seed_title": "해외펀드의 유형별 BM",
  "question": "소유형 BM의 대표 벤치마크 지수는 무엇인가?",
...
## Assistant Response
```text
소유형 BM은 대유형(예: 주식형) 안에서 더 세분된 소유형별로 적용되는 벤치마크 지수를 말합니다. 

- 소유형 BM의 대표 벤치마크 지수: KOSPI200 
- (문서 내 기준) 주식의 경우 시장의 지수로도 KOSPI200지수가 사용됩니다.
```

...
```json
{
  ...
  "target_total": 100,
  "generated_question": "채권형 BM를 구분하는 판단 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "채권형_BM_기준"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "2) 국내펀드의 유형별 BM",
  "question": "채권형 BM를 구분하는 판단 기준은 무엇인가?",
...
## Assistant Response
```text
채권형 벤치마크를 세부 구분할 때는 채권 포트폴리오 스타일을 “신용도”와 “듀레이션(채권 만기 성격)” 두 축으로 나눠 판단합니다. 

- 신용도의 구분: 채권 포트폴리오의 시가평가액 가중 신용점수로 단계화(최상~하)   
  - 최상: 신용점수 ≤ 0.1  
  - 상: 0.1 < 신용점수 ≤ 1  
  - 중: 1 < 신용점수 ≤ 2  
  - 중하: 2 < 신용점수 ≤ 3  
  - 하: 3 < 신용점수 
- 듀레이션의 구분: 채권 포트폴리오의 시가평가액 가중 듀레이션으로 단계화(초단기~초장기)   
  - 초단기: 듀레이션 ≤ 0.5  
  - 단기: 0.5 < 듀레이션 ≤ 2  
  - 중기: 2 < 듀레이션 ≤ 4  
  - 장기: 4 < 듀레이션 ≤ 6  

...
## Question
해외주식형 펀드의 BM으로 사용하는 벤치마크 지수는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "해외주식형 펀드의 BM으로 사용하는 벤치마크 지수는 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "해외펀드의 유형별 BM",
  "seed_title": "해외펀드의 유형별 BM",
  "question": "해외주식형 펀드의 BM으로 사용하는 벤치마크 지수는 무엇인가?",
...
## Assistant Response
```text
해외주식형 펀드는 유형 기준 BM을 펀드 BM으로 사용합니다.   
해외주식형의 소유형별 BM 벤치마크 지수는 다음과 같습니다.   
- 글로벌주식: MSCI ACWI  
- 유럽주식: MSCI EUROPE  
- 중국주식: MSCI CHINA
```

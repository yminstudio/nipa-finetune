...
## Question
Delta Normal Method의 특징에 따라 포트폴리오 VaR를 적용하려면 먼저 어떤 정보를 확인해야 하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Delta Normal Method의 특징에 따라 포트폴리오 VaR를 적용하려면 먼저 어떤 정보를 확인해야 하는가?",
  "qa_type": "application",
  "question_template": "DeltaNormal_Application_1"
}
```

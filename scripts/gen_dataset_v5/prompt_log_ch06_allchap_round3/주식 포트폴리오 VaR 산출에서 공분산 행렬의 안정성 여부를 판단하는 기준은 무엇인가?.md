...
## Question
주식 포트폴리오 VaR 산출에서 공분산 행렬의 안정성 여부를 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "주식 포트폴리오 VaR 산출에서 공분산 행렬의 안정성 여부를 판단하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "covariance_stability"
}
```

...
## Question
Delta-Normal 방법으로 주식 포트폴리오의 VaR를 산출하려면 필요한 입력값 중 하나를 제시하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Delta-Normal 방법으로 주식 포트폴리오의 VaR를 산출하려면 필요한 입력값 중 하나를 제시하시오.",
  "qa_type": "application",
  "question_template": "적용_DeltaNormal입력값"
}
```

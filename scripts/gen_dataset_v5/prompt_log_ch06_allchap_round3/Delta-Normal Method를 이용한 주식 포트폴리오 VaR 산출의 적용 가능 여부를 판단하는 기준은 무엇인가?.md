...
## Question
Delta-Normal Method를 이용한 주식 포트폴리오 VaR 산출의 적용 가능 여부를 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Delta-Normal Method를 이용한 주식 포트폴리오 VaR 산출의 적용 가능 여부를 판단하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "delta_normal_application"
}
```

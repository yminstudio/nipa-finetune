...
## Question
매도가격의 효율성을 판단하는 기준에서 당일고가와 당일저가 중 어느 값을 사용하는 것이 더 적합한지 비교하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "매도가격의 효율성을 판단하는 기준에서 당일고가와 당일저가 중 어느 값을 사용하는 것이 더 적합한지 비교하시오.",
  "qa_type": "comparison",
...
[핵심 명사]
) 매도가격의 효율성, 매도가격의 효율성, 매도가격의, 효율성, sum, left, frac, 당일고가, 매도가격, 당일저가, times, 매도금액가중치

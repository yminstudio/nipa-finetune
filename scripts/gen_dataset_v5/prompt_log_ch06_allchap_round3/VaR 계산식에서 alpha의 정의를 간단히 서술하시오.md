...
## Question
VaR 계산식에서 alpha의 정의를 간단히 서술하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "VaR 계산식에서 alpha의 정의를 간단히 서술하시오.",
  "qa_type": "definition",
  "question_template": "definition_template_1"
}
```
...
```json
{
  ...
  "subsection": "[VaR 계산식]",
  "seed_title": "[VaR 계산식]",
  "question": "VaR 계산식에서 alpha의 정의를 간단히 서술하시오.",
...
## Assistant Response
```text
VaR 계산식에서 alpha(α)는 유의수준을 의미합니다.   
- α := 유의수준(Level of Significance)   
- 또는 신뢰수준은 (1−α)×100으로 표현합니다.
```

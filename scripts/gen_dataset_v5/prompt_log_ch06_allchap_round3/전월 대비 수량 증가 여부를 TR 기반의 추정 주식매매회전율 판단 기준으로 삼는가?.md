...
## Question
전월 대비 수량 증가 여부를 TR 기반의 추정 주식매매회전율 판단 기준으로 삼는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "전월 대비 수량 증가 여부를 TR 기반의 추정 주식매매회전율 판단 기준으로 삼는가?",
  "qa_type": "criteria",
  "question_template": "criteria_increase_prev_month_tr"
}
```

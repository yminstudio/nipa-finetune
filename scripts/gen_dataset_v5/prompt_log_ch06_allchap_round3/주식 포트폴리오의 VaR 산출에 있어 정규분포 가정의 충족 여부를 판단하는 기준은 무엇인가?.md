...
## Question
주식 포트폴리오의 VaR 산출에 있어 정규분포 가정의 충족 여부를 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "주식 포트폴리오의 VaR 산출에 있어 정규분포 가정의 충족 여부를 판단하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "normal_assumption"
}
```

...
## Question
추정 주식매수회전율의 추정값이 허용 범위(limits) 내에 있어야 한다는 판단 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "추정 주식매수회전율의 추정값이 허용 범위(limits) 내에 있어야 한다는 판단 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_limits"
}
```

...
```json
{
  ...
  "target_total": 100,
  "generated_question": "TECO 지표의 특성에서 비교 축은 무엇인가?",
  "qa_type": "comparison",
  "question_template": "비교_TECO_축_03"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "6) TECO 지표의 특성",
  "question": "TECO 지표의 특성에서 비교 축은 무엇인가?",
...
## Assistant Response
```text
TECO 지표는 타겟펀드와 대상펀드 사이를 비교할 때, 변동 추이와 방향성을 함께 고려하도록 설계되어 있습니다. 

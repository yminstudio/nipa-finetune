...
## Question
TECO 지표의 특성 판단 기준으로 수익률 변동 추이의 유사성 여부를 사용하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "TECO 지표의 특성 판단 기준으로 수익률 변동 추이의 유사성 여부를 사용하는가?",
  "qa_type": "criteria",
  "question_template": "criteria_7"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "6) TECO 지표의 특성",
  "question": "TECO 지표의 특성 판단 기준으로 수익률 변동 추이의 유사성 여부를 사용하는가?",
...
## Assistant Response
```text
- 예, TECO 지표의 특성 판단에는 “타겟펀드와 대상펀드 사이의 수익률 변동 추이의 유사성”을 나타내는 TE가 포함됩니다.   
- 또한 TECO는 TE뿐 아니라 상관계수도 함께 활용하여, 유사성뿐 아니라 변동의 방향성도 고려합니다.   
- 즉 TECO는 수익률 변동 추이의 유사성 여부를 포함하는 형태로 구성됩니다.
```

...
## Assistant Response
```text
- FXR은 KRW Hedged 지수 산출에서 CurrencyReturn을 계산하기 위해 쓰이는 값으로, CurrencyReturn_t = FXR_t^R / FXR_0^R 로 정의됩니다.   
- 또한 ForwardReturn_t 산출식에도 FXR_0^R와 FXR_t^R가 분모 및 차감항으로 사용됩니다.
```

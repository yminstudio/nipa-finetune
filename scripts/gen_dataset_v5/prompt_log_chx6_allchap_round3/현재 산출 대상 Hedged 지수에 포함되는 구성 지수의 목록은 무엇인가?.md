...
## Question
현재 산출 대상 Hedged 지수에 포함되는 구성 지수의 목록은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "현재 산출 대상 Hedged 지수에 포함되는 구성 지수의 목록은 무엇인가?",
  "qa_type": "definition",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1) 현재 산출 대상 Hedged 지수",
  "question": "현재 산출 대상 Hedged 지수에 포함되는 구성 지수의 목록은 무엇인가?",
...
## Assistant Response
```text
현재 산출 대상 Hedged 지수(헤지비용을 반영해 산출하는 지수)의 구성 지수는 다음과 같다. 

- MSCI ACWI, MSCI WI, MSCI EM

...
## Question
문서에 명시된 Hedged 지수 산출 대상의 예시는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "문서에 명시된 Hedged 지수 산출 대상의 예시는 무엇인가?",
  "qa_type": "definition",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1) 현재 산출 대상 Hedged 지수",
  "question": "문서에 명시된 Hedged 지수 산출 대상의 예시는 무엇인가?",
...
## Assistant Response
```text
문서에서의 Hedged 지수 산출 대상은 헤지비율을 적용해 산출하는 KRW Hedged 지수 작성에 활용되는 지수(벤치마크)이며, 예시는 다음과 같습니다. 

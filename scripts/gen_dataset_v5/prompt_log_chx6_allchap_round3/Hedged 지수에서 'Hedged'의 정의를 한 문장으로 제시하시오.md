...
## Question
Hedged 지수에서 'Hedged'의 정의를 한 문장으로 제시하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Hedged 지수에서 'Hedged'의 정의를 한 문장으로 제시하시오.",
  "qa_type": "definition",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1) 현재 산출 대상 Hedged 지수",
  "question": "Hedged 지수에서 'Hedged'의 정의를 한 문장으로 제시하시오.",
...
## Assistant Response
```text
- KRW Hedged 지수에서 ‘Hedged’는 환에 대한 노출을 피하도록 환헤지를 적용한(헤지비율 H_t를 반영한) 지수를 뜻한다.
```

...
## Question
성능등급의 판단 기준으로 Equivalence 항목의 명칭은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "성능등급의 판단 기준으로 Equivalence 항목의 명칭은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_equivalence_item"
}
```
...
```json
{
  ...
  "subsection": "[참고 : CE 식의 유도]",
  "seed_title": "[참고 : CE 식의 유도]",
  "question": "성능등급의 판단 기준으로 Equivalence 항목의 명칭은 무엇인가?",
...
## Assistant Response
```text
- Equivalence 항목의 명칭은 “확실성 등가( Certainty Equivalence ; CE )”입니다.
```
...
## Assistant Response
```text
성능등급 산출에서 수익과 위험의 관계를 효용함수 기반의 값으로 판단하기 위한 기준입니다. 
...
## Assistant Response
```text
성능등급(태극마크) 산출에서 Equivalence 항목은 위험회피를 반영해 펀드 성과를 효용값으로 판단하기 위한 기준입니다.   
Equivalence의 명칭은 Certainty Equivalence(CE)로, “확실성 등가”입니다.
```
...
## Assistant Response
```text
성능등급 판단 기준에서 Equivalence는 수익과 위험의 관계(위험을 반영한 수익)를 나타내기 위한 항목입니다.   
해당 Equivalence 항목의 명칭은 “확실성등가( Certainty Equivalence, CE )”입니다.
```

...
## Question
등급 부여 대상 펀드와 제외 대상 펀드 간의 판단 기준 중 하나를 비교하시오.
...
```json
{
  ...
  "subsection": "가) 등급 부여 대상 펀드",
  "seed_title": "가) 등급 부여 대상 펀드",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "등급 부여 대상 펀드와 제외 대상 펀드 간의 판단 기준 중 하나를 비교하시오.",
  "qa_type": "comparison",
  "question_template": "comparison_template_등급부여대상펀드_제외대상펀드비교"
}
```
...
[핵심 명사]
가) 등급 부여 대상 펀드, 등급 부여 대상 펀드, 등급, 부여, 구분, 등급부여, 비고, 펀드유형, 국내외, 기타유형, 테마주식을, 제외한

...
## Question
그룹(Peer Group) 수익률 계산의 정의를 간단히 서술하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "그룹(Peer Group) 수익률 계산의 정의를 간단히 서술하시오.",
  "qa_type": "definition",
...
[핵심 명사]
) 그룹(Peer Group) 수익률 계산, 그룹, Peer Group, 수익률 계산, 최소 운용규모, 운용기간, 평가여부, 대상 펀드, Peer, Group, 수익률, 계산

...
## Question
제로인 펀드등급의 부여와 일반 펀드등급의 부여를 비교할 때 판단 축은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "제로인 펀드등급의 부여와 일반 펀드등급의 부여를 비교할 때 판단 축은 무엇인가?",
  "qa_type": "comparison",
  "question_template": "comparison_zi_vs_general_grade"
}
```

...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0024

## Question
ESG 펀드 스코어링 방법론에서 스코어링 적용 여부를 결정하는 주된 기준은 '제외' 기준과 '등급 산출 대상 유형' 중 어느 것인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "ESG 펀드 스코어링 방법론에서 스코어링 적용 여부를 결정하는 주된 기준은 '제외' 기준과 '등급 산출 대상 유형' 중 어느 것인가?",
  "qa_type": "comparison",
  "question_template": "comparison_제외대상vs등급대상유형"
}
```
...
[핵심 명사]
) ESG 펀드 스코어링 방법론, ESG 펀드 스코어링 방법론, 제외, 등급 산출 대상 유형, ESG, 스코어링, 방법론, ESG평가란, 환경, Environment, 사회책임, Social

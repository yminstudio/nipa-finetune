...
## Question
펀드의 순자산 총액 산출 관련 기준에서 운용 NAV, 보정 NAV, 수정 NAV, 기준 NAV 중 어떤 NAV를 선택하는지 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "펀드의 순자산 총액 산출 관련 기준에서 운용 NAV, 보정 NAV, 수정 NAV, 기준 NAV 중 어떤 NAV를 선택하는지 판단하는 기준은 무엇인가?",
  "qa_type": "criteria",

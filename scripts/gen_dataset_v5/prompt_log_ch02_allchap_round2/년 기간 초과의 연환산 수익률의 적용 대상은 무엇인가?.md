...
```json
{
  ...
  "target_total": 100,
  "generated_question": "년 기간 초과의 연환산 수익률의 적용 대상은 무엇인가?",
  "qa_type": "definition",
...
[핵심 명사]
. 수익률 평가방법, 아시아 및 호주, 이외 지역, 주식형, 계산의 편의성, 정규성 가정의 뒷받침, 년 기간 초과의 연환산 수익률 : 모든 유형의 펀드에 적용, 년 미만의 연환산 수익률 : 채권형, MMF에 적용, 산출 기간, 운용 NAV, 보정 NAV, 수정 NAV

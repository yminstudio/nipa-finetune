...
## Question
기간평균 Score를 산출할 때 제외하는 항목은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "기간평균 Score를 산출할 때 제외하는 항목은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "기간평균 Score 제외 요소 기준"
}
```
...
```json
{
  ...
  "subsection": "기간평균 Score",
  "seed_title": "기간평균 Score",
  "question": "기간평균 Score를 산출할 때 제외하는 항목은 무엇인가?",
...
## Assistant Response
```text
기간평균 Score를 산출할 때 정성평가점수는 제외한다.   
...
## Assistant Response
```text
기간평균 Score는 기간별 평가지표의 백분위점수를 평균해 산출하기 위한 기준입니다. 

- 기간평균 Score 산출 시 제외하는 항목은 정성평가점수입니다. 
- 정성평가점수는 기간평균을 산출하지 않고, 가장 최근 시점에 근접한 정성평가점수를 반영합니다.
```
...
## Assistant Response
```text
기간평균 Score는 기간별 평가지표를 기준으로 점수를 평균내어 산출하기 위한 기준입니다. 

- 기간평균 Score 산출 시 제외하는 항목: 정성평가점수 
- 정성평가점수는 기간평균을 산출하지 않고 가장 최근 시점에 근접한 정성평가점수를 반영합니다.
```
...
## Assistant Response
```text
기간평균 Score는 기간별 평가지표에서 산출된 백분위 점수를 평균해 평가기간 성과를 종합하기 위한 값이다. 

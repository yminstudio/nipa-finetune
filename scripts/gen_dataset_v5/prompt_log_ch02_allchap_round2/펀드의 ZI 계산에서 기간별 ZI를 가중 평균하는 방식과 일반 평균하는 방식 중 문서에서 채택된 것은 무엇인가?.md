...
## Question
펀드의 ZI 계산에서 기간별 ZI를 가중 평균하는 방식과 일반 평균하는 방식 중 문서에서 채택된 것은 무엇인가?
...
{
  "chapter": "2. 펀드평가 방법론",
  "section": "Step 4 : 각 펀드의 기간별 ZI 를 가중 평균하여 펀드의 ZI 를 계산합니다.",
  "subsection": "",
  "seed_title": "Step 4 : 각 펀드의 기간별 ZI 를 가중 평균하여 펀드의 ZI 를 계산합니다.",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "펀드의 ZI 계산에서 기간별 ZI를 가중 평균하는 방식과 일반 평균하는 방식 중 문서에서 채택된 것은 무엇인가?",
  "qa_type": "comparison",
  "question_template": "비교_단일질문"
}
```
...
[핵심 명사]
각 펀드의 기간별 ZI 를 가중 평균하여 펀드의 ZI 를 계산합니다., Step, 펀드의, 기간별, ZI, 가중, 평균하여, 계산합니다, sum, omega, times, Where

...
```json
{
  "chapter": "2. 펀드평가 방법론",
  "section": "1) 펀드 수익률 계산",
  "subsection": "나) 기간(누적) 수익률",
  "seed_title": "나) 기간(누적) 수익률",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "나) 기간(누적) 수익률의 정의는 무엇인가?",
  "qa_type": "definition",
...
[핵심 명사]
나) 기간(누적) 수익률, 기간, 누적, 수익률, 산출 기간, prod, Where, 동안, ldots, 펀드의, 일별수익률, 혹은

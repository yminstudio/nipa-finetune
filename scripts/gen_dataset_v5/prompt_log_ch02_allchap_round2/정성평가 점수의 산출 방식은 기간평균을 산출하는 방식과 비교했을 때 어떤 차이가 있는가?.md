...
## Question
정성평가 점수의 산출 방식은 기간평균을 산출하는 방식과 비교했을 때 어떤 차이가 있는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "정성평가 점수의 산출 방식은 기간평균을 산출하는 방식과 비교했을 때 어떤 차이가 있는가?",
  "qa_type": "comparison",
  "question_template": "정성평가 점수 산출 방식 비교"
}
```
...
[핵심 명사]
정성평가 점수, 정성평가, 점수, 정성평가점수는, 기간평균을, 산출하지, 않고, 가장, 최근, 시점에, 근접한, 정성평가점수를

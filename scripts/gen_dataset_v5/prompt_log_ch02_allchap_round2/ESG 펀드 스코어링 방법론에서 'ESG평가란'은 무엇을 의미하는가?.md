...
## Question
ESG 펀드 스코어링 방법론에서 'ESG평가란'은 무엇을 의미하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "ESG 펀드 스코어링 방법론에서 'ESG평가란'은 무엇을 의미하는가?",
  "qa_type": "definition",
  "question_template": "definition_ESG평가란"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "3) ESG 펀드 스코어링 방법론",
  "question": "ESG 펀드 스코어링 방법론에서 'ESG평가란'은 무엇을 의미하는가?",
...
## Assistant Response
```text
- ESG 펀드 스코어링 방법론에서 ‘ESG평가란’은 환경(Environment), 사회책임(Social Responsibility), 지배구조(Governance) 등 기업의 지속가능성에 영향을 미치는 요소를 평가하는 것을 의미합니다. 
- 즉, ESG평가는 해당 지속가능성 영향 요소에 대한 ‘평가’ 자체를 뜻합니다.
```
...
## Assistant Response
```text
- ESG 펀드 스코어링에서 ‘ESG평가란’은 환경(Environment), 사회책임(Social Responsibility), 지배구조(Governance) 등 기업의 지속가능성에 영향을 미치는 요소를 평가하는 것을 말합니다.
```
...
## Assistant Response
```text
- 제로인 ESG 펀드 스코어링에서 “ESG평가란” 기업의 지속가능성에 영향을 미치는 요소를 평가하는 것을 의미합니다.   
- 구체적으로 환경(Environment), 사회책임(Social Responsibility), 지배구조(Governance) 등과 같은 항목을 평가하는 것을 말합니다.
```
...
## Assistant Response
```text
- 제로인 ESG 펀드 스코어링에서 ‘ESG평가란’은 기업의 지속가능성에 영향을 미치는 요소를 평가하는 것을 의미합니다.   
- 그 평가 대상은 환경(Environment), 사회책임(Social Responsibility), 지배구조(Governance) 등으로 제시됩니다.   
- 즉, 기업의 지속가능성에 관련된 요소들을 ESG 관점에서 평가한다는 뜻입니다.
```

...
## Question
펀드평가 대상 선정 기준에서 순자산의 고려 여부를 수익률 지표 부여 여부와 비교할 때 문서가 제시하는 판단 축은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "펀드평가 대상 선정 기준에서 순자산의 고려 여부를 수익률 지표 부여 여부와 비교할 때 문서가 제시하는 판단 축은 무엇인가?",
  "qa_type": "comparison",

...
```json
{
  ...
  "target_total": 100,
  "generated_question": "ESG평가란 무엇을 평가하는 방법인가?",
  "qa_type": "definition",
...
## Assistant Response
```text
- ESG평가란 환경(Environment), 사회책임(Social Responsibility), 지배구조(Governance) 등 기업의 지속가능성에 영향을 미치는 요소를 평가하는 것을 말합니다.
```
...
## Assistant Response
```text
ESG평가란 기업의 지속가능성에 영향을 미치는 요소를 평가하는 것을 말합니다.   
- 환경(Environment) 관련 요소를 평가합니다.   
- 사회책임(Social Responsibility) 관련 요소를 평가합니다.   
- 지배구조(Governance) 관련 요소를 평가합니다.
```

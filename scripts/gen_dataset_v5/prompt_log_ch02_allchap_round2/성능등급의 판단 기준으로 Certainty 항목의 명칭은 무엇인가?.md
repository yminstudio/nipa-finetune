...
## Question
성능등급의 판단 기준으로 Certainty 항목의 명칭은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "성능등급의 판단 기준으로 Certainty 항목의 명칭은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_certainty_item"
}
```
...
```json
{
  ...
  "subsection": "[참고 : CE 식의 유도]",
  "seed_title": "[참고 : CE 식의 유도]",
  "question": "성능등급의 판단 기준으로 Certainty 항목의 명칭은 무엇인가?",
...
## Assistant Response
```text
- Certainty 항목의 명칭: 확실성등가( Certainty Equivalence, CE )
```
...
## Assistant Response
```text
수익과 위험을 효용함수로 반영해 성능등급 산출에 쓰는 ‘Certainty(확실성)’ 성격의 항목을 의미합니다.   
Certainty 항목의 명칭은 “확실성등가( Certainty Equivalence, CE )”입니다.
```
...
## Assistant Response
```text
성능등급(태극마크) 산출을 위한 기초값인 Certainty 항목은 “확실성등가”로 명칭합니다.   
Certainty Equivalence은 약어로 CE로 표기됩니다.
```
...
## Assistant Response
```text
Certainty는 펀드의 위험을 반영한 위험조정 성과(효용값)를 바탕으로 성과등급을 산출하기 위한 항목입니다.   
- Certainty 항목의 명칭: 확실성등가   
- 영문 표기/약어: Certainty Equivalence(CE)
```

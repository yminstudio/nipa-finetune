...
## Question
펀드 수익률 계산에서 지역 구분(아시아 및 호주 vs 이외 지역)을 적용하는 판단 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "펀드 수익률 계산에서 지역 구분(아시아 및 호주 vs 이외 지역)을 적용하는 판단 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "지역 구분 적용 기준"
}
```

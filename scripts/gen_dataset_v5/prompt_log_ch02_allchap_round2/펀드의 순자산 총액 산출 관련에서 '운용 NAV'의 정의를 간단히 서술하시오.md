...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0034

## Question
펀드의 순자산 총액 산출 관련에서 '운용 NAV'의 정의를 간단히 서술하시오.
...
```json
{
  "chapter": "2. 펀드평가 방법론",
  "section": "1) 펀드 수익률 계산",
  "subsection": "바) 펀드의 순자산 총액 산출 관련",
  "seed_title": "바) 펀드의 순자산 총액 산출 관련",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "펀드의 순자산 총액 산출 관련에서 '운용 NAV'의 정의를 간단히 서술하시오.",
  "qa_type": "definition",
...
[핵심 명사]
바) 펀드의 순자산 총액 산출 관련, 펀드의 순자산 총액 산출 관련, 운용 NAV, 보정 NAV, 수정 NAV, 기준 NAV, 실제주식편입비 NAV, 펀드의, 순자산, 총액, 산출, 관련

...
## Question
펀드 등급 대상 제외 펀드와 등급 대상 펀드의 구분 기준은 무엇인가?
...
```json
{
  "chapter": "2. 펀드평가 방법론",
  "section": "수익률 분포 비교",
  "subsection": "라) 펀드 등급 대상 제외 펀드",
  "seed_title": "라) 펀드 등급 대상 제외 펀드",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "펀드 등급 대상 제외 펀드와 등급 대상 펀드의 구분 기준은 무엇인가?",
  "qa_type": "comparison",
...
[핵심 명사]
라) 펀드 등급 대상 제외 펀드, 펀드 등급 대상 제외 펀드, 등급, 제외, 구분, 해당사항, 사유, 제외유형, 국내기타, 해외기타, 테마주식, 기타인덱스

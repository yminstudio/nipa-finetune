...
## Question
ZI Score 변환 개념에서 상한값으로 작용하는 경계는 Min과 Max 중 어느 것인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "ZI Score 변환 개념에서 상한값으로 작용하는 경계는 Min과 Max 중 어느 것인가?",
  "qa_type": "comparison",
  "question_template": "Comparison_Min_Max_Upper_Bound"
}
```

...
## Question
리서치등급 부여에서 주요 평가지표로 채택되는 항목은 Score와 정성평가점수 중 어느 쪽인가?
...
```json
{
  ...
  "subsection": "다) 리서치등급 부여",
  "seed_title": "다) 리서치등급 부여",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "리서치등급 부여에서 주요 평가지표로 채택되는 항목은 Score와 정성평가점수 중 어느 쪽인가?",
  "qa_type": "comparison",
...
[핵심 명사]
다) 리서치등급 부여, 리서치등급 부여, 리서치등급, 부여, 기간평균, Score, 정성평가점수를, 제외한, 기간별, 평가지표에, 대해, 년의

...
## Question
BM대비 성과요인 분석에서 자산배분타이밍효과를 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "BM대비 성과요인 분석에서 자산배분타이밍효과를 판단하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "자산배분타이밍효과_실제편입비수익률-평균편입비수익률"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "5.1. BM대비 성과요인 분석",
  "question": "BM대비 성과요인 분석에서 자산배분타이밍효과를 판단하는 기준은 무엇인가?",
...
## Assistant Response
```text
자산배분타이밍효과는 BM 대비 초과수익(또는 초과손실) 중에서 ‘실제 편입비의 타이밍’이 성과에 기여했는지를 판단하기 위한 항목이다. 

- 자산배분타이밍효과 = 실제편입비수익률 − 평균편입비수익률   
- 상승장에서 실제편입비가 평균편입비보다 높다면 (+) 값(타이밍 성공)으로 판단   
- 약세장에서 실제편입비가 평균편입비보다 낮다면 (+) 값(타이밍 성공)으로 판단 filecite
```

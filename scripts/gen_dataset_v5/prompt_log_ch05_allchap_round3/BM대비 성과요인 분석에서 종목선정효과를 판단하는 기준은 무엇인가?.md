...
## Question
BM대비 성과요인 분석에서 종목선정효과를 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "BM대비 성과요인 분석에서 종목선정효과를 판단하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "종목선정효과_펀드수익률-실제편입비수익률"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "5.1. BM대비 성과요인 분석",
  "question": "BM대비 성과요인 분석에서 종목선정효과를 판단하는 기준은 무엇인가?",
...
## Assistant Response
```text
종목선정효과는 BM 대비 초과수익(또는 초과손실)에서 “종목을 선택한 결과”가 기여한 부분을 판단하기 위한 항목입니다. 

- 종목선정효과 = 펀드수익률 – 실제편입비수익률   
- 따라서 종목선정효과는 펀드의 실제 성과(펀드수익률)가 실제 편입비에 의해 기대되는 성과(실제편입비수익률) 대비 얼마나 달라졌는지로 판단합니다.
```

...
```json
{
  ...
  "target_total": 100,
  "generated_question": "BM대비의 정의를 한 문장으로 설명하시오.",
  "qa_type": "definition",
  "question_template": "정의템플릿_BM대비"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "5.1. BM대비 성과요인 분석",
  "question": "BM대비의 정의를 한 문장으로 설명하시오.",
...
## Assistant Response
```text
- BM대비는 특정 기간 동안 BM에 대해 펀드가 보인 초과수익(또는 초과손실)을 의미한다.   
- 이 BM대비 초과수익의 원인은 자산배분효과, 자산배분타이밍효과, 종목선정효과로 나누어 설명한다.
```

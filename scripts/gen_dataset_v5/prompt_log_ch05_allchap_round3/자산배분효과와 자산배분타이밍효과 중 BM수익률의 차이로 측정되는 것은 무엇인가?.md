...
## Question
자산배분효과와 자산배분타이밍효과 중 BM수익률의 차이로 측정되는 것은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "자산배분효과와 자산배분타이밍효과 중 BM수익률의 차이로 측정되는 것은 무엇인가?",
  "qa_type": "comparison",
  "question_template": "비교템플릿_자산배분효과_대자산배분타이밍효과"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "5.1. BM대비 성과요인 분석",
  "question": "자산배분효과와 자산배분타이밍효과 중 BM수익률의 차이로 측정되는 것은 무엇인가?",
...
## Assistant Response
```text
- 자산배분효과는 BM수익률과의 차이로 측정되며, 평균편입비수익률 – BM수익률로 정의됩니다.   
- 자산배분타이밍효과는 BM수익률이 아니라 실제편입비수익률과 평균편입비수익률의 차이(실제편입비수익률 – 평균편입비수익률)로 측정됩니다.
```

...
```json
{
  ...
  "target_total": 100,
  "generated_question": "문서에 정의된 'co'의 정의는 무엇인가?",
  "qa_type": "definition",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "8. 평가 자료의 공시",
  "question": "문서에 정의된 'co'의 정의는 무엇인가?",
...
## Assistant Response
```text
- 해당 문서에서 기호 ‘co’에 대해 별도의 “정의(정의문)”가 제시되어 있지 않습니다.  
- 따라서 문서에 정의된 ‘co’의 정의는 확인할 수 없습니다.
```

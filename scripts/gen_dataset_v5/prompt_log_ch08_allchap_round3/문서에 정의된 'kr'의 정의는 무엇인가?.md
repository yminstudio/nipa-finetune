...
```json
{
  ...
  "target_total": 100,
  "generated_question": "문서에 정의된 'kr'의 정의는 무엇인가?",
  "qa_type": "definition",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "8. 평가 자료의 공시",
  "question": "문서에 정의된 'kr'의 정의는 무엇인가?",
...
## Assistant Response
```text
- 문서에서 ‘kr’은 원화/로컬 환율을 의미하며, 원화환산 BM지수를 계산할 때 Local(or USD) 지수에 곱하는 값으로 제시됩니다.
```

...
```json
{
  ...
  "target_total": 100,
  "generated_question": "문서에 정의된 'http'의 정의는 무엇인가?",
  "qa_type": "definition",
  "question_template": "DefinitionTemplate"
}
```
...
[핵심 명사]
. 평가 자료의 공시, 평가, 자료의, 공시, 제로인이, 운용하는, 웹사이트, http, www, funddoctor, co, kr
...
```json
{
  ...
  "subsection": "",
  "seed_title": "8. 평가 자료의 공시",
  "question": "문서에 정의된 'http'의 정의는 무엇인가?",
...
## Assistant Response
```text
- 문서에서 ‘http’는 별도의 용어 정의로 설명되기보다는, 제로인이 공시하는 웹사이트 주소를 표기할 때 URL에 포함되어 나타납니다: ‘http://www.funddoctor.co.kr’   
- 따라서 문서에 ‘http’의 개념/의미에 대한 별도 정의문은 제시되어 있지 않습니다.
```

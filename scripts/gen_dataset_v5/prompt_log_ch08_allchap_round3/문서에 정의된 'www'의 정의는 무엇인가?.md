...
```json
{
  ...
  "target_total": 100,
  "generated_question": "문서에 정의된 'www'의 정의는 무엇인가?",
  "qa_type": "definition",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "8. 평가 자료의 공시",
  "question": "문서에 정의된 'www'의 정의는 무엇인가?",
...
## Assistant Response
```text
- 문서에서는 ‘www’를 별도의 용어로 정의(의미/약어 풀이는 등)하지 않습니다.   
- ‘www’는 제로인 웹사이트 주소(http://www.funddoctor.co.kr)에서 주소 구성요소로만 나타납니다.
```

...
## Question
Modified Sharpe Ratio의 판단 기준은 무위험 수익률과의 차이를 반영한 값을 위험으로 나눈 비율로 정의된다고 보는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Modified Sharpe Ratio의 판단 기준은 무위험 수익률과의 차이를 반영한 값을 위험으로 나눈 비율로 정의된다고 보는가?",
  "qa_type": "criteria",
  "question_template": "criteria_3"
}
```

...
```json
{
  ...
  "section": "5) 상승베타 ; Bull Beta",
  "subsection": "",
  "seed_title": "5) 상승베타 ; Bull Beta",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "상승베타(Bull Beta)의 정의는 무엇인가?",
  "qa_type": "definition",
  "question_template": "BullBeta_Definition"
}
```
...
[핵심 명사]
) 상승베타 ; Bull Beta, 상승베타 ; Bull Beta, 상승베타, Bull, Beta, 벤치마크, 지수가, 상승할, 때의, 베타를, 말합니다, 일반적으로

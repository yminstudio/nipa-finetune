...
## Question
왜도(Skewness)의 정의를 문서에 따라 한 문장으로 설명하시오.
...
```json
{
  ...
  "section": "2) 왜도 : Skewness",
  "subsection": "",
  "seed_title": "2) 왜도 : Skewness",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "왜도(Skewness)의 정의를 문서에 따라 한 문장으로 설명하시오.",
  "qa_type": "definition",
...
[핵심 명사]
) 왜도 : Skewness, 왜도, Skewness, 수익률, 분포가, 얼마나, 쪽으로, 치우쳤는지, 대칭성, 파악하는, 척도, 펀드수익률

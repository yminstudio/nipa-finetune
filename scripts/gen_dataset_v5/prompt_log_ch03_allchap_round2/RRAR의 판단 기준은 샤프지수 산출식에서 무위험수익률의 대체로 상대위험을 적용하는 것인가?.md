...
## Question
RRAR의 판단 기준은 샤프지수 산출식에서 무위험수익률의 대체로 상대위험을 적용하는 것인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "RRAR의 판단 기준은 샤프지수 산출식에서 무위험수익률의 대체로 상대위험을 적용하는 것인가?",
  "qa_type": "criteria",
  "question_template": "RRAR_criteria_3"
}
```

...
## Question
Calmar Ratio의 정의를 한 문장으로 서술하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Calmar Ratio의 정의를 한 문장으로 서술하시오.",
  "qa_type": "definition",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "12) Calmar Ratio",
  "question": "Calmar Ratio의 정의를 한 문장으로 서술하시오.",
...
## Assistant Response
```text
Calmar Ratio는 펀드의 연복리수익률(Annualized Rate of Return)을 Maximum Drawdown(최대 누적손실)의 절댓값으로 나눈 비율이다.
```
...
## Assistant Response
```text
- Calmar Ratio는 펀드의 연복리수익률을 Maximum Drawdown(최대 누적손실)으로 나눈 비율이다.   
- Calmar Ratio = Annualized Rate of Return / |Maximum Drawdown|이며, Annualized Rate of Return은 단순수익률의 연환산(로그수익률 사용안함)이다.
```
...
## Assistant Response
```text
- Calmar Ratio는 펀드의 연복리수익률을 최대낙폭(Maximum Drawdown)으로 나눈 비율로, Calmar Ratio = Annualized Rate of Return / |Maximum Drawdown| 입니다.   
...
## Assistant Response
```text
- Calmar Ratio는 펀드의 연복리(연환산) 수익률을 Maximum Drawdown(최대 누적손실)의 절댓값으로 나눈 비율이다.   
- 정의식: Calmar Ratio = Annualized Rate of Return ÷ |Maximum Drawdown|.   
- 여기서 Annualized Rate of Return은 단순수익률의 연환산을 사용한다.
```

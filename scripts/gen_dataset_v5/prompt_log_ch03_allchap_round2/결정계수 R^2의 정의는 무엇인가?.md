...
```json
{
  ...
  "section": "7) 결정계수 ; R-Square($R^2$)",
  "subsection": "",
  "seed_title": "7) 결정계수 ; R-Square($R^2$)",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "결정계수 R^2의 정의는 무엇인가?",
  "qa_type": "definition",
...
[핵심 명사]
) 결정계수 ; R-Square($R^2$), 결정계수 ; R-Square, $R^2$, 결정계수, R-Square, 종속변수의, 분산, 독립변수, 또는, 설명변수, 의해, 설명되는

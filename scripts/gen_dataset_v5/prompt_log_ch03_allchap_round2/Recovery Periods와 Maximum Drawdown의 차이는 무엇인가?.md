...
## Question
Recovery Periods와 Maximum Drawdown의 차이는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Recovery Periods와 Maximum Drawdown의 차이는 무엇인가?",
  "qa_type": "comparison",
  "question_template": "Recovery Periods vs Maximum Drawdown 비교 템플릿"
}
```

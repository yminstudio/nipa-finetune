...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0015

## Question
Maximum Gain의 정의에서 다루는 기간과 '펀드가 설정된 이후 플러스 수익률을 기록한 기간'은 같은 개념인가?
...
```json
{
  ...
  "section": "13) 최대이익 ; Maximum Gain",
  "subsection": "",
  "seed_title": "13) 최대이익 ; Maximum Gain",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "Maximum Gain의 정의에서 다루는 기간과 '펀드가 설정된 이후 플러스 수익률을 기록한 기간'은 같은 개념인가?",
  "qa_type": "comparison",
  "question_template": "comparison_equivalence"
}
```
...
[핵심 명사]
) 최대이익 ; Maximum Gain, 최대이익 ; Maximum Gain, 최대이익, Maximum, Gain, 펀드가, 설정된, 이후, 플러스, 수익률을, 기록한, 기간

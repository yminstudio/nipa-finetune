...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0035

## Question
첨도(Kurtosis)라는 지표가 수익률의 최빈값 주변의 밀집 정도를 판단하는 기준으로 제시되는가?
...
```json
{
  ...
  "section": "1) 첨도 ; Kurtosis",
  "subsection": "",
  "seed_title": "1) 첨도 ; Kurtosis",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "첨도(Kurtosis)라는 지표가 수익률의 최빈값 주변의 밀집 정도를 판단하는 기준으로 제시되는가?",
  "qa_type": "criteria",
  "question_template": "Kurtosis_criteria_density_focus_variant"
}
```
...
[핵심 명사]
) 첨도 ; Kurtosis, 첨도 ; Kurtosis, 첨도, Kurtosis, 수익률이, 최빈값, 주변에, 얼마나, 밀집되어, 있는지를, 말해주는, 지표

...
## Question
기간중 음비중과 Negative Periods의 정의 차이는 무엇인가?
...
```json
{
  ...
  "section": "14) 기간중 음비중 ; Negative Periods",
  "subsection": "",
  "seed_title": "14) 기간중 음비중 ; Negative Periods",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "기간중 음비중과 Negative Periods의 정의 차이는 무엇인가?",
  "qa_type": "comparison",
...
[핵심 명사]
) 기간중 음비중 ; Negative Periods, 기간중 음비중 ; Negative Periods, 기간중, 음비중, Negative, Periods, 전체, 기간, 환산, 마이너스, 수익이, 발생했던

...
## Question
Maximum Loss와 '펀드가 설정된 이후 마이너스 수익률을 기록한 기간'은 같은 개념인가?
...
```json
{
  ...
  "section": "12) 최대손실 ; Maximum Loss",
  "subsection": "",
  "seed_title": "12) 최대손실 ; Maximum Loss",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "Maximum Loss와 '펀드가 설정된 이후 마이너스 수익률을 기록한 기간'은 같은 개념인가?",
  "qa_type": "comparison",
  "question_template": "Comparison_MaxLoss_Synonym"
}
```
...
[핵심 명사]
) 최대손실 ; Maximum Loss, 최대손실 ; Maximum Loss, 최대손실, Maximum, Loss, 펀드가, 설정된, 이후, 마이너스, 수익률을, 기록한, 기간

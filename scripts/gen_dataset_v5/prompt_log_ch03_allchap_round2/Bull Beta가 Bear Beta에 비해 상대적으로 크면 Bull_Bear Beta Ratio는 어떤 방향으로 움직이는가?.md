...
## Question
Bull Beta가 Bear Beta에 비해 상대적으로 크면 Bull/Bear Beta Ratio는 어떤 방향으로 움직이는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Bull Beta가 Bear Beta에 비해 상대적으로 크면 Bull/Bear Beta Ratio는 어떤 방향으로 움직이는가?",
  "qa_type": "comparison",

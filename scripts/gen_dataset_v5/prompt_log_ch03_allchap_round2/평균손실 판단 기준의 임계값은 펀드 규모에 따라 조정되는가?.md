...
## Question
평균손실 판단 기준의 임계값은 펀드 규모에 따라 조정되는가?
...
```json
{
  ...
  "section": "9) 평균손실 ; Average Loss",
  "subsection": "",
  "seed_title": "9) 평균손실 ; Average Loss",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "평균손실 판단 기준의 임계값은 펀드 규모에 따라 조정되는가?",
  "qa_type": "criteria",
  "question_template": "criteria_threshold_adjustment"
}
```
...
[핵심 명사]
) 평균손실 ; Average Loss, 평균손실 ; Average Loss, 평균손실, Average, Loss, 펀드가, 손실을, 경우에, 평균적으로, 주에, 어느, 정도

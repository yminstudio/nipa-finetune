...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0027

## Question
RTRR의 판단 기준에 따라 수익률을 나누는 대상은 무엇인가?
...
```json
{
  ...
  "section": "7) 수익/위험비율 ; Return to Risk Ratio",
  "subsection": "",
  "seed_title": "7) 수익/위험비율 ; Return to Risk Ratio",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "RTRR의 판단 기준에 따라 수익률을 나누는 대상은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_template_03"
}
```
...
[핵심 명사]
) 수익/위험비율 ; Return to Risk Ratio, 수익, 위험비율 ; Return to Risk Ratio, 수익/위험비율, Return, to, Risk, Ratio, 수익률을, 수익률의, 변동성으로, 나눈

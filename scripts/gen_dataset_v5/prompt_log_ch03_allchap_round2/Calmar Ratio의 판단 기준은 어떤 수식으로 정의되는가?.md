...
## Question
Calmar Ratio의 판단 기준은 어떤 수식으로 정의되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Calmar Ratio의 판단 기준은 어떤 수식으로 정의되는가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "12) Calmar Ratio",
  "question": "Calmar Ratio의 판단 기준은 어떤 수식으로 정의되는가?",
...
- 여기서 Annualized Rate of Return은 단순수익률의 연환산값을 사용합니다(로그수익률 사용안함).
```
...
## Assistant Response
```text
Calmar Ratio는 펀드의 연간 수익(연복리수익률)을 최대 누적손실(최대낙폭, Maximum Drawdown) 대비해 위험 대비 성과를 판단하기 위한 지표입니다. 

- Calmar Ratio = Annualized Rate of Return / |Maximum Drawdown| 
- 여기서 Annualized Rate of Return은 단순수익률의 연환산을 사용합니다(로그수익률 사용안함).
```
...
## Assistant Response
```text
Calmar Ratio는 펀드의 수익 성과를 최대 누적손실(최대낙폭, Maximum Drawdown) 대비로 판단하기 위한 지표입니다. 

- 수식: Calmar Ratio = Annualized Rate of Return / |Maximum Drawdown|   
- 여기서 Annualized Rate of Return은 단순수익률을 연환산한 값(로그수익률 사용 안 함)입니다.
```
...
## Assistant Response
```text
Calmar Ratio는 펀드의 최대 누적손실(Maximum Drawdown) 대비 연간 수익이 얼마나 좋은지를 판단하기 위한 지표입니다. 

- 수식: Calmar Ratio = Annualized Rate of Return / |Maximum Drawdown|   
- 여기서 Annualized Rate of Return은 단순수익률의 연환산(로그수익률 사용안함)입니다.
```
...
## Assistant Response
```text
Calmar Ratio는 펀드의 연간 수익(연복리)을 최대 누적손실(Maximum Drawdown)로 나누어, 최대 손실 대비 수익 성과를 판단하는 지표입니다. 

Calmar Ratio = Annualized Rate of Return ÷ |Maximum Drawdown| 

여기서 Annualized Rate of Return은 단순수익률의 연환산이며, 로그수익률을 사용하지 않습니다.
```

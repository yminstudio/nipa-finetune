...
## Question
포트폴리오의 시가배당률 산출에서 데이터 소스로 KOSCOM을 이용한다는 판단 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "포트폴리오의 시가배당률 산출에서 데이터 소스로 KOSCOM을 이용한다는 판단 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_data_source_KOSCOM"
}
```

...
## Question
일별 종가정보를 이용해 포트폴리오의 시가배당률을 산출하는 절차를 한 문장으로 제시하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "일별 종가정보를 이용해 포트폴리오의 시가배당률을 산출하는 절차를 한 문장으로 제시하시오.",
  "qa_type": "application",
  "question_template": "app_procedure_sentence"
}
```

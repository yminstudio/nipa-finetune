...
## Question
포트폴리오의 시가배당률 산출에서 'sum'의 사용 여부를 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "포트폴리오의 시가배당률 산출에서 'sum'의 사용 여부를 판단하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_sum_usage_detail"
}
```

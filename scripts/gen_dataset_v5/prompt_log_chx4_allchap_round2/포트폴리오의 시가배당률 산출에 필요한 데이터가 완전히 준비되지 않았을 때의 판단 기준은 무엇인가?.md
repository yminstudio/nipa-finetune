...
## Question
포트폴리오의 시가배당률 산출에 필요한 데이터가 완전히 준비되지 않았을 때의 판단 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "포트폴리오의 시가배당률 산출에 필요한 데이터가 완전히 준비되지 않았을 때의 판단 기준은 무엇인가?",
  "qa_type": "application",
  "question_template": "app_condition_check"
}
```

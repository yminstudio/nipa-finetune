...
## Question
포트폴리오의 시가배당률은 단일 주식의 시가배당률과 달리 어떤 점에서 다르게 산출되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "포트폴리오의 시가배당률은 단일 주식의 시가배당률과 달리 어떤 점에서 다르게 산출되는가?",
  "qa_type": "comparison",
  "question_template": "comp_single_vs_portfolio"
}
```

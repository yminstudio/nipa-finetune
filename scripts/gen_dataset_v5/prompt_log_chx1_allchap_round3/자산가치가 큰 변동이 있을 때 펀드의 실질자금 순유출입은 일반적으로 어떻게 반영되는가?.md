...
## Question
자산가치가 큰 변동이 있을 때 펀드의 실질자금 순유출입은 일반적으로 어떻게 반영되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "자산가치가 큰 변동이 있을 때 펀드의 실질자금 순유출입은 일반적으로 어떻게 반영되는가?",
  "qa_type": "application",
  "question_template": "Application_Scenario"
}
```

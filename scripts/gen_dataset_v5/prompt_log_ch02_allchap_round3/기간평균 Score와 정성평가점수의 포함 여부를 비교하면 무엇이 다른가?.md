...
## Question
기간평균 Score와 정성평가점수의 포함 여부를 비교하면 무엇이 다른가?
...
```json
{
  ...
  "subsection": "기간평균 Score",
  "seed_title": "기간평균 Score",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "기간평균 Score와 정성평가점수의 포함 여부를 비교하면 무엇이 다른가?",
  "qa_type": "comparison",
  "question_template": "비교_기간평균스코어_정성평가점수"
}
```
...
[핵심 명사]
기간평균 Score, 기간평균, Score, 정성평가점수를, 제외한, 기간별, 평가지표에, 대해, 년의, 평가기간별로, 산출된, 백분위점수를

...
## Question
펀드 ESG 스코어 산출에서 주식종목 포함과 ETF 포함은 산출 대상 자산의 범위에서 어떤 차이가 있는가?
...
```json
{
  ...
  "subsection": "나) 펀드 ESG 스코어의 산출",
  "seed_title": "나) 펀드 ESG 스코어의 산출",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "펀드 ESG 스코어 산출에서 주식종목 포함과 ETF 포함은 산출 대상 자산의 범위에서 어떤 차이가 있는가?",
  "qa_type": "comparison",
  "question_template": "펀드_ESG스코어_산출_자산대상_비교"
}
```
...
[핵심 명사]
나) 펀드 ESG 스코어의 산출, 펀드 ESG 스코어의 산출, 제외, 등급 산출 대상 유형, ESG, 스코어의, 산출, 포트폴리오, 자산, 주식종목, 우선주포함, ETF

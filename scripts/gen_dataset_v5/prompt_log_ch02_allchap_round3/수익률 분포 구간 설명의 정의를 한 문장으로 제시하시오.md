...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0042

## Question
수익률 분포 구간 설명의 정의를 한 문장으로 제시하시오.
...
{
  "chapter": "2. 펀드평가 방법론",
  "section": "수익률 분포 구간 설명",
  "subsection": "",
  "seed_title": "수익률 분포 구간 설명",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "수익률 분포 구간 설명의 정의를 한 문장으로 제시하시오.",
  "qa_type": "definition",
...
[핵심 명사]
수익률 분포 구간 설명, 수익률, 분포, 구간, 데이터는, 형태에, 따라, 여러, 구간으로, 나누어, 분석된다, 예시

...
```json
{
  ...
  "target_total": 100,
  "generated_question": "리서치등급은 정량평가와 정성평가를 함께 사용하는가?",
  "qa_type": "comparison",
  "question_template": "comparison_template_inclusion_of_methods"
}
```
...
[핵심 명사]
) 리서치등급(Research Rating), 리서치등급, Research Rating, 정량평가, 정성평가, 수익성, 평균 수익성, Research, Rating, 리서치등급은, 운용체계, 정성평가와

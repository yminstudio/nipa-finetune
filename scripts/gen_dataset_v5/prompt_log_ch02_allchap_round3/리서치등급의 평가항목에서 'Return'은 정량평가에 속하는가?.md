...
## Question
리서치등급의 평가항목에서 'Return'은 정량평가에 속하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "리서치등급의 평가항목에서 'Return'은 정량평가에 속하는가?",
  "qa_type": "criteria",
  "question_template": "criteria_Return_정량평가여부"
}
```
...
[핵심 명사]
나) 평가항목, 평가항목, 정량평가, 정성평가, 수익성, 평균 수익성, 평가, 항목, 구분, 측정지표, 수익률, Return

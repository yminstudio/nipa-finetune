...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0041

## Question
펀드평가 방법론에서 '평균 수익률 계산'의 정의는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "펀드평가 방법론에서 '평균 수익률 계산'의 정의는 무엇인가?",
  "qa_type": "definition",
...
[핵심 명사]
) 평균 수익률 계산, 평균 수익률 계산, 계산의 편의성, 정규성 가정의 뒷받침, 평균, 수익률, 계산, 펀드의, 기간별, 평균을, 의미하며, 제로인에서는

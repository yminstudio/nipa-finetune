...
## Question
원금 보존성의 위험도 측면에서 가격이 상승하는 경우와 하락하는 경우 중 더 높은 원금 보존성을 나타내는 쪽은 어느 쪽인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "원금 보존성의 위험도 측면에서 가격이 상승하는 경우와 하락하는 경우 중 더 높은 원금 보존성을 나타내는 쪽은 어느 쪽인가?",
  "qa_type": "comparison",
...
[핵심 명사]
원금 보존성, 원금, 보존성, 보통의, 경우, 가격이, 상승하는, 보다, 하락하는, 경우가, 위험도, 측면에서

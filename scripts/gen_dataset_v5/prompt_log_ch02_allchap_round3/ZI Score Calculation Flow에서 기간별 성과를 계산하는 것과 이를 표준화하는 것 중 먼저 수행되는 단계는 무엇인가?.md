...
## Question
ZI Score Calculation Flow에서 기간별 성과를 계산하는 것과 이를 표준화하는 것 중 먼저 수행되는 단계는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "ZI Score Calculation Flow에서 기간별 성과를 계산하는 것과 이를 표준화하는 것 중 먼저 수행되는 단계는 무엇인가?",
  "qa_type": "comparison",
  "question_template": "comparison_flow_steps_order"
}
```

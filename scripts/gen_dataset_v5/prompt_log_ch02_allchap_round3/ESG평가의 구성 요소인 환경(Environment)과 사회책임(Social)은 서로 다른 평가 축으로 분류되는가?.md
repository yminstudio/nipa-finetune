...
## Question
ESG평가의 구성 요소인 환경(Environment)과 사회책임(Social)은 서로 다른 평가 축으로 분류되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "ESG평가의 구성 요소인 환경(Environment)과 사회책임(Social)은 서로 다른 평가 축으로 분류되는가?",
  "qa_type": "comparison",
...
[핵심 명사]
가) ESG평가란?, ESG평가란?, ESG평가란, 환경, Environment, 사회책임, Social, Responsibility, 지배구조, Governance, 기업의, 지속가능성에

...
## Question
비용효율성 평가에서 투자비용이 낮은 경우가 더 높은 비용효율성으로 해석되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "비용효율성 평가에서 투자비용이 낮은 경우가 더 높은 비용효율성으로 해석되는가?",
  "qa_type": "comparison",
...
[핵심 명사]
비용효율성, 비용효율성은, 투자비용을, 평가한다, 투자비용, 신탁보수율, 평가기간, 선취수수료율, 평가기간은, 백분위순위점수는, 투자비용이, 낮은

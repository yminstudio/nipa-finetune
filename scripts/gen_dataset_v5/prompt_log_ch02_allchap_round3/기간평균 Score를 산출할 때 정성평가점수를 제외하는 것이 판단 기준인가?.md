...
## Question
기간평균 Score를 산출할 때 정성평가점수를 제외하는 것이 판단 기준인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "기간평균 Score를 산출할 때 정성평가점수를 제외하는 것이 판단 기준인가?",
  "qa_type": "criteria",
  "question_template": "기간평가_정성제외_기준"
}
```
...
```json
{
  ...
  "subsection": "기간평균 Score",
  "seed_title": "기간평균 Score",
  "question": "기간평균 Score를 산출할 때 정성평가점수를 제외하는 것이 판단 기준인가?",
...
## Assistant Response
```text
기간평균 Score는 기간별 평가지표의 백분위 성과를 종합해 반영하기 위한 값입니다. 

- 기간평균 Score 산출 시 정성평가점수는 제외하는 것이 맞습니다. 정성평가점수를 제외한 기간별 평가지표에 대해 1년, 2년, 3년 평가기간별 백분위점수를 평균해 기간평균 Score를 구합니다. 
- 정성평가점수는 기간평균을 산출할 때 반영하지 않고, 가장 최근 시점에 근접한 정성평가점수를 반영합니다.
```

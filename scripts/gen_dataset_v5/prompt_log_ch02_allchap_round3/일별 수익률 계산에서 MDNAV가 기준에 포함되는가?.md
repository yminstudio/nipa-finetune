...
## Record ID
Zeroin 펀드평가 방법론 - only_text_structure_0037

## Question
일별 수익률 계산에서 MDNAV가 기준에 포함되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "일별 수익률 계산에서 MDNAV가 기준에 포함되는가?",
  "qa_type": "criteria",
  "question_template": "criteria_MDNAV포함여부_일별수익률"
}
```
...
[핵심 명사]
나) 일별 수익률, 일별 수익률, 일별, 수익률, frac, sum, mathrm, NAV, MDNAV, Where, 일의, 그룹의

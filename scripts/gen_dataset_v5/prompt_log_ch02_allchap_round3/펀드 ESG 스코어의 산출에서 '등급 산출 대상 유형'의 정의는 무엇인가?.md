...
## Question
펀드 ESG 스코어의 산출에서 '등급 산출 대상 유형'의 정의는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "펀드 ESG 스코어의 산출에서 '등급 산출 대상 유형'의 정의는 무엇인가?",
  "qa_type": "definition",
  "question_template": "펀드_ESG스코어_산출_정의"
}
```
...
```json
{
  ...
  "subsection": "나) 펀드 ESG 스코어의 산출",
  "seed_title": "나) 펀드 ESG 스코어의 산출",
  "question": "펀드 ESG 스코어의 산출에서 '등급 산출 대상 유형'의 정의는 무엇인가?",
...
## Assistant Response
```text
펀드 포트폴리오 ESG 등급을 산출할 때, “등급 산출 대상 유형”은 등급을 부여하기 위해 같은 그룹으로 묶는 펀드의 유형 범위를 뜻합니다.  
등급 산출 대상 유형은 “대유형 및 소유형”으로 정의됩니다.
```

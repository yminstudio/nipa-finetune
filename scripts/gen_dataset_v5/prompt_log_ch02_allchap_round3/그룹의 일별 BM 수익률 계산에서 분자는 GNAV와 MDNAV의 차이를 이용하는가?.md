...
## Question
그룹의 일별 BM 수익률 계산에서 분자는 GNAV와 MDNAV의 차이를 이용하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "그룹의 일별 BM 수익률 계산에서 분자는 GNAV와 MDNAV의 차이를 이용하는가?",
  "qa_type": "criteria",
  "question_template": "bm_daily_return_criteria_numerator"
}
```

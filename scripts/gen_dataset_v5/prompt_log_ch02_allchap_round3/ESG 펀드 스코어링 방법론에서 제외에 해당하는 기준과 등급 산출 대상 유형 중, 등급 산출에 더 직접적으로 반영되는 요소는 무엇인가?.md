...
## Question
ESG 펀드 스코어링 방법론에서 제외에 해당하는 기준과 등급 산출 대상 유형 중, 등급 산출에 더 직접적으로 반영되는 요소는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "ESG 펀드 스코어링 방법론에서 제외에 해당하는 기준과 등급 산출 대상 유형 중, 등급 산출에 더 직접적으로 반영되는 요소는 무엇인가?",
  "qa_type": "comparison",
  "question_template": "비교_제외대등급산출대상유형"
}
```

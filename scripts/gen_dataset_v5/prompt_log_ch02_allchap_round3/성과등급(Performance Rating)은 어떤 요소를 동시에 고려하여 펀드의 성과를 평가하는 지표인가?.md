...
## Question
성과등급(Performance Rating)은 어떤 요소를 동시에 고려하여 펀드의 성과를 평가하는 지표인가?
...
{
  "chapter": "2. 펀드평가 방법론",
  "section": "1) 성과등급(Performance Rating)",
  "subsection": "",
  ...
  "target_total": 100,
  "generated_question": "성과등급(Performance Rating)은 어떤 요소를 동시에 고려하여 펀드의 성과를 평가하는 지표인가?",
  "qa_type": "definition",
...
[핵심 명사]
) 성과등급(Performance Rating), 성과등급, Performance Rating, Performance, Rating, 제로인은, 수익률과, 변동성, 위험, 동시에, 고려한, 위험조정수익률

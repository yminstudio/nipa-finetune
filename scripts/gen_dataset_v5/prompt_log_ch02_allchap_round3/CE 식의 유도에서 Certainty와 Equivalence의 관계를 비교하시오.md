...
## Question
CE 식의 유도에서 Certainty와 Equivalence의 관계를 비교하시오.
...
```json
{
  ...
  "subsection": "[참고 : CE 식의 유도]",
  "seed_title": "[참고 : CE 식의 유도]",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "CE 식의 유도에서 Certainty와 Equivalence의 관계를 비교하시오.",
  "qa_type": "comparison",
  "question_template": "CE식의유도_관계비교_template"
}
```
...
[핵심 명사]
[참고 : CE 식의 유도], [참고, CE 식의 유도], [CE 식의 유도], 참고, CE, 식의, 유도, Certainty, Equivalence, 제로인이, 펀드등급

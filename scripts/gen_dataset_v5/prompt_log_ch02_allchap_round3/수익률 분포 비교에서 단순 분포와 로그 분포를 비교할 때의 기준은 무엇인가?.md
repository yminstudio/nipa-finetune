...
## Question
수익률 분포 비교에서 단순 분포와 로그 분포를 비교할 때의 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "수익률 분포 비교에서 단순 분포와 로그 분포를 비교할 때의 기준은 무엇인가?",
  "qa_type": "comparison",
...
[핵심 명사]
수익률 분포 비교, 수익률, 분포, 비교, 성과, 분석에서는, 다음, 가지, 분포가, 사용된다, 단순, 로그

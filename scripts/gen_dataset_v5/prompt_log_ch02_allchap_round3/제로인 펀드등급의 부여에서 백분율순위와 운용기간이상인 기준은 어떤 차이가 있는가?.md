...
## Question
제로인 펀드등급의 부여에서 백분율순위와 운용기간이상인 기준은 어떤 차이가 있는가?
...
```json
{
  ...
  "subsection": "다) 제로인 펀드등급의 부여",
  "seed_title": "다) 제로인 펀드등급의 부여",
  "record_target": 3,
  ...
  "target_total": 100,
  "generated_question": "제로인 펀드등급의 부여에서 백분율순위와 운용기간이상인 기준은 어떤 차이가 있는가?",
  "qa_type": "comparison",
  "question_template": "Comparison: 백분율순위 vs 운용기간이상인 기준 차이"
}
```
...
[핵심 명사]
다) 제로인 펀드등급의 부여, 제로인 펀드등급의 부여, 펀드등급의, 부여, 위의, ZI, 백분율순위, Rank, 기초로, 펀드의, 운용기간이, 이상인

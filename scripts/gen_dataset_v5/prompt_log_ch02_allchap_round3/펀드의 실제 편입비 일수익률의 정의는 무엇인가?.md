...
```json
{
  "chapter": "2. 펀드평가 방법론",
  "section": "1) 펀드 수익률 계산",
  "subsection": "마) 펀드의 실제 편입비 일수익률",
  "seed_title": "마) 펀드의 실제 편입비 일수익률",
  "record_target": 2,
  ...
  "target_total": 100,
  "generated_question": "펀드의 실제 편입비 일수익률의 정의는 무엇인가?",
  "qa_type": "definition",
  "question_template": "definition_template_펀드의_실제_편입비_일수익률_정의"
}
```
...
[핵심 명사]
마) 펀드의 실제 편입비 일수익률, 펀드의 실제 편입비 일수익률, 주식형, 펀드의, 실제, 편입비, 일수익률, 주식평가액, 주식선물매수평가액, 주식선물매도평가액, 순자산, 실제편입비수익률

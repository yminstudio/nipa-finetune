...
## Question
운용사와 유형 간 %순위 및 등급의 선정 기준은 서로 다른가?
...
{
  "chapter": "2. 펀드평가 방법론",
  "section": "2) 운용사/유형 %순위 및 등급의 선정 기준",
  "subsection": "",
  ...
  "target_total": 100,
  "generated_question": "운용사와 유형 간 %순위 및 등급의 선정 기준은 서로 다른가?",
  "qa_type": "comparison",
...
[핵심 명사]
) 운용사/유형 %순위 및 등급의 선정 기준, 운용사, 유형 %순위, 등급의 선정 기준, 운용사/유형, 순위, 등급의, 선정, 부여, 펀드가, 설정된, 후부터

...
## Question
리서치등급의 평가 항목에서 정량평가와 정성평가 중 더 큰 비중을 차지하는 항목은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "리서치등급의 평가 항목에서 정량평가와 정성평가 중 더 큰 비중을 차지하는 항목은 무엇인가?",
  "qa_type": "comparison",
  "question_template": "비교_리서치등급_평가항목정량정성비중"
}
```
...
[핵심 명사]
평가 항목, 정량평가, 정성평가, 수익성, 평균 수익성, 평가, 항목, 구분, 측정지표, 수익률, Return, 평균수익성

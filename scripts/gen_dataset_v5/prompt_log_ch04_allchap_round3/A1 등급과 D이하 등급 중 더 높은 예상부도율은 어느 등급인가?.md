...
## Question
A1 등급과 D이하 등급 중 더 높은 예상부도율은 어느 등급인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "A1 등급과 D이하 등급 중 더 높은 예상부도율은 어느 등급인가?",
  "qa_type": "comparison",
...
```json
{
  ...
  "subsection": "[CP등급별 예상부도율]",
  "seed_title": "[CP등급별 예상부도율]",
  "question": "A1 등급과 D이하 등급 중 더 높은 예상부도율은 어느 등급인가?",
...
## Assistant Response
```text
- CP 신용등급별 예상부도율 기준에서 A1은 0.0%, D이하는 100%로 제시됩니다.   
- 따라서 더 높은 예상부도율은 D이하 등급입니다.
```

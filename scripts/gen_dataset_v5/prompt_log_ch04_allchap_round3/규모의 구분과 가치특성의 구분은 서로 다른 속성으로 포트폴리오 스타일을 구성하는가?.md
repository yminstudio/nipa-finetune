...
## Question
규모의 구분과 가치특성의 구분은 서로 다른 속성으로 포트폴리오 스타일을 구성하는가?
...
{
  "chapter": "4. 펀드의 스타일분류",
  "section": "4.1. 주식 포트폴리오의 스타일",
  "subsection": "",
  "seed_title": "4.1. 주식 포트폴리오의 스타일",
  "record_target": 5,
  ...
  "target_total": 100,
  "generated_question": "규모의 구분과 가치특성의 구분은 서로 다른 속성으로 포트폴리오 스타일을 구성하는가?",
  "qa_type": "comparison",
...
[핵심 명사]
. 주식 포트폴리오의 스타일, [시장의 규모별 대표 PER, PBR], [규모의 구분], [가치특성의 구분], 규모, 가치특성, 주식, 포트폴리오의, 스타일, 주식운용스타일은, 펀드매니저가, 투자하여

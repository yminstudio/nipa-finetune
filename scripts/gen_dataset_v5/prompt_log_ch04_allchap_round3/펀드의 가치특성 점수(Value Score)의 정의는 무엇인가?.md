...
## Question
펀드의 가치특성 점수(Value Score)의 정의는 무엇인가?
...
```json
{
  "chapter": "4. 펀드의 스타일분류",
  "section": "2) 가치특성의 구분",
  "subsection": "다) 펀드의 가치특성 점수(Value Score) 계산",
  "seed_title": "다) 펀드의 가치특성 점수(Value Score) 계산",
  "record_target": 4,
  ...
  "target_total": 100,
  "generated_question": "펀드의 가치특성 점수(Value Score)의 정의는 무엇인가?",
  "qa_type": "definition",
...
[핵심 명사]
다) 펀드의 가치특성 점수(Value Score) 계산, 펀드의 가치특성 점수, Value Score, 계산, 펀드의, 가치특성, 점수, Value, Score, 우선, 펀드에, 포함된

...
## Question
펀드의 스타일분류에 적용될 때 채권 및 CP의 신용등급별 배점은 어떤 방식으로 반영되는가?
...
```json
{
  "chapter": "4. 펀드의 스타일분류",
  "section": "1) 신용도의 구분",
  "subsection": "[채권 및 CP의 신용등급별 배점]",
  "seed_title": "[채권 및 CP의 신용등급별 배점]",
  "record_target": 4,
  ...
  "target_total": 100,
  "generated_question": "펀드의 스타일분류에 적용될 때 채권 및 CP의 신용등급별 배점은 어떤 방식으로 반영되는가?",
  "qa_type": "application",
  "question_template": "적용_템플릿"
}
```
...
[핵심 명사]
[채권 및 CP의 신용등급별 배점], [채권, CP의 신용등급별 배점], 채권, CP의, 신용등급별, 배점, 신용등급명, CP, 신용등급, 부여, AAA+

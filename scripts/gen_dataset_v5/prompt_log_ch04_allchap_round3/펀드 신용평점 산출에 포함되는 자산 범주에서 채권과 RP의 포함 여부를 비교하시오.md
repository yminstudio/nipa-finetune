...
## Question
펀드 신용평점 산출에 포함되는 자산 범주에서 채권과 RP의 포함 여부를 비교하시오.
...
```json
{
  ...
  "subsection": "나) 펀드 신용평점",
  "seed_title": "나) 펀드 신용평점",
  "record_target": 4,
  ...
  "target_total": 100,
  "generated_question": "펀드 신용평점 산출에 포함되는 자산 범주에서 채권과 RP의 포함 여부를 비교하시오.",
  "qa_type": "comparison",
  "question_template": "비교_자산포함여부"
}
```
...
[핵심 명사]
나) 펀드 신용평점, 펀드 신용평점, 대상 자산, 채권, CD, CP, RP, 콜, 보통예금, 정기예금, 신용평점, 자산, RP, 보통예금, 정기예금

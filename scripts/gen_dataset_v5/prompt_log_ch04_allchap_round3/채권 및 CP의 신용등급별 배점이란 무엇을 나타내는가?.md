...
```json
{
  ...
  "target_total": 100,
  "generated_question": "채권 및 CP의 신용등급별 배점이란 무엇을 나타내는가?",
  "qa_type": "definition",
...
```json
{
  ...
  "subsection": "[채권 및 CP의 신용등급별 배점]",
  "seed_title": "[채권 및 CP의 신용등급별 배점]",
  "question": "채권 및 CP의 신용등급별 배점이란 무엇을 나타내는가?",
...
## Assistant Response
```text
- 채권 및 CP의 신용등급별 배점이란, 각 채권·CP 신용등급(예: AAA+, AA+, A2+, B 등)에 대응해 부여된 점수 값을 말한다.   
- 이 배점은 채권 포트폴리오의 “시가평가액 가중 신용점수”를 산출하기 위한 구성요소로 사용된다.   
- 또한 같은 표에서 해당 신용등급이 “신용등급 부여(최상/상중/중/하등급 등)”와 연결되어 제시된다.
```

...
## Question
3*3 분류 기준을 실제 포트폴리오 스타일 분류에 적용할 때 먼저 확인해야 하는 요소는 무엇인가?
...
{
  "chapter": "4. 펀드의 스타일분류",
  "section": "3) 주식 포트폴리오 스타일의 분류 기준",
  "subsection": "가) 3*3 분류 기준",
  "seed_title": "가) 3*3 분류 기준",
  "record_target": 4,
  ...
  "target_total": 100,
  "generated_question": "3*3 분류 기준을 실제 포트폴리오 스타일 분류에 적용할 때 먼저 확인해야 하는 요소는 무엇인가?",
  "qa_type": "application",
...
[핵심 명사]
가) 3*3 분류 기준, *3 분류 기준, [규모의 구분], [가치특성의 구분], 분류, 규모의, 구분, 펀드의, 규모구분, 편입종목, 시가총액내림차순기준, 누적편입비

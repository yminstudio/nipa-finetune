...
## Question
AAA와 BBB의 비교에서 더 높은 등급은 어느 등급인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "AAA와 BBB의 비교에서 더 높은 등급은 어느 등급인가?",
  "qa_type": "comparison",
...
```json
{
  ...
  "subsection": "[신용등급별 예상부도율]",
  "seed_title": "[신용등급별 예상부도율]",
  "question": "AAA와 BBB의 비교에서 더 높은 등급은 어느 등급인가?",
...
## Assistant Response
```text
- 제로인 신용등급 기준에서 AAA는 “최상등급(1)”로 분류됩니다.   
- 반면 BBB는 “중등급(4)”로 분류됩니다.   
- 따라서 AAA와 BBB를 비교하면 더 높은 등급은 AAA입니다.
```

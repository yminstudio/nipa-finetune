...
## Question
CP등급별 예상부도율 판단의 기준에 포함되는 CP 등급은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "CP등급별 예상부도율 판단의 기준에 포함되는 CP 등급은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_include_grade_list"
}
```
...
```json
{
  ...
  "subsection": "[CP등급별 예상부도율]",
  "seed_title": "[CP등급별 예상부도율]",
  "question": "CP등급별 예상부도율 판단의 기준에 포함되는 CP 등급은 무엇인가?",
...
## Assistant Response
```text
CP등급별 예상부도율을 판단할 때 적용되는 CP 신용등급은 다음 등급들입니다. 

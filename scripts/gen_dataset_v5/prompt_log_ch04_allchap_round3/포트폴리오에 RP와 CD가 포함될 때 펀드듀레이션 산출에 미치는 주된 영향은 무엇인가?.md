...
## Question
포트폴리오에 RP와 CD가 포함될 때 펀드듀레이션 산출에 미치는 주된 영향은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "포트폴리오에 RP와 CD가 포함될 때 펀드듀레이션 산출에 미치는 주된 영향은 무엇인가?",
  "qa_type": "application",
  "question_template": "적용_자산영향_RP_CD"
}
```
...
[핵심 명사]
가) 펀드듀레이션, 펀드듀레이션, 대상 자산, 채권, 채권선물, RP, 콜, 정기예금, 보통예금, 자산, CD, CP, RP, 보통예금, 정기예금

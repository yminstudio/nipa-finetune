...
## Question
일별 종가정보의 시가배당률을 이용해 포트폴리오의 시가배당률을 산출하려면 먼저 확인해야 하는 데이터는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "일별 종가정보의 시가배당률을 이용해 포트폴리오의 시가배당률을 산출하려면 먼저 확인해야 하는 데이터는 무엇인가?",
  "qa_type": "application",
  "question_template": "Application_Template_2"
}
```

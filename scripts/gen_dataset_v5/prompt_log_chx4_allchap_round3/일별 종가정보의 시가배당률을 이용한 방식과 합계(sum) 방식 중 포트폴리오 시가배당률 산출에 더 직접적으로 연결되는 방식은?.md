...
## Question
일별 종가정보의 시가배당률을 이용한 방식과 합계(sum) 방식 중 포트폴리오 시가배당률 산출에 더 직접적으로 연결되는 방식은?
...
```json
{
  "chapter": "X.4. 주식 포트폴리오의 시가배당률",
  "section": "X.4. 주식 포트폴리오의 시가배당률",
  "subsection": "",
  "seed_title": "X.4. 주식 포트폴리오의 시가배당률",
  "record_target": 100,
  ...
  "target_total": 100,
  "generated_question": "일별 종가정보의 시가배당률을 이용한 방식과 합계(sum) 방식 중 포트폴리오 시가배당률 산출에 더 직접적으로 연결되는 방식은?",
  "qa_type": "comparison",
  "question_template": "Comparison_Template_2"
}
```
...
[핵심 명사]
X.4. 주식 포트폴리오의 시가배당률, 주식, 포트폴리오의, 시가배당률, KOSCOM, 일별, 종가정보의, 시가배당률을, 이용하여, 산출, 배당주식시가배당률, sum

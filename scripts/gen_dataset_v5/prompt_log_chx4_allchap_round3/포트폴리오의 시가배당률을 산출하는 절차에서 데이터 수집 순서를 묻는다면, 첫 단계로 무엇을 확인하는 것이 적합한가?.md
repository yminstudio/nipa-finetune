...
## Question
포트폴리오의 시가배당률을 산출하는 절차에서 데이터 수집 순서를 묻는다면, 첫 단계로 무엇을 확인하는 것이 적합한가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "포트폴리오의 시가배당률을 산출하는 절차에서 데이터 수집 순서를 묻는다면, 첫 단계로 무엇을 확인하는 것이 적합한가?",
  "qa_type": "application",
  "question_template": "Application_Template_3"
}
```

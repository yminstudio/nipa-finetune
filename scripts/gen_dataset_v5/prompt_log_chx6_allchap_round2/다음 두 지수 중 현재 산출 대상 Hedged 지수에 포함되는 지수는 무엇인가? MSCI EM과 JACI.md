...
## Question
다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI EM과 JACI
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI EM과 JACI",
  "qa_type": "comparison",
  "question_template": "Comparison_Template_A8"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1) 현재 산출 대상 Hedged 지수",
  "question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI EM과 JACI",
...
- JACI: 현재 산출 대상 Hedged 지수에 포함됩니다.
```
...
```text
- MSCI EM: 현재 산출 대상 Hedged 지수에 포함됩니다.   
- JACI: 현재 산출 대상 Hedged 지수에 포함됩니다(같은 항목에 JACI, JACI IG가 함께 제시됨).
```
...
```text
- MSCI EM: 현재 산출 대상 Hedged 지수에 포함됩니다.   
- JACI: 현재 산출 대상 Hedged 지수에 포함됩니다( JACI, JACI IG ).
```
...
## Assistant Response
```text
- 현재 산출 대상 Hedged 지수의 “현재 산출 대상” 목록에는 MSCI EM이 포함됩니다.   
- 같은 목록에 JACI와 JACI IG도 포함되어 있어, 질문에 제시된 JACI 역시 포함됩니다.   

따라서 두 지수 모두(MSCI EM, JACI) 현재 산출 대상 Hedged 지수에 포함됩니다.
```

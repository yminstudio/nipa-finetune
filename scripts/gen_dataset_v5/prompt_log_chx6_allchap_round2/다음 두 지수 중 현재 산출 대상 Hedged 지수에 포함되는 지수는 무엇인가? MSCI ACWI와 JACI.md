...
## Question
다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI ACWI와 JACI
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI ACWI와 JACI",
  "qa_type": "comparison",
  "question_template": "Comparison_Template_A3"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1) 현재 산출 대상 Hedged 지수",
  "question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI ACWI와 JACI",
...
## Assistant Response
```text
- 현재 산출 대상 Hedged 지수에는 MSCI ACWI와 JACI가 모두 포함됩니다.   
- MSCI ACWI: 임의로 부여한 헤지비율에 따라 산출 대상입니다.   
- JACI: JACI와 함께 JACI IG도 산출 대상에 포함됩니다.
```
...
## Assistant Response
```text
- 현재 산출 대상 Hedged 지수에는 MSCI ACWI가 포함됩니다.   
- 현재 산출 대상 Hedged 지수에는 JACI도 포함됩니다.   
- 두 지수 모두 임의로 부여한 헤지비율에 따라 산출됩니다.
```
...
- JACI: 현재 산출 대상 Hedged 지수에 포함됩니다(‘JACI, JACI IG’로 표기).
```

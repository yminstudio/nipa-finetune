...
## Question
다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI ACWI와 JACI IG
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI ACWI와 JACI IG",
  "qa_type": "comparison",
  "question_template": "Comparison_Template_A4"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1) 현재 산출 대상 Hedged 지수",
  "question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI ACWI와 JACI IG",
...
## Assistant Response
```text
- MSCI ACWI: 현재 산출 대상 Hedged 지수에 포함됩니다.   
- JACI IG: 현재 산출 대상 Hedged 지수에 포함됩니다.
```
...
## Assistant Response
```text
- 현재 산출 대상 Hedged 지수 목록에는 MSCI ACWI가 포함됩니다.   
- 같은 목록에 JACI IG 역시 포함됩니다(“JACI, JACI IG”로 함께 기재).   
- 결론적으로, MSCI ACWI와 JACI IG 두 지수 모두 현재 산출 대상 Hedged 지수에 포함됩니다.
```
...
## Assistant Response
```text
두 지수 모두 “현재 산출 대상 Hedged 지수” 목록에 포함됩니다. 

- MSCI ACWI: 헤지비율을 임의로 부여해 각각 산출되는 대상에 포함   
- JACI IG: JACI, JACI IG가 함께 “임의로 부여한 헤지비율에 따라 각각 산출”되는 대상에 포함
```
...
## Assistant Response
```text
KRW Hedged 지수 산출에서 “현재 산출 대상 Hedged 지수”로 정의된 범위를 기준으로 보면, 

- MSCI ACWI: 현재 산출 대상 Hedged 지수에 포함   
- JACI IG: 현재 산출 대상 Hedged 지수에 포함
```

...
## Question
다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI ACWI와 MSCI EM
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI ACWI와 MSCI EM",
  "qa_type": "comparison",
  "question_template": "Comparison_Template_A2"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1) 현재 산출 대상 Hedged 지수",
  "question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI ACWI와 MSCI EM",
...
- MSCI EM: 현재 산출 대상 Hedged 지수에 포함됩니다.
```
...
## Assistant Response
```text
현재 산출 대상 Hedged 지수는 여러 해외 주가지수(헤지비율을 임의로 부여해 산출)로 구성됩니다.   
- MSCI ACWI: 현재 산출 대상 Hedged 지수에 포함됩니다.   
- MSCI EM: 현재 산출 대상 Hedged 지수에 포함됩니다.
```
...
## Assistant Response
```text
- 공통 맥락: 제로인 방법론에서 “현재 산출 대상 Hedged 지수”로는 헤지비율을 임의로 부여해 산출하는 MSCI 지수들이 포함됩니다.   
- MSCI ACWI: 현재 산출 대상 Hedged 지수에 포함   
- MSCI EM: 현재 산출 대상 Hedged 지수에 포함
```
...
## Assistant Response
```text
현재 산출 대상 Hedged 지수는 임의로 부여한 헤지비율에 따라 각 지수를 산출 대상으로 삼습니다. 

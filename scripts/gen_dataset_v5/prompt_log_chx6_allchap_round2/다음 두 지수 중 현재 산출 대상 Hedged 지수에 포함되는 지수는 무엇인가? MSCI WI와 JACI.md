...
## Question
다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI WI와 JACI
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI WI와 JACI",
  "qa_type": "comparison",
  "question_template": "Comparison_Template_A6"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1) 현재 산출 대상 Hedged 지수",
  "question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI WI와 JACI",
...
## Assistant Response
```text
- MSCI WI: 현재 산출 대상 Hedged 지수에 포함   
- JACI: 현재 산출 대상 Hedged 지수에 포함
```
...
## Assistant Response
```text
두 지수는 ‘현재 산출 대상 Hedged 지수’ 목록에 포함되는지 여부로 보면, 공통적으로 모두 포함됩니다. 

- MSCI WI: 포함   
- JACI: 포함 (JACI, JACI IG로 산출 대상이 함께 제시됨)
```
...
## Assistant Response
```text
- 현재 산출 대상 Hedged 지수 목록에 MSCI WI가 포함됩니다.   
- 현재 산출 대상 Hedged 지수 목록에 JACI가 포함됩니다.   
- 따라서 두 지수(MSCI WI, JACI) 모두 현재 산출 대상 Hedged 지수에 해당합니다.
```
...
## Assistant Response
```text
현재 산출 대상 Hedged 지수에 대해 보면, MSCI WI와 JACI는 모두 포함됩니다. 

- MSCI WI: 임의로 부여한 헤지비율에 따라 산출되는 항목으로 포함   
- JACI: JACI, JACI IG로 함께 묶여 임의로 부여한 헤지비율에 따라 산출되는 항목으로 포함
```

...
## Question
다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI WI와 JACI IG
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI WI와 JACI IG",
  "qa_type": "comparison",
  "question_template": "Comparison_Template_A7"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1) 현재 산출 대상 Hedged 지수",
  "question": "다음 두 지수 중 현재 산출 대상 Hedged 지수에 포함되는 지수는 무엇인가? MSCI WI와 JACI IG",
...
## Assistant Response
```text
현재 산출 대상 Hedged 지수 목록 기준으로 보면, 두 지수 모두 포함됩니다. 

- MSCI WI: 포함   
- JACI IG: 포함(“JACI, JACI IG”로 함께 산출 대상에 기재)
```
...
## Assistant Response
```text
두 지수는 모두 ‘현재 산출 대상 Hedged 지수’ 목록에 포함됩니다(환헤지 성과측정을 위한 KRW Hedged 지수 산출 맥락). 

- MSCI WI: 현재 산출 대상 Hedged 지수에 포함   
- JACI IG: 현재 산출 대상 Hedged 지수에 포함(‘JACI, JACI IG’로 함께 산출)
```
...
## Assistant Response
```text
현재 산출 대상 Hedged 지수(“KRW Hedged 지수 산출”에서 사용하는 현재 산출 대상 목록)에는 두 지수 모두 포함됩니다. 

- MSCI WI: 포함   
- JACI IG: 포함(“JACI, JACI IG”로 함께 기재)
```

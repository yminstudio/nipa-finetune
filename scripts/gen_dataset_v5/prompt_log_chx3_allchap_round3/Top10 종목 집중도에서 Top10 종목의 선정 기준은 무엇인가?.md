...
## Question
Top10 종목 집중도에서 Top10 종목의 선정 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "Top10 종목 집중도에서 Top10 종목의 선정 기준은 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "4) Top10 종목 집중도",
  "question": "Top10 종목 집중도에서 Top10 종목의 선정 기준은 무엇인가?",
...
## Assistant Response
```text
Top10 종목의 “선정 기준(어떤 값을 기준으로 상위 10개 종목을 고르는지)”은, 제시된 내용에서는 별도로 규정돼 있지 않습니다.

다만 Top10 종목 집중도를 “기준점”으로 판단하기 위한 펀드 적용 기준은 다음과 같습니다.   
- 사모펀드는 제외  
- 기준점 산출 대상은 순자산액 100억 이상 평가 공모펀드( FoFs, 자펀드 제외 )  
- 대상 펀드를 집중도 내림차순 정렬 후 33.1%(상한값), 67.0%(하한값)에 해당하는 펀드의 집중도를 기준점으로 구분(평균이상/수준/이하)
```

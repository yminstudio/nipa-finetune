...
## Question
기산일 지수를 원화환산 BM지수의 산출에 적용하는 여부를 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "기산일 지수를 원화환산 BM지수의 산출에 적용하는 여부를 판단하는 기준은 무엇인가?",
  "qa_type": "criteria",
...
```json
{
  ...
  "subsection": "",
  "seed_title": "X.5. 원화환산 BM지수의 산출",
  "question": "기산일 지수를 원화환산 BM지수의 산출에 적용하는 여부를 판단하는 기준은 무엇인가?",
...
## Assistant Response
```text
기산일 지수 적용 여부 판단은 원화환산 BM지수의 “기준 시작값(기산값)”을 무엇으로 둘지 정하기 위한 것입니다.   
- 원화환산 BM지수의 기산일 지수는 “해당 BM의 첫 지수”로 둡니다.   
- 따라서 적용 여부의 기준은, 원화환산 BM지수 산출에 사용되는 대상 BM에 대해 “첫 지수”를 기산일 지수로 설정하는지입니다.
```

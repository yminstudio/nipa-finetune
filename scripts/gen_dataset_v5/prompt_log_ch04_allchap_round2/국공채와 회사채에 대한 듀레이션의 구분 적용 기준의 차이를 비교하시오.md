...
## Question
국공채와 회사채에 대한 듀레이션의 구분 적용 기준의 차이를 비교하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "국공채와 회사채에 대한 듀레이션의 구분 적용 기준의 차이를 비교하시오.",
  "qa_type": "comparison",
  "question_template": "비교_듀레이션구분_대상차이"
}
```
...
[핵심 명사]
) 듀레이션의 구분, 듀레이션의 구분, 듀레이션의, 구분, 국공채, 지방채, 회사채, 특수채, 모든, 채권과, 통안증권을, 대상으로

...
## Question
문서에 명시된 대상 자산 목록에서 하나의 예시를 들고, 그 예시가 채권 포트폴리오의 스타일 분류의 축 중 하나에 어떻게 적용될 수 있는지 한 문장으로 설명하시오.
...
{
  "chapter": "4. 펀드의 스타일분류",
  "section": "4.2. 채권 포트폴리오의 스타일",
  "subsection": "",
  "seed_title": "4.2. 채권 포트폴리오의 스타일",
  "record_target": 4,
  ...
  "target_total": 100,
  "generated_question": "문서에 명시된 대상 자산 목록에서 하나의 예시를 들고, 그 예시가 채권 포트폴리오의 스타일 분류의 축 중 하나에 어떻게 적용될 수 있는지 한 문장으로 설명하시오.",
  "qa_type": "application",
  "question_template": "application_asset_example"
}
```
...
[핵심 명사]
. 채권 포트폴리오의 스타일, [신용도의 구분], [듀레이션의 구분], 대상 자산, 채권, 채권선물, RP, 콜, 정기예금, 보통예금, CD, CP, RP, 콜, 보통예금, 정기예금, 포트폴리오의, 스타일

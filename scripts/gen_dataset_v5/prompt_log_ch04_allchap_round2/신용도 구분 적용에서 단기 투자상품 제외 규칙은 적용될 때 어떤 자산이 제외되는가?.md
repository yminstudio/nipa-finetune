...
## Question
신용도 구분 적용에서 단기 투자상품 제외 규칙은 적용될 때 어떤 자산이 제외되는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "신용도 구분 적용에서 단기 투자상품 제외 규칙은 적용될 때 어떤 자산이 제외되는가?",
  "qa_type": "application",
...
[핵심 명사]
) 신용도의 구분, 신용도의 구분, 신용도의, 구분, 보유, 채권, CP, 단기, 투자상품, 제외, 가중평균, 부도율에

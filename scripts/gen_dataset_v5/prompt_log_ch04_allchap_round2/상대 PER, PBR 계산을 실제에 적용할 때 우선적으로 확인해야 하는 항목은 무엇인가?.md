...
## Question
상대 PER, PBR 계산을 실제에 적용할 때 우선적으로 확인해야 하는 항목은 무엇인가?
...
```json
{
  "chapter": "4. 펀드의 스타일분류",
  "section": "2) 가치특성의 구분",
  "subsection": "나) 개별종목의 상대 PER, PBR 계산",
  "seed_title": "나) 개별종목의 상대 PER, PBR 계산",
  "record_target": 4,
  ...
  "target_total": 100,
  "generated_question": "상대 PER, PBR 계산을 실제에 적용할 때 우선적으로 확인해야 하는 항목은 무엇인가?",
  "qa_type": "application",
  "question_template": "적용_상대PER_PBR_우선확인항목"
}
```
...
[핵심 명사]
나) 개별종목의 상대 PER, PBR 계산, 개별종목의 상대 PER, PBR 계산, 개별종목의, 상대, PER, PBR, 계산, 개별, 종목이, 속하는, 규모별

...
## Question
5*5 분류 기준을 적용할 때 시가총액내림차순기준은 어떤 구분에 해당하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "5*5 분류 기준을 적용할 때 시가총액내림차순기준은 어떤 구분에 해당하는가?",
  "qa_type": "application",
...
[핵심 명사]
나) 5*5 분류 기준, *5 분류 기준, [규모의 구분], [가치특성의 구분], 분류, 규모의, 구분, 펀드의, 규모구분, 편입종목, 시가총액내림차순기준, 누적편입비

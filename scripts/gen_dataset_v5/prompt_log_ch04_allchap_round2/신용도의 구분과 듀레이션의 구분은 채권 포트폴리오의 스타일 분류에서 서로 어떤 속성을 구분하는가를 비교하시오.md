...
## Question
신용도의 구분과 듀레이션의 구분은 채권 포트폴리오의 스타일 분류에서 서로 어떤 속성을 구분하는가를 비교하시오.
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "신용도의 구분과 듀레이션의 구분은 채권 포트폴리오의 스타일 분류에서 서로 어떤 속성을 구분하는가를 비교하시오.",
  "qa_type": "comparison",
  "question_template": "comparison_axis"
}
```

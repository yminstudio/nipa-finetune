...
## Question
가치특성 구분의 판단 기준으로, Value Score가 초과하는 경우의 펀드 분류는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "가치특성 구분의 판단 기준으로, Value Score가 초과하는 경우의 펀드 분류는 무엇인가?",
  "qa_type": "criteria",
  "question_template": "criteria_가치특성분류_ValueScore초과_성장형분류"
}
```

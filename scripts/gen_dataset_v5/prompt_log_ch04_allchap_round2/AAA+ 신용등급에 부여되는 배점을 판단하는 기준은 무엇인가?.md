...
## Question
AAA+ 신용등급에 부여되는 배점을 판단하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "AAA+ 신용등급에 부여되는 배점을 판단하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "AAAplus_배점_기준"
}
```
...
```json
{
  ...
  "subsection": "[채권 및 CP의 신용등급별 배점]",
  "seed_title": "[채권 및 CP의 신용등급별 배점]",
  "question": "AAA+ 신용등급에 부여되는 배점을 판단하는 기준은 무엇인가?",
...
## Assistant Response
```text
- 채권 신용등급명이 AAA+이면 배점은 0이다.   
- AAA+는 ‘최상등급(1)’으로 신용등급 부여 기준에 해당한다.
```
...
## Assistant Response
```text
AAA+ 신용등급에 부여되는 배점은 신용 위험(예상부도율)을 신용등급별로 매핑해 정해집니다. 

- 채권 신용등급 기준, AAA+의 배점은 0입니다.   
- AAA+는 신용등급 부여 체계에서 최상등급(1)으로 구분됩니다.   
- 신용등급별 예상부도율은 AAA 구간에서 0.0%로 제시됩니다.
```
...
## Assistant Response
```text
AAA+ 신용등급에 부여되는 배점은 “채권 및 CP의 신용등급별 배점”에서 신용등급명에 따라 정해지는 값을 기준으로 판단합니다. 

- 판단 기준: 채권(또는 CP)의 신용등급 ‘AAA+’ 해당 여부   
- AAA+의 배점: 0   
- AAA+의 신용등급 부여: 최상등급(1)
```
...
## Assistant Response
```text
채권의 신용등급에 따른 배점은 “신용등급-배점”을 등급별로 매핑해 정해진 값을 부여하는 방식으로 판단합니다.   
- 채권 신용등급 AAA+의 배점: 0   
- CP는 별도의(채권과 구분된) 배점 표를 적용하며, AAA+ 배점과 동일한 개념으로 보지 않습니다.
```

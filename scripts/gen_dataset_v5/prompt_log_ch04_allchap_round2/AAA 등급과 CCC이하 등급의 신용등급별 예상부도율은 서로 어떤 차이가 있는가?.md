...
## Question
AAA 등급과 CCC이하 등급의 신용등급별 예상부도율은 서로 어떤 차이가 있는가?
...
```json
{
  "chapter": "4. 펀드의 스타일분류",
  "section": "1) 신용도의 구분",
  "subsection": "[신용등급별 예상부도율]",
  "seed_title": "[신용등급별 예상부도율]",
  "record_target": 4,
  ...
  "target_total": 100,
  "generated_question": "AAA 등급과 CCC이하 등급의 신용등급별 예상부도율은 서로 어떤 차이가 있는가?",
  "qa_type": "comparison",
  "question_template": "비교문_예상부도율_등급간차이"
}
```
...
[핵심 명사]
[신용등급별 예상부도율], 신용등급별, 예상부도율, 등급, AAA, AA, BBB, BB, CCC이하, 신용등급, 평가시, 사용되는

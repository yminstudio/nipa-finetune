...
## Question
펀드의 스타일분류에서 시장 규모별 대표 PER, PBR 계산을 적용해야 하는 구체적 상황은 무엇인가?
...
```json
{
  "chapter": "4. 펀드의 스타일분류",
  "section": "2) 가치특성의 구분",
  "subsection": "가) 시장의 규모별 대표 PER, PBR 계산",
  "seed_title": "가) 시장의 규모별 대표 PER, PBR 계산",
  "record_target": 4,
  ...
  "target_total": 100,
  "generated_question": "펀드의 스타일분류에서 시장 규모별 대표 PER, PBR 계산을 적용해야 하는 구체적 상황은 무엇인가?",
  "qa_type": "application",
  "question_template": "적용_사례"
}
```
...
[핵심 명사]
가) 시장의 규모별 대표 PER, PBR 계산, 시장의 규모별 대표 PER, PBR 계산, [시장의 규모별 대표 PER, PBR], 시장의, 규모별, 대표, PER, PBR, 계산, 시장에서, 거래되는

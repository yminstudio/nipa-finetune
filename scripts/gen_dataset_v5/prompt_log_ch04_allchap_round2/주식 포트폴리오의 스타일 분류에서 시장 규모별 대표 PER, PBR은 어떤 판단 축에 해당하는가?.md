...
## Question
주식 포트폴리오의 스타일 분류에서 시장 규모별 대표 PER, PBR은 어떤 판단 축에 해당하는가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "주식 포트폴리오의 스타일 분류에서 시장 규모별 대표 PER, PBR은 어떤 판단 축에 해당하는가?",
  "qa_type": "criteria",
  "question_template": "대표 지표의 판단 축"
}
```

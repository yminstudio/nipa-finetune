...
## Question
시장 규모별 대표 PER, PBR를 적용할 때 가장 먼저 고려해야 하는 것은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "시장 규모별 대표 PER, PBR를 적용할 때 가장 먼저 고려해야 하는 것은 무엇인가?",
  "qa_type": "application",
...
[핵심 명사]
) 가치특성의 구분, 가치특성의 구분, [시장의 규모별 대표 PER, PBR], 가치특성의, 구분, 시장의, 규모별, 대표, PER, PBR, 계산, 시장에서

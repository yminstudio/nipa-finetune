...
## Question
개별주식의 규모 구분에서 시가총액을 기준으로 대형주와 중형주를 구분하는 정의는 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "개별주식의 규모 구분에서 시가총액을 기준으로 대형주와 중형주를 구분하는 정의는 무엇인가?",
  "qa_type": "definition",
...
[핵심 명사]
) 규모의 구분, 규모의 구분, [개별주식의 규모 구분], 규모의, 구분, 개별주식의, 규모구분, 주식의, 시가총액을, 기준으로, 대형주, 중형주

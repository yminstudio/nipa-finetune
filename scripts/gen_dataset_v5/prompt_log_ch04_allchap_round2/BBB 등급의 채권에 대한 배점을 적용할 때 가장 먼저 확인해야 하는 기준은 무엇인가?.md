...
## Question
BBB 등급의 채권에 대한 배점을 적용할 때 가장 먼저 확인해야 하는 기준은 무엇인가?
...
```json
{
  ...
  "target_total": 100,
  "generated_question": "BBB 등급의 채권에 대한 배점을 적용할 때 가장 먼저 확인해야 하는 기준은 무엇인가?",
  "qa_type": "application",
...
```json
{
  ...
  "subsection": "[채권 및 CP의 신용등급별 배점]",
  "seed_title": "[채권 및 CP의 신용등급별 배점]",
  "question": "BBB 등급의 채권에 대한 배점을 적용할 때 가장 먼저 확인해야 하는 기준은 무엇인가?",
...
## Assistant Response
```text
- 적용 순서: 채권의 신용등급명부터 확인한다( BBB+ / BBB0 / BBB- ).   
- 적용 조건: “채권 신용등급별 배점” 기준이므로, CP가 아니라 채권의 신용등급명에 해당하는 값을 선택한다.   
- 전환 규칙: 신용등급명이 BBB+이면 배점 2.1, BBB0이면 2.4, BBB-이면 2.7을 배정한다.
```
...
## Assistant Response
```text
- 먼저 채권의 “적용 신용등급”이 무엇인지 확인한다. 채권은 KIS 채권평가사가 제공한 신용등급을 사용하며(무등급 제외), 보증채는 보증기관·발행기관 중 높은 신용등급을, 보증기관의 부도/폐업 시에는 발행기관 신용등급을 사용한다.    
- 다음으로 그 신용등급 표기가 BBB의 세부구분 중 무엇인지 확인한다(BBB+, BBB0, BBB-).   
- 확인된 BBB 세부등급에 해당하는 채권 배점을 바로 적용한다: BBB+ 2.1, BBB0 2.4, BBB- 2.7.
```
...
## Assistant Response
```text
- 적용 대상은 ‘BBB 등급 채권’이므로, 먼저 해당 자산의 신용등급이 KIS 채권평가사 제공 신용등급인지 확인하고(무등급은 제외) 배점 산출을 진행합니다   
- 그 다음 신용등급 “명칭”을 BBB+ / BBB0 / BBB- 중 무엇으로 받았는지 확인합니다   
- 확인한 신용등급 명칭에 따라 배점을 그대로 부여합니다: BBB+ 2.1, BBB0 2.4, BBB- 2.7   
- 전환 규칙: 같은 등급이라도 ‘채권’이면 채권 칼럼의 배점을, ‘CP’이면 CP 칼럼(별도 배점표)에서 배점을 적용합니다
```
...
## Assistant Response
```text
- 가장 먼저 확인: 배점표에서 채권 신용등급명이 BBB+ / BBB0 / BBB- 중 어디에 해당하는지(해당 세부 등급명) 확인한다.   
- 적용 조건: 배점은 “채권 신용등급별 배점” 기준으로 해당되는(채권) 등급명에 매칭해 부여한다.   
- 전환 규칙: 보증채는 보증기관과 발행기관의 신용등급 중 높은 신용등급을 사용하고, 보증기관이 부도 또는 폐업한 경우에는 발행기관의 신용등급으로 교체해 그 결과가 BBB+·BBB0·BBB-로 귀속되는지부터 다시 반영한다.   
- 매칭(배점 부여): BBB+ 2.1점, BBB0 2.4점, BBB- 2.7점.
```

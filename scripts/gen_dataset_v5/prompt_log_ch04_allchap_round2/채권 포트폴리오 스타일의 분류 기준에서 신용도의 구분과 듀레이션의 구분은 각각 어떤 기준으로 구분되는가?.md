...
## Question
채권 포트폴리오 스타일의 분류 기준에서 신용도의 구분과 듀레이션의 구분은 각각 어떤 기준으로 구분되는가?
...
```json
{
  ...
  "subsection": "",
  "seed_title": "3) 채권 포트폴리오 스타일의 분류 기준",
  "record_target": 4,
  ...
  "target_total": 100,
  "generated_question": "채권 포트폴리오 스타일의 분류 기준에서 신용도의 구분과 듀레이션의 구분은 각각 어떤 기준으로 구분되는가?",
  "qa_type": "comparison",
...
[핵심 명사]
) 채권 포트폴리오 스타일의 분류 기준, 채권 포트폴리오 스타일의 분류 기준, [신용도의 구분], [듀레이션의 구분], 채권, 포트폴리오, 스타일의, 분류, 신용도의, 구분, 펀드의, 신용등급구분

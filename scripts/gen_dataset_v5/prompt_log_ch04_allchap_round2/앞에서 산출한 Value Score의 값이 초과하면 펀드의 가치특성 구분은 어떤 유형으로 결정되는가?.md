...
## Question
앞에서 산출한 Value Score의 값이 초과하면 펀드의 가치특성 구분은 어떤 유형으로 결정되는가?
...
```json
{
  "chapter": "4. 펀드의 스타일분류",
  "section": "2) 가치특성의 구분",
  "subsection": "라) 펀드의 가치특성 구분",
  "seed_title": "라) 펀드의 가치특성 구분",
  "record_target": 4,
  ...
  "target_total": 100,
  "generated_question": "앞에서 산출한 Value Score의 값이 초과하면 펀드의 가치특성 구분은 어떤 유형으로 결정되는가?",
  "qa_type": "application",
...
[핵심 명사]
라) 펀드의 가치특성 구분, 펀드의 가치특성 구분, 펀드의, 가치특성, 구분, 앞에서, 산출한, Value, Score, 값이, 초과하면, 성장형

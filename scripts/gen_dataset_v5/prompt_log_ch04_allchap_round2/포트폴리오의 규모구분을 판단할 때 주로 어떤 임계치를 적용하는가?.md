...
## Question
포트폴리오의 규모구분을 판단할 때 주로 어떤 임계치를 적용하는가?
...
```json
{
  "chapter": "4. 펀드의 스타일분류",
  "section": "1) 규모의 구분",
  "subsection": "나) 펀드 포트폴리오의 규모구분",
  "seed_title": "나) 펀드 포트폴리오의 규모구분",
  "record_target": 5,
  ...
  "target_total": 100,
  "generated_question": "포트폴리오의 규모구분을 판단할 때 주로 어떤 임계치를 적용하는가?",
  "qa_type": "application",
  "question_template": "적용형_임계치"
}
```
...
[핵심 명사]
나) 펀드 포트폴리오의 규모구분, 펀드 포트폴리오의 규모구분, 포트폴리오의, 규모구분, 주식형, 펀드의, 규모는, 펀드에, 편입되어, 있는, 주식의, 평균적인

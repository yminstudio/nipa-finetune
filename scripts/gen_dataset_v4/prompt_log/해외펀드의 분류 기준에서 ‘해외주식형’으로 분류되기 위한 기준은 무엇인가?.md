...
## Record ID
01_유형분류_기준_structure_0005

## Question
해외펀드의 분류 기준에서 ‘해외주식형’으로 분류되기 위한 기준은 무엇인가?
...
```json
{
  ...
  "generated_question": "해외펀드의 분류 기준에서 ‘해외주식형’으로 분류되기 위한 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "해외펀드_주식형_분류기준"
}
```
...
```json
{
  ...
  "subsection": "해외펀드",
  "seed_title": "해외펀드",
  "question": "해외펀드의 분류 기준에서 ‘해외주식형’으로 분류되기 위한 기준은 무엇인가?",
...
## Assistant Response
```text
해외펀드가 ‘해외주식형’으로 분류되기 위한 기준은 다음과 같습니다. 

- 약관상 **주식 또는 주식펀드 투자한도**가 **최고 2/3를 초과**할 것
- 그리고 **투자가능 주식의 2/3 이상**을 **해외주식(또는 해외 특정지역)**에 투자할 것
```

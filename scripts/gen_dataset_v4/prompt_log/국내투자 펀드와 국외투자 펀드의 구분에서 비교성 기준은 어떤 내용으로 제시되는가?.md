...
## Question
국내투자 펀드와 국외투자 펀드의 구분에서 비교성 기준은 어떤 내용으로 제시되는가?
...
```json
{
  ...
  "generated_question": "국내투자 펀드와 국외투자 펀드의 구분에서 비교성 기준은 어떤 내용으로 제시되는가?",
  "qa_type": "comparison",
  "question_template": "비교_국내vs국외"
}
```
...
```json
{
  ...
  "subsection": "",
  "seed_title": "1.1 유형분류 개요",
  "question": "국내투자 펀드와 국외투자 펀드의 구분에서 비교성 기준은 어떤 내용으로 제시되는가?",
...
## Assistant Response
```text
국내투자펀드와 국외투자펀드를 유형으로 나누는 기준에서 말하는 **비교성**은, “사회적 통념을 기준으로 판단”하는 내용으로 제시됩니다.
```

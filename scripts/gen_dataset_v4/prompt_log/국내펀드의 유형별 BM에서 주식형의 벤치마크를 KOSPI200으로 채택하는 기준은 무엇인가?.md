...
## Question
국내펀드의 유형별 BM에서 주식형의 벤치마크를 KOSPI200으로 채택하는 기준은 무엇인가?
...
```json
{
  ...
  "generated_question": "국내펀드의 유형별 BM에서 주식형의 벤치마크를 KOSPI200으로 채택하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "주식형BM_KOSPI200_기준_template"
}
```
...
```json
{
  ...
  "subsection": "국내펀드의 유형별 BM",
  "seed_title": "국내펀드의 유형별 BM",
  "question": "국내펀드의 유형별 BM에서 주식형의 벤치마크를 KOSPI200으로 채택하는 기준은 무엇인가?",
...
## Assistant Response
```text
국내펀드에서 **주식형**의 유형별 BM을 **KOSPI200**으로 채택하는 기준은, 먼저 해당 펀드가 **주식형으로 분류**되는지 여부와 그 안의 **소유형**입니다.

1) **주식형 분류 기준**
- **약관상 최고 주식투자한도 2/3 초과** 펀드를 주식형으로 봅니다. 

2) 주식형 내 **소유형별 유형BM**
- 주식형의 소유형 중 **일반주식(순수/자산배분)**, **테마주식**, **K200 인덱스**, **기타인덱스**는 유형별 BM을 **KOSPI200**으로 둡니다.
```

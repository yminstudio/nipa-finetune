...
```json
{
  ...
  "generated_question": "특별자산형은 어떤 상황에서 적용되는가?",
  "qa_type": "application",
  "question_template": "적용"
}
```
...
## Assistant Response
```text
제로인에서 **특별자산형**은 펀드 **투자설명서상 주식이나 채권, 부동산 이외의 투자대상자산**에 투자하는 펀드에 적용됩니다.
```

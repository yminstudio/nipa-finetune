...
## Assistant Response
```text
소유형 BM은 펀드를 분류할 때의 “소유형(대유형 내 세부 유형)”에 대응해 적용하는 벤치마크 지수를 의미합니다. 즉, 유형별 BM 매핑표에서 소유형 항목에 지정된 “소유형 BM”이 해당 펀드의 BM으로 설정됩니다.  

예) 국내펀드: 주식형-일반주식(순수, 자산배분) → KOSPI200   
예) 해외펀드: 해외주식형-글로벌주식 → MSCI ACWI
```

...
## Question
국내/국외 유형분류 기준에 따라 국내투자 펀드를 구분하는 기준은 무엇인가?
...
```json
{
  ...
  "generated_question": "국내/국외 유형분류 기준에 따라 국내투자 펀드를 구분하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "기준_펀드구분"
}
```
...
```json
{
  ...
  "subsection": "국내/국외 유형분류 기준",
  "seed_title": "국내/국외 유형분류 기준",
  "question": "국내/국외 유형분류 기준에 따라 국내투자 펀드를 구분하는 기준은 무엇인가?",
...
## Assistant Response
```text
제로인의 국내/국외 유형분류 기준에서 **국내투자 펀드**는 다음 기준으로 구분합니다.

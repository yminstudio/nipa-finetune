...
## Question
해외펀드의 유형별 BM에서 '소유형 BM'의 정의는 무엇인가?
...
```json
{
  ...
  "generated_question": "해외펀드의 유형별 BM에서 '소유형 BM'의 정의는 무엇인가?",
  "qa_type": "definition",
...
```json
{
  ...
  "subsection": "3) 해외펀드의 유형별 BM",
  "seed_title": "3) 해외펀드의 유형별 BM",
  "question": "해외펀드의 유형별 BM에서 '소유형 BM'의 정의는 무엇인가?",
...
## Assistant Response
```text
제로인 해외펀드의 유형별 BM에서 **‘소유형 BM’**은, 해외펀드를 **대유형–소유형**으로 나눈 뒤 그중 **‘소유형’에 매칭하여 적용하는 벤치마크 지수**를 말합니다. 예를 들어 **해외주식형**의 **글로벌주식(소유형)**에는 **MSCI ACWI(소유형 BM)**를 적용하는 방식입니다.
```

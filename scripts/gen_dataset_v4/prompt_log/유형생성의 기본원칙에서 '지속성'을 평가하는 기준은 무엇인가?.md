...
## Question
유형생성의 기본원칙에서 '지속성'을 평가하는 기준은 무엇인가?
...
```json
{
  ...
  "generated_question": "유형생성의 기본원칙에서 '지속성'을 평가하는 기준은 무엇인가?",
  "qa_type": "criteria",
  "question_template": "유형생성의 기본원칙-지속성 기준"
}
```
...
```json
{
  ...
  "subsection": "유형생성의 기본원칙",
  "seed_title": "유형생성의 기본원칙",
  "question": "유형생성의 기본원칙에서 '지속성'을 평가하는 기준은 무엇인가?",
...
## Assistant Response
```text
유형생성의 기본원칙 중 ‘지속성’은 **단기적인 시장 유행이 아니라, 해당 유형이 장기간 생존할 수 있는 가능성**을 기준으로 평가합니다.
```

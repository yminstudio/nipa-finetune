...
DEFAULT_INPUT = Path(__file__).resolve().parent / "state/questions_raw.jsonl"
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "state/questions_filtered.jsonl"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Filter and normalize raw v4 questions.")
    parser.add_argument("--input", default=str(DEFAULT_INPUT), help="Path to questions_raw.jsonl")
    parser.add_argument("--output", default=str(DEFAULT_OUTPUT), help="Path to questions_filtered.jsonl")

...
DEFAULT_INPUT = STATE_DIR / "answers_raw.jsonl"
DEFAULT_OUTPUT = STATE_DIR / "answers_validated.jsonl"
DEFAULT_REPORT = STATE_DIR / "validation_report.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate v4 generated answers.")
    parser.add_argument("--input", default=str(DEFAULT_INPUT), help="Path to answers_raw.jsonl")
    parser.add_argument("--output", default=str(DEFAULT_OUTPUT), help="Path to answers_validated.jsonl")
    parser.add_argument("--report", default=str(DEFAULT_REPORT), help="Path to validation_report.json")
